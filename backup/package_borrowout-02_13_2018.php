...
<table width="1280">
	<tr>
        ...
        <td>Reports: <strong><?php echo $get_p['scheme']; ?> Borrow Out</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
...
<table width="1280" id="list_table">
    ...
    <tr>
    	<td colspan="4" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/'" value=""></td>
    </tr>
    <tr>
    	<td colspan="4">&nbsp;</td>
    </tr>
