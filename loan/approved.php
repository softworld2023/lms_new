...
$sql = mysql_query("SELECT * FROM customer_details cd, customer_loanpackage lp WHERE lp.branch_id = '".$_SESSION['login_branchid']."' AND (lp.loan_status = 'Approved' OR lp.loan_status = 'Paid' OR lp.loan_status = 'Finished') AND lp.customer_id = cd.id ORDER BY cd.name ASC");
?>
...
<table width="1280">
    ...
    <tr>
    	<td colspan="3">
        <div class="subnav">
			<a href="index.php">Waiting</a><a href="approved.php" id="active-menu">Approved</a><a href="rejected.php">Rejected</a><a href="kiv.php">KIV</a>
		</div>	
        </td>
    </tr>
</table>
