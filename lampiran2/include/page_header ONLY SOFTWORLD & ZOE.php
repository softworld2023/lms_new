...
<table width="1280" background="../img/top-logo-bg.jpg" height="37">
    <tr>
        ...
        <td align="right" style="padding-right:20px"><?php include('../include/userpanel.php'); ?></td> 
    </tr>
</table>
<?php
	//check the userright
...
?>
<table width="1280" background="../img/menu-bg.jpg" height="47">
    <tr>
        ...
        ?>
				...
				{ 
				?>
				<a href="../branch/" title="Home" id="header">
				<?php } else { ?>
				<a href="../home/" title="Home" id="header">
				<?php } ?>
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/home-icon.png" width="20"></td>
                		<td style="padding-right:7px">Home</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
        <!--<?php
            }
            if($get_userright['files_page'] == 'on')
            { 
        ?>
                <a href="../files/">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/files-icon.png"></td>
                		<td style="padding-right:7px">Files</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
        ...
        <?php
            ...
            { 
        ?>
                <a href="../customers/" title="Customers" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/customers-icon.png" width="20"></td>
                		<td style="padding-right:7px">Customers</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
        <?php
            ...
            { 
        ?>
                <a href="../loan/" title="Loan" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/loan-icon.png" width="20"></td>
                		<td style="padding-right:7px">Loan</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
                <a href="../payout/" title="Payout" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/payment-icon.png" width="20"></td>
                		<td style="padding-right:7px">Payout</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
                <a href="../payment/" title="Payment Received" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/cash-register-icon.png" width="20"></td>
                		<td style="padding-right:7px">Payment</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
        <?php
			...
			if($get_userright['cashbook_page'] == 'on')
            { 
        ?>
		<?php
			if($_SESSION['login_branchid'] != '13')
			{
		?>
                <a href="../cashbook/" title="Cash Book" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/cash-book-icon.png" width="25"></td>
                		<td style="padding-right:7px">Cash Book</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
		<?php } else { ?>
			 	<a href="../cashbookhq/" title="Cash Book" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/cash-book-icon.png" width="25"></td>
                		<td style="padding-right:7px">Cash Book</td>
        ...
        <?php
			...
			if($get_userright['report_page'] == 'on')
            { 
        ?>
                <a href="../report/" title="Reports" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/report-icon.png" width="17"></td>
                		<td style="padding-right:7px">Reports</td>
                        <td><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
        <?php
            ...
            { 
        ?>
   		  <a href="../enquiry/" title="Enquiry" id="header">
          <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/enquiry/small-enquiry-icon.png" width="25"></td>
                		<td style="padding-right:7px">Enquiry</td>
                        <td><img src="../img/menu-line.jpg"></td>
                    </tr>
          </table>
          </a>
                <a href="../blacklist/" title="Check Blacklist" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td><img src="../img/check-blacklist/check-blacklist.png" width="25"></td>
                		<td style="padding-right:7px">Blacklist</td>
                        <td><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
                <a href="../reminder/" title="Collection Reminder" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td><img src="../img/collection-reminder/collection-reminder.png" width="20"></td>
                		<td style="padding-right:7px">Reminder</td>
                        <td><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
                <a href="../package/" title="Package" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td><img src="../img/package/package.png" width="20"></td>
                		<td style="padding-right:7px">Package</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
                <a href="../expenses/" title="Expenses" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/expenses-icon.png"></td>
                		<td style="padding-right:7px">Expenses</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
				...
				{
				?>
                <a href="../setting/" title="Setting" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/setting-icon.png" width="20"></td>
                		<td style="padding-right:7px">Setting</td>
                        <td style="padding-right:3px"><div style="height:34px; line-height:34px">&nbsp;</div></td>
                    </tr>
                </table>
                </a>
				<?php } ?>
        <!--<?php
			...
			if($get_userright['help_page'] == 'on')
            { 
        ?>
                <a href="../help/">
                <table id="navigation_button" >
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/help-icon.png"></td>
                		<td style="padding-right:7px">Help</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg" height="34"></td>
                    </tr>
                </table>
                </a>
        <?php
