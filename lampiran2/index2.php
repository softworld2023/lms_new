...
<table width="1280" id="list_table" align="center">
	...
	?> 
		<tr align="center">
			...
			<td><a href="lampiranA/generate.php?id=<?php echo $chkic['id']; ?>">
					<img src="../img/view_source.png"/></a>&nbsp;
				<a href="lampiranA/view_details.php?id=<?php echo $chkic['id']; ?>">
					<img src="../img/view.png"/>&nbsp;
				<a href="lampiranA/edit.php?id=<?php echo $chkic['id']; ?>">
					<img src="../img/enquiry/edit-btn.png"/></a>&nbsp;
				<a href="javascript:deleteConfirmation('<?php echo $exp_d['id']; ?>','<?php echo $exp_d['name']; ?>')">
    ...
    <tr>
    	<td colspan="8" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../home/'"></td>
    </tr>
    <tr>
    	<td colspan="8">&nbsp;</td>
    </tr>
