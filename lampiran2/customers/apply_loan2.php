        	...
        	<center>
        	  <table width="85%" id="table_form">
                ...
                <tr>
                  ...
                  <td style="padding-right:10px">Previous Loan Code </td>
                ...
                <tr>
                  <td colspan="2" style="padding-right:10px"><table id="radio_table">
                      <tr>
                        <td><input type="radio" name="loan_type" id="loan_type" value="Flexi Loan" checked="checked" /></td>
                        <td style="padding-left:5px; padding-right:20px">Flexi Loan</td>
                        <td><input type="radio" name="loan_type" id="loan_type1" value="Fixed Loan" /></td>
                        <td style="padding-left:5px; padding-right:20px">Fixed Loan</td>
                      </tr>
                  </table></td>
                  <td style="padding-right:10px">Loan Amount</td>
                  <td><input type="text" name="loan_amount" id="loan_amount" placeholder="RM" class="currenciesOnly" tabindex="16" onkeyup="calculateInt(); hideloanamt(this.value)" />
                ...
                <tr>
                  ...
                  <td width="20%"style="padding-right:10px">Interest Rate </td>
                  <td width="35%"><table width="100%" style="border-collapse:collapse">
                      <tr>
                ...
                <tr>
                  ...
                  <td><!--<input type="text" name="loan_code" id="loan_code" style="width:80px" onblur="checkLoanCode(this.value)" tabindex="16" />-->
                      <input type="text" name="loan_code" id="loan_code" style="width:80px" tabindex="16" onblur="checkLoanCode(this.value)"/></td>
                  <td style="padding-right:10px">Loan Period (months) </td>
                  <td><input type="text" name="loan_period" id="loan_period" tabindex="16" onkeyup="calculateInt()" />
...
function checkLoanCode(str)
{
	...
	xmlhttp.open("GET","checkLoanCode.php?code="+escape(str),true);
	xmlhttp.send();
}
function sameR(v)
{
