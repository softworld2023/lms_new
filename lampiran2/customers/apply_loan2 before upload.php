        	...
        	<center>
        	  <table width="85%" id="table_form2">
        	    ...
        	    <tr>
        	      ...
        	      <td><div class="fileUpload"><input type="file" name="cust_pic" id="cust_pic" class="upload" onchange="readURL(this, 'cust_pic2');"></div></td>
      	      </tr>
        	    <tr>
                ...
                <tr>
                  ...
                  <td width="35%"><table width="100%" style="border-collapse:collapse">
                      <tr>
                        ...
                        <td><input type="text" name="loan_interesttotal" id="loan_interesttotal" class="currenciesOnly" style="width:80px" tabindex="17" /></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td style="padding-right:10px">Loan Code</td>
                  <td><!--<input type="text" name="loan_code" id="loan_code" style="width:80px" onblur="checkLoanCode(this.value)" tabindex="16" />--><input type="text" name="loan_code" id="loan_code" style="width:80px" tabindex="16" /></td>
...
function checkForm()
{
	if((document.getElementById('name').value != '' && document.getElementById('nric').value != '' && document.getElementById('mobile_contact').value != '' && document.getElementById('loan_package').value != '' && document.getElementById('loan_amount').value != '' && document.getElementById('loan_interest').value != '' && document.getElementById('loan_interesttotal').value != '' && document.getElementById('loan_code').value!= ''))
	{
		$('#message').empty();
		return true;	
	}
