  ...
  <tr>
    ...
    <table width="97%" align="center" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr align="center">
        ...
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;" size="6" id="loan_total<?php echo $c; ?>" name="loan_total<?php echo $c; ?>"  value="<?php echo strtoupper($sql['loan_total']); ?>"></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;"size="6"  id="balance<?php echo $c; ?>" name="balance<?php echo $c; ?>"  value="<?php echo strtoupper($sql['balance']); ?>"></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;" size="4" id="loan_period<?php echo $c; ?>" name="loan_period<?php echo $c; ?>"  value="<?php echo strtoupper($sql['loan_period']); ?>"></td>
        <td><input type="date" style="font-weight:bold; font-size:14px; border: none;" size="5" id="payout_date<?php echo $c; ?>" name="payout_date<?php echo $c; ?>"  value="<?php echo strtoupper($sql['payout_date']); ?>"></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;" size="9" id="mobile_contact<?php echo $c; ?>" name="mobile_contact<?php echo $c; ?>" value="<?php echo $sql['mobile_contact']; ?>"></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;" size="4" id="int_percent<?php echo $c; ?>" name="int_percent<?php echo $c; ?>" value="<?php echo $sql['int_percent']; ?>"></td>
        <td><select id="jenis_cagaran<?php echo $c; ?>" name="jenis_cagaran<?php echo $c; ?>" >
										<option value=""></option>
										<option value="BERCAGAR" <?php if($sql['jenis_cagaran']=="BERCAGAR") echo 'selected="selected"'; ?> >BERCAGAR</option>
										<option value="TANPA CAGARAN" <?php if($sql['jenis_cagaran']=="TANPA CAGARAN") echo 'selected="selected"'; ?> >TANPA CAGARAN</option>
										</select></td>
        <td colspan="2"><select id="taraf<?php echo $c; ?>" name="taraf<?php echo $c; ?>">
										<option value=""></option>
										<option value="BUMI" <?php if($sql['taraf']=="BUMI") echo 'selected="selected"'; ?> >BUMI</option>
										<option value="BUKAN BUMI" <?php if($sql['taraf']=="BUKAN BUMI") echo 'selected="selected"'; ?> >BUKAN BUMI</option>
										</select></td>
		...
		<td><input type="text" style="font-weight:bold; font-size:14px; border: none; text-transform: uppercase;" size="8" id="employer<?php echo $c; ?>" name="employer<?php echo $c; ?>" value="<?php echo strtoupper($sql['employer']); ?>"></td>
		<td><input type="text" style="font-weight:bold; font-size:14px; border: none; text-transform: uppercase;" size="6" id="salary<?php echo $c; ?>" name="salary<?php echo $c; ?>" value="<?php echo $sql['salary']; ?>"></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;" size="4" id="remark<?php echo $c; ?>" name="remark<?php echo $c; ?>"  value="<?php echo strtoupper($sql['remark']); ?>"></td>
      </tr>
	  <?php } ?>
    </table></td>
  </tr>
