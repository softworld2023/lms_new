    ...
    if (isset($_POST)) {
        ...
        foreach ($db_name_arr as $db_name) {
            ...
            while ($row = mysql_fetch_assoc($q)) {
                ...
                $action = '<a href="../customers/view_customer.php?id=' . $id . '&db_name=' . $db_name . '" title="View Particular">
                                <img src="../img/customers/view-icon.png" />
                            </a>
                            <a href="../customers/history.php?id=' . $id . '&db_name=' . $db_name . '" title="History">
                                <img src="../img/customers/history-icon.png" />
                            </a>';
                if ($branch_name == $login_branch) {
                    $action .= '<a href="../customers/add_loan.php?id=' . $id . '" title="Apply Loan">
