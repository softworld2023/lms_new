        	...
        	<table width="85%" id="table_form">
              ...
              <tr>
                ...
                <td align="left" style="padding-right:10px">ATM Card </td>
                    <td>
                    <table>
					<td><?php $ctr_5=0; if($get_a['a_atmfile'] != '') { ?>
              ...
              <tr>
                ...
                <td align="left" style="padding-right:10px">Mortgage</td>
                 ...
                 <td> <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_6;?></a></td>
                    	...
                    	<td><a href="multiimage/mortgage.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
              </tr>
              </table>
              <tr>
              ...
              <tr>
                ...
                <table>
					<?php $ctr_8=0; if($get_a['a_landfile'] != '') { ?>
                    	<td><a href="<?php echo "../files/customer/".$id."/".$get_a['a_landfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                    <?php } ?>
                    </td>
					<?php
						//callout uploaded files
                  ...
                  <td><a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_8?></a></td>
                    	...
                    	<td><a href="multiimage/others.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
              </tr>
              </table>
              <tr>
        	...
        	<center>
        	  <table width="85%" id="table_form">
                ...
                <tr>
                  <td colspan="2" style="padding-right:10px"><table id="radio_table">
                      <tr>
                        <td><input type="radio" name="loan_type" id="loan_type" value="Flexi Loan" disabled /></td>
                        <td style="padding-left:5px; padding-right:20px">Flexi Loan</td>
                        <td><input type="radio" name="loan_type" id="loan_type1" value="Fixed Loan" disabled /></td>
                ...
                <tr>
                  ...
                  <td><!--<input type="text" name="loan_code" id="loan_code" style="width:80px" onblur="checkLoanCode(this.value)" tabindex="16" />-->
                      <!--<input type="text" name="loan_code" id="loan_code" style="width:80px" tabindex="16" onblur="checkLoanCode(this.value)" />-->
					  <input type="text" name="loan_code" id="loan_code" tabindex="16" style="width:80px;" onBlur="checkLoanCode(this.value)"/>	  
				 </td>
...
//{
	...
	//xmlhttp.onreadystatechange=function()
	  ...
	  //if (xmlhttp.readyState==4 && xmlhttp.status==200)
		//{
			...
			//if(err != '')
			//{
				//alert("Loan Code " + str + " already exist!");
	...
	//xmlhttp.open("GET","checkLoanCode.php?code="+escape(str)+"&package="+$package,true);
	//xmlhttp.send();
//}
</script>
