...
<center>
<form id = "mainForm" action="action_edit_cust.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm()">
<input type="hidden" name="customer_id" id="customer_id" value="<?php echo $id; ?>">
<button type="submit" name="submit_approve" id="submit_approve" style="display:none;"></button>
<button type="submit" name="submit_reject" id="submit_reject" style="display:none;"></button>
        	...
        	<center>
                ...
                <thead>
                	...
                	<tr>
                        ...
                        <th style="background:#333; color:#FFF">Position</th>
        	...
        	<table width="85%" id="table_form">
                ...
                <tr>
                  ...
                  <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /></a>
						...
						<a href="multiimage/index.php" rel="shadowbox"><img src="../img/browse.JPG" />	</a>				</td>
            	</tr>
                <tr>
                  ...
                  <td width="32%"><input type="text" name="a_bankbranch" id="a_bankbranch" style="width:300px" tabindex="14" value="<?php echo $get_a['a_bankbranch']; ?>" /></td>
                    ...
                    <td>
                      ...
                      <?php } ?>
						...
						?>
                  <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /></a>						<?php
						...
						?>
                      	<a href="multiimage/ic.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
                </tr>
                <tr>
                  ...
                  <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /></a>
						...
						?>
                      	...
                      	<a href="multiimage/bs.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
              </tr>
              <tr>
                ...
                <td align="left" style="padding-right:10px">Salary Slips </td>
                  ...
                  <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /></a>
						...
						?>
                      	<a href="multiimage/salary.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
              </tr>
              <tr>
                <td align="left" style="padding-right:10px">ATM Card Number</td>
                  ...
                  <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /></a>
                    ...
                    <a href="multiimage/atm.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
                     </tr>
              <tr>
              ...
              <tr>
               ...
               <td align="left" style="padding-right:10px">Guarantor Form </td>
                  ...
                  <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /></a>
                    	...
                    	<a href="multiimage/guarantorform.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="image.php?link=<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /></a>
                    	...
                    	<a href="multiimage/reminder.php" rel="shadowbox"><img src="../img/browse.JPG" /></a>					</td>
              </tr>
              <tr>
...
<!--                       <select name="loan_package" id="loan_package" tabindex="16" style="height:30px">
 ...
 <!--                  <td width="20%"style="padding-right:10px" hidden="">Interest Rate </td>
				  ...
				  <td>
					<tr>
					<td>Start Date</td>
					<td><input type="month" name="start_date" id="start_date" tabindex="16" autocomplete="OFF" value = "<?php echo $get_inst['start_month'] ?>"/></td>
				</tr></td>
                </tr>
                <!-- <tr>
 ...
 <!--                  <td width="20%"style="padding-right:10px" hidden="">Interest Rate </td>
                  <td width="35%" hidden=""><table width="100%" style="border-collapse:collapse">
                      <tr>
						...
						<tr>
							<td>Payout Date</td>
							<td><input type="date" name="monthly_date" id="monthly_date" autocomplete="off" value = "<?php echo $get_monthly['monthly_date'] ?>"></td>
						</tr>
						<tr>
							<td>Month</td>
						...
						<tr>
							<td>SD</td>
							<td>
								<!-- <input style="vertical-align: middle;" type="radio" name="sd" value="Normal" required <?php if($get_monthly['sd'] == 'Normal') { echo 'checked'; } ?>><span>Normal (RM5)</span><br> -->
								<input style="vertical-align: middle;" type="radio" name="sd" value="Listing" required checked <?php if($get_monthly['sd'] == 'Listing') { echo 'checked'; } ?> disabled><span> Stamping List</span>
							</td>
						</tr>
              </table>
        	</center>
...
<div id="actionModal" class="modal" style="display:none;">
  <div class="modal-content">
    <h2><strong>PLEASE SELECT:</strong></h2><br>
    <button class="colored-button green-button" onclick="approveAction()">APPROVE</button>
    <button class="colored-button red-button" onclick="rejectAction()">REJECT</button>
  </div>
</div>
...
<div id="approveModal" class="modal" style="display:none;">
  <div class="modal-content">
    <h2>Are you sure you want to approve this customer?</h2><br>
    <button class="colored-button green-button" onclick="confirmApprove()">Yes</button>
    <button class="colored-button red-button" onclick="$('#approveModal').hide();">No</button>
  </div>
</div>

<div id="rejectModal" class="modal" style="display:none;">
  <div class="modal-content">
    <h2>Are you sure you want to reject this customer?</h2><br>
    <button class="colored-button green-button" onclick="submitReject()">Yes</button>
    <button class="colored-button red-button" onclick="$('#rejectModal').hide();">No</button>
  </div>
</div>
...
function submitReject() {
  const name = document.getElementById('name').value;
  const nric = document.getElementById('nric').value;
  const customer_id = document.getElementById('idReload').value;
  const mobile_contact = document.getElementById('mobile_contact').value;
  const company = document.getElementById('company').value;

  console.log(name);
  Shadowbox.open({
    content: '../reject/reject.php?name=' + encodeURIComponent(name) + 
				'&nric=' + encodeURIComponent(nric)+ 
				'&customer_id=' + encodeURIComponent(customer_id)+
				'&mobile_contact=' + encodeURIComponent(mobile_contact)+
...
function SBClose() {
	  ...
	  window.open('edit_customer_loan.php?id='+$idReload, '_self');     // Reload parent window.
