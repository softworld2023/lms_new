...
$sql = mysql_query("SELECT * FROM customer_loanpackage WHERE 
					customer_id = '".$id."' 
...
<table width="1280" id="list_table">
	...
	while($get_q = mysql_fetch_assoc($sql)){
		...
		if($lcode == '0')
		{
			$lpd_q = mysql_query("SELECT * FROM loan_payment_details WHERE 
		...
		// $late_interest_q = mysql_query("SELECT * FROM late_interest_record WHERE loan_code = '".$lcode."'") or die (mysql_error());
