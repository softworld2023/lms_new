...
if (!file_exists('../reminder/'.$customer_id)) 
{
	mkdir('../reminder/'.$customer_id, 0777, true);
}
$output_dir = "../reminder/".$customer_id."/";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	for($i = 0; $i < $fileCount; $i++)
	{
		...
		else
		{
			...
			$filename = "../reminder/".$customer_id."/". $_FILES['file']['name'][$i];
