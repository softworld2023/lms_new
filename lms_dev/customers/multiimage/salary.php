...
if (!file_exists('../salaryslip/'.$customer_id)) 
{
	mkdir('../salaryslip/'.$customer_id, 0777, true);
}
$output_dir = "../salaryslip/".$customer_id."/";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	for($i = 0; $i < $fileCount; $i++)
	{
		...
		else
		{
			...
			$filename = "../salaryslip/".$customer_id."/". $_FILES['file']['name'][$i];
