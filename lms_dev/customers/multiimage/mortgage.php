...
if (!file_exists('../mortgage/'.$customer_id)) 
{
	mkdir('../mortgage/'.$customer_id, 0777, true);
}
$output_dir = "../mortgage/".$customer_id."/";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	for($i = 0; $i < $fileCount; $i++)
	{
		...
		else
		{
			...
			$filename = "../mortgage/".$customer_id."/". $_FILES['file']['name'][$i];
