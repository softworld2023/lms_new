...
<table width="1280" id="list_table">
	...
	<tr>
      <td>&nbsp;</td>
      <td><?php echo date('d-m-Y', strtotime($oddate)); ?></td>
      <td>CF</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="javascript:deleteConfirmation('<?php echo $get_q['date']; ?>', '<?php echo $get_q['description']; ?>', '<?php echo $get_q['id']; ?>')"><img src="../img/customers/delete-icon.png" title="Delete" id="del"></a></td>
			<?php } ?>
    </tr>
