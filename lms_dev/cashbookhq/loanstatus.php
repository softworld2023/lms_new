...
if($num>0){	
    ...
    <tr id="grid">
        ...
        <td>
			...
			<center>
				<a href="edit_loanstatus.php?id=<?php echo $get_q['id']; ?>&branch=<?php echo $cust['branch_id']; ?>&database=<?php echo $cust['branch_name']; ?>"><img src="../img/customers/edit-icon.png" title="Edit" style="margin-bottom:2px"></a>&nbsp;&nbsp;
			</center>        
