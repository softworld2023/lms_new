...
$query = "SELECT * FROM loansystem_dev.reject_loan WHERE (branch_name = 'ANSENG' OR branch_name = 'MAJUSAMA')  AND status = 'ACTIVE' AND id = '".$id."' ORDER BY reject_date ASC";
...
<table width="100%" id="list_table" border="0">
    ...
    <tr> <td style="padding-right:10px;" align="right"><b>Document</b></td>
        <td><input type="file" name="reject_doc" id="reject_doc" class="upload" />
            ...
            <a target="_blank" href="../reject/document/<?php echo $reject['id']; ?>/<?php echo $reject['document']; ?>"><img src="../img/customers/view-icon.png" alt="" title="View Reject Document" /></a><?php }?>
