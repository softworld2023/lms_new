...
<table width="1280">
    ...
    <tr>
		...
		<a href="javascript:editpayoutamount('<?php echo $get_q['id']; ?>')" title="save payout amount"><img src="../img/document_save.png" /></a></td>
		<td><a href="monthlyPaymentForm.php?mprid=<?php echo $get_q['id']; ?>" title="Make Payment" rel="shadowbox; width=600px; height=380px" ><table>
											<tr>
