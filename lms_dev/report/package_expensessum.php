...
$sql = mysql_query("SELECT * FROM expenses GROUP BY package_id");
?>
<style type="text/css">
<!--
.submit_style {
...
<table width="1280">
	<tr>
        ...
        <td>Reports: <strong>Expenses (Summary)</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    ...
    <tr>
        ...
        <div class="subnav">
			...
			<a href="expenses.php" id="active-menu">Expenses</a>
...
<table width="1280" id="list_table">
	...
	{
		$sum_q = mysql_query("SELECT SUM(amount) as expamt FROM expenses WHERE package_id = '".$get_q['package_id']."'");
		$get_sum = mysql_fetch_assoc($sum_q);
		$ctr++;
		$total += $get_sum['expamt'];
    ...
    <tr>
        ...
        <td><?php echo "RM ".number_format($get_sum['expamt'], '2', '.', ''); ?></td>
    </tr>
    <?php } ?>
    <tr>
    ...
    <tr>
    	<td colspan="3" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/expenses.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    </tr>
