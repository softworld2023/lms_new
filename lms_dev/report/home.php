...
$date_hingga = $day2.'hb '.$mth2.' '.$yr2;
	...
	//Bawah RM500
	$sql_11 = mysql_query("SELECT count(customer_financial.basic_salary) as count_basicsalary FROM customer_financial LEFT JOIN customer_loanpackage ON customer_financial.customer_id = customer_loanpackage.customer_id WHERE customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_financial.basic_salary <= '500' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."'AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	$result_11 = mysql_fetch_assoc($sql_11);
	$gaji1 = $result_11['count_basicsalary'];

	//RM501 - RM1,000
	$sql_12 = mysql_query("SELECT count(customer_financial.basic_salary) as count_basicsalary FROM customer_financial LEFT JOIN customer_loanpackage ON customer_financial.customer_id = customer_loanpackage.customer_id WHERE customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_financial.basic_salary >= '501' AND customer_financial.basic_salary <='1000' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."'AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	$result_12 = mysql_fetch_assoc($sql_12);
	$gaji2 = $result_12['count_basicsalary'];

	//RM1,001 - RM5,000
	$sql_13 = mysql_query("SELECT count(customer_financial.basic_salary) as count_basicsalary FROM customer_financial LEFT JOIN customer_loanpackage ON customer_financial.customer_id = customer_loanpackage.customer_id WHERE customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_financial.basic_salary >= '1001' AND customer_financial.basic_salary <='5000' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."'AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	$result_13 = mysql_fetch_assoc($sql_13);
	$gaji3 = $result_13['count_basicsalary'];

	//RM5,001 - RM10,000
	$sql_14 = mysql_query("SELECT count(customer_financial.basic_salary) as count_basicsalary FROM customer_financial LEFT JOIN customer_loanpackage ON customer_financial.customer_id = customer_loanpackage.customer_id WHERE customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_financial.basic_salary >= '5001' AND customer_financial.basic_salary <='10000' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."'AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	$result_14 = mysql_fetch_assoc($sql_14);
	$gaji4 = $result_14['count_basicsalary'];

	//RM10,001 dan ke atas
	$sql_15 = mysql_query("SELECT count(customer_financial.basic_salary) as count_basicsalary FROM customer_financial LEFT JOIN customer_loanpackage ON customer_financial.customer_id = customer_loanpackage.customer_id WHERE customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_financial.basic_salary >= '10001' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."'AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	$result_15 = mysql_fetch_assoc($sql_15);
	$gaji5 = $result_15['count_basicsalary'];

	$jumlah_gaji = $gaji1 + $gaji2 + $gaji3 + $gaji4 + $gaji5;

	// 2 c)Pecahan mengikut kaum (Nilai pinjaman) :-
	//Melayu
	$sql_16 = mysql_query("SELECT sum(loan_pokok) as sum_loan_amount FROM customer_loanpackage LEFT JOIN customer_details ON customer_loanpackage.customer_id = customer_details.id WHERE customer_details.race ='Malay' AND customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."' AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	...
	//Chinese
	$sql_17 = mysql_query("SELECT sum(loan_pokok) as sum_loan_amount FROM customer_loanpackage LEFT JOIN customer_details ON customer_loanpackage.customer_id = customer_details.id WHERE customer_details.race ='Chinese' AND customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."' AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	...
	//Indian
	$sql_18 = mysql_query("SELECT sum(loan_pokok) as sum_loan_amount FROM customer_loanpackage LEFT JOIN customer_details ON customer_loanpackage.customer_id = customer_details.id WHERE customer_details.race ='Indian' AND customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."' AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	...
	//Bumiputera
	$sql_19 = mysql_query("SELECT sum(loan_pokok) as sum_loan_amount FROM customer_loanpackage LEFT JOIN customer_details ON customer_loanpackage.customer_id = customer_details.id WHERE customer_details.race ='Bumiputera' AND customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."' AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	...
	//Lain-lain
	$sql_20 = mysql_query("SELECT sum(loan_pokok) as sum_loan_amount FROM customer_loanpackage LEFT JOIN customer_details ON customer_loanpackage.customer_id = customer_details.id WHERE customer_details.race='Lain-lain' OR customer_details.race=' ' AND customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."' AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	...
	//Bukan Warganegara
	$sql_21 = mysql_query("SELECT sum(loan_pokok) as sum_loan_amount FROM customer_loanpackage LEFT JOIN customer_details ON customer_loanpackage.customer_id = customer_details.id WHERE customer_details.race ='Bukan Warganegara' AND customer_loanpackage.loan_package = 'NEW PACKAGE' AND customer_loanpackage.payout_date >='".$date_from."' AND customer_loanpackage.payout_date <='".$date_to."' AND customer_loanpackage.loan_status!='Deleted' AND customer_loanpackage.loan_code NOT LIKE 'MS%'");
	...
	//Bawah RM1,000
	$sql_22 = mysql_query("SELECT count(loan_pokok) as count_loan_amount FROM customer_loanpackage WHERE loan_pokok <= '1000' AND loan_package = 'NEW PACKAGE' AND payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	$result_22 = mysql_fetch_assoc($sql_22);
	$pinjaman1 = $result_22['count_loan_amount'];

	//RM1,001 - RM5,000
	$sql_23 = mysql_query("SELECT count(loan_pokok) as count_loan_amount FROM customer_loanpackage WHERE loan_pokok >= '1001' AND loan_pokok <= '5000' AND loan_package = 'NEW PACKAGE' AND payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	$result_23 = mysql_fetch_assoc($sql_23);
	$pinjaman2 = $result_23['count_loan_amount'];

	//RM5,001 - RM10,000
	$sql_24 = mysql_query("SELECT count(loan_pokok) as count_loan_amount FROM customer_loanpackage WHERE loan_pokok >= '5001' AND loan_pokok <= '10000' AND loan_package = 'NEW PACKAGE' AND payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	$result_24 = mysql_fetch_assoc($sql_24);
	$pinjaman3 = $result_24['count_loan_amount'];

	//RM10,001 - RM50,000
	$sql_25 = mysql_query("SELECT count(loan_pokok) as count_loan_amount FROM customer_loanpackage WHERE loan_pokok >= '10001' AND loan_pokok <= '50000' AND loan_package = 'NEW PACKAGE' AND payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	$result_25 = mysql_fetch_assoc($sql_25);
	$pinjaman4 = $result_25['count_loan_amount'];

	//RM50,001 - RM100,000
	$sql_26 = mysql_query("SELECT count(loan_pokok) as count_loan_amount FROM customer_loanpackage WHERE loan_pokok >= '50001' AND loan_pokok <= '100000' AND loan_package = 'NEW PACKAGE' AND payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	$result_26 = mysql_fetch_assoc($sql_26);
	$pinjaman5 = $result_26['count_loan_amount'];

	//RM100,001 - RM1 juta
	$sql_27 = mysql_query("SELECT count(loan_pokok) as count_loan_amount FROM customer_loanpackage WHERE loan_pokok >= '100001' AND loan_pokok <= '1000000' AND loan_package = 'NEW PACKAGE' AND payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	$result_27 = mysql_fetch_assoc($sql_27);
	$pinjaman6 = $result_27['count_loan_amount'];

	//RM1 juta > dan ke atas
	$sql_28 = mysql_query("SELECT count(loan_pokok) as count_loan_amount FROM customer_loanpackage WHERE loan_pokok > '1000000' AND loan_package = 'NEW PACKAGE' AND payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	...
	$sql_29 = mysql_query("SELECT sum(loan_pokok) as sum_loan_pokok, sum(loan_total) as sum_loan_amount FROM customer_loanpackage WHERE payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_package = 'NEW PACKAGE' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	...
	$sql_30 = mysql_query("SELECT count(id) as perjanjian FROM customer_loanpackage WHERE payout_date >='".$date_from."' AND payout_date <='".$date_to."' AND loan_package = 'NEW PACKAGE' AND loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	...
	$sql_33 = mysql_query("SELECT sum(loan_lejar_details.payment) as payment FROM loan_lejar_details JOIN customer_loanpackage ON loan_lejar_details.customer_loanid = customer_loanpackage.id WHERE customer_loanpackage.payout_date <='".$date_from."' AND loan_lejar_details.payment_date >='".$date_from."' AND loan_lejar_details.payment_date <='".$date_to."'AND customer_loanpackage.loan_status!='Deleted' AND loan_code NOT LIKE 'MS%'");
	$result_33 = mysql_fetch_assoc($sql_33);

	$sql_34 = mysql_query("SELECT sum(loan_lejar_details.balance) as balance FROM loan_lejar_details JOIN customer_loanpackage ON loan_lejar_details.customer_loanid = customer_loanpackage.id  WHERE loan_lejar_details.bad_debt ='yes' and loan_lejar_details.payment = '0'");
	$result_34 = mysql_fetch_assoc($sql_34);

	$total_baki_2 = $result_33['payment'] - $result_34['balance'];
	$total_baki2 = number_format($total_baki_2,'2'); 


	$sql_35 = mysql_query("SELECT * FROM profile_kpkt");
	$result_35 = mysql_fetch_assoc($sql_35);
...
$html.='<div style="text-align:right;">
		...
		<div style="font-size:12px;">
			...
			<tr>
				...
				<td width="1%">:</td>
				<td colspan="4" style="border-bottom: 1px solid;">MJ MAJUSAMA SDN BHD</td>
			</tr>
			<tr>
...
$profile='<div>
			<table width="100%" align="center"  cellspacing="0" cellpadding="5" style="font-family:Time New Roman;font-size:12px;">
			<tr>
			<td style="border:1px solid"><b>NAMA</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>OLD NAME/POSTAL ADDRESS</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>NO. SSM</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>ALAMAT OPERASI</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>POSKOD</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>BANDAR</b></td>
			</tr>
			<tr>
			<td style="border-left:1px solid;border-right:1px solid;border-bottom:1px solid;">'.$result_35['nama'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['postal_address'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['no_ssm'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['alamat_operasi'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['poskod'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['bandar'].'</td>
			</tr>
			</table>
			</div>
			<br>
			...
			<table width="100%" align="center"  cellspacing="0" cellpadding="5" style="font-family:Time New Roman;font-size:12px;">
			<tr>
			<td style="border:1px solid;"><b>NO. TELEPHONE FIXED</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>TELEFON BIMBIT</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>EMAIL</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>CATATAN</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>JENIS ORGANISASI</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>NAMA PENGURUS</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>NO. RUJUKAN KPKT</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>NO. LESEN PPW</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>NO. PERMIT IKLAN</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>TAMAT TEMPOH LESEN</b></td>
			</tr>
			<tr>
			<td style="border-left:1px solid;border-right:1px solid;border-bottom:1px solid;">'.$result_35['no_telephone'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['telefon_bimbit'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['email'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['catatan'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['jenis_organisasi'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['nama_pengurus'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['no_rujukan'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['no_lesen'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['no_permit'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['tamat_tempoh'].'</td>
			</tr>
			</table>
			</div>
			<br>
			...
			<table width="100%" align="center"  cellspacing="0" cellpadding="5" style="font-family:Time New Roman;font-size:12px;">
			<tr>
			<td style="border:1px solid;"><b>TARIKH MULA</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>TARIKH TAMAT</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>NO K/P</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>ALAMAT RUMAH</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>FAVOURITE CITY BLESS</b></td>
			<td style="border-top:1px solid;border-right:1px solid;border-bottom:1px solid;"><b>PASSWORD</b></td>
			</tr>
			<tr>
			<td style="border-left:1px solid;border-right:1px solid;border-bottom:1px solid;">'.$result_35['tarikh_mula'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['tarikh_tamat'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['no_kp'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['alamat_rumah'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['favourite_city'].'</td>
			<td style="border-right:1px solid;border-bottom:1px solid;">'.$result_35['password'].'</td>
			</tr>
			</table>
			</div>';
$mpdf->WriteHTML($html);

$mpdf->AddPage('L','','','','',10,10,30,30,10,10);
