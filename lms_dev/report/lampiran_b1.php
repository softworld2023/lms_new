...
$mpdf = new mPDF('','A4-L','','',2,2,27,20,5,5,'P');
$header='<div style="text-align:right;font-size:11px;">
			<b>LAMPIRAN B1</b>
		</div>
		<div style="text-align:center;font-size:10px;padding-bottom:5px;">
			<b>PERATURAN-PERATURAN PEMBERI PINJAM WANG (KAWALAN DAN PELESENAN) 2003 <br> [Subperaturan 16(1) Akta 400] <br> REKOD TRANSAKSI TAHUNAN MENGIKUT PERINCIAN PINJAMAN BAGI TAHUN '.$date.'
		</div>
		<div style="font-size:12px; padding-bottom:5px;">
			...
			<tr>
				...
				<td style="text-align:center; border-bottom:1px solid;"><b>KTL SETIA REALTY SDN BHD</b></td>
...
$html='
		<div style="font-size:10px;">
			...
			<tr>
				...
				<td style="text-align:center;border-top:1px solid;border-right:1px solid;">Pendapatan/ Gaji (RM)</td>
			</tr>';
						$sql_1 = mysql_query("SELECT
											...
											WHERE
												customer_loanpackage.loan_lejar_date >= '2021-01-01' 
												AND customer_loanpackage.loan_lejar_date <= '2021-12-31'");
						$ctr=0;
