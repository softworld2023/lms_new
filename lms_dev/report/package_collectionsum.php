...
$sql = mysql_query("SELECT * FROM loan_payment_details pd, customer_loanpackage lp WHERE (lp.loan_status = 'Paid' OR lp.loan_status = 'Finished') AND pd.customer_loanid = lp.id AND pd.payment_date != '0000-00-00' GROUP BY lp.loan_package");
...
<table width="1280">
	<tr>
        ...
        <td>Reports: <strong>Collection (Summary)</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    ...
    <tr>
        ...
        <div class="subnav">
			...
			<a href="collection.php" id="active-menu">Total Collection</a>
...
<table width="1280" id="list_table">
	...
	while($get_q = mysql_fetch_assoc($sql))
	{
		...
		$coll_q = mysql_query("SELECT SUM(payment) AS payment, SUM(payment_int) AS payment_int FROM loan_payment_details WHERE package_id = '".$get_pack['id']."'");
    ...
    <tr>
    	<td colspan="3" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/collection.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    </tr>
