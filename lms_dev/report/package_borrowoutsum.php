...
$sql = mysql_query("SELECT * FROM customer_loanpackage WHERE loan_status = 'Paid' OR loan_status = 'Finished' GROUP BY loan_package ORDER BY payout_date DESC");
...
<table width="1280">
	<tr>
        ...
        <td>Reports: <strong>Borrow Out (Summary)</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
...
<table width="1280" id="list_table">
	...
	while($get_q = mysql_fetch_assoc($sql))
	{
		...
		$sum_q = mysql_query("SELECT SUM(loan_amount) AS amt_sum FROM customer_loanpackage WHERE loan_package = '".$package."'");
		$get_s = mysql_fetch_assoc($sum_q);
    ...
    <tr>
        ...
        <td width="150"><?php echo "RM ".$get_s['amt_sum']; ?></td>
    </tr>
    <?php } ?>
    <tr>
    ...
    <tr>
    	<td colspan="3" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/'" value=""></td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    </tr>
