...
<table width="90%" id="list_table">
    ...
    <tr>
      ...
      <td><input type="text" name="period" id="period" value="<?php echo $get_q['loan_period']; ?>" style="width:50px" onkeyup="changePeriod(this.value,'<?php echo $get_q['loan_period']; ?>')" readonly="readonly" /> months <div id="save_period" style="display:none"><a href="javascript:updatePeriod('<?php echo $get_q['loan_period'] ?>', '<?php echo $id; ?>')"><input type="button" name="saveperiod" id="saveperiod" value="" /></a></div></td>
    </tr>
    <tr>
	...
	<tr>
		...
		<td><input type="text" name="payday" id="payday" value="<?php echo $getacc['a_payday']; ?>" style="width:50px" /></td>
		<td></td>
		<td></td>
	</tr>  
    <tr>
...
<table width="90%" id="list_table">
	...
	<tr <?php echo $style; ?>>
		...
		<td>
			...
			<?php } ?>
			<?php } ?>
			<?php } else { echo $get_l['payment_date']; } ?>		</td>
		<td>
			<?php if($get_l['payment_date'] == '0000-00-00') {  ?>
			<?php if($style == '') {?>
    ...
    <tr>
    	<td colspan="9" align="right"><input type="button" name="back" id="back" onClick="history.go(-1)" value=""></td>
    </tr>
    <tr>
    	<td colspan="9">&nbsp;</td>
    </tr>
