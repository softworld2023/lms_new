...
<table width="1280" id="list_table">
    ...
    while($get_p = mysql_fetch_assoc($package_q))
	{
		...
		$prevbal13_q = mysql_query("SELECT SUM(amount) AS amtPay FROM cashbook WHERE package_id = '".$get_p['id']."' AND branch_id = '".$_SESSION['login_branchid']."' AND type = 'PAY' AND code =' 'AND date < '".$date."'");
		$get_pb13 = mysql_fetch_assoc($prevbal13_q);


		
		$cfy = $cfy - $get_pby['amtOut'] + $get_pb2y['amtIn'] - $get_pb3y['amtEx'] + $get_pb4y['amtKom'] + $get_pb5y['amtOth'] + $get_pb6y['amtKom2'] + $get_pb7y['amtCCM'] - $get_pb8y['amtTrans'] + $get_pb9y['amtTrans2'] - $get_pb10y['amtExt'] + $get_pb11y['amtKInt'] + $get_pb12y['amtKInt']- $get_pb13['amtPay'];
	?>
    <tr>
    	<td><?php echo $get_p['scheme']; ?></td>
	</tr>
...
?>
	...
	<center><img src="http://www.hangtogetherblog.com/wp-content/uploads/2015/06/permission-sign.gif" alt="Paris" class="center"></center>
