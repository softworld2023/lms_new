...
<table width="1280">
    ...
    <tr>
    	<td colspan="2">
        <div class="subnav">
			<a href="index.php">Borrow Out</a><a href="payout.php">Actual Payout</a>
...
<table width="1280" id="list_table">
    ...
    <tr>
    	<td><?php echo $ctr."."; ?></td>
        <td><a href="package_collection.php?id=<?php echo $get_p['id']; ?>"><?php echo $get_p['scheme']; ?></a></td>
    </tr>
    <?php } ?>
    <tr>
    	<td><?php echo ($ctr+1)."."; ?></td>
        <td><a href="package_collectionsum.php">SUMMARY</a></td>
    </tr>
    <tr>
    	<td colspan="2">&nbsp;</td>
    </tr>
