...
<table width="90%" id="list_table">
	<tr>
	  	<th width="61">Months</th>
	  	<th width="84">Scheduled Date</th>
	  	<th width="67">Receipt No. </th>
	  	<th width="66">Loan Balance</th>
	  	<th width="35">%</th>
    	<th width="142">Payment - Loan</th>
    	<th width="145">Payment - Interest</th>
        <th width="122">Payment Date</th>
    </tr>
    <?php 
	$ctr = 0;
	$latectr = 0;
