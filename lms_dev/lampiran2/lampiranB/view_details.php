...
<tr>
    	<td colspan="4" align="center">&nbsp;&nbsp;&nbsp;<input type="button" name="back" value="Back" class="all_btn" onClick="window.location.href='../lampiranB/index.php?branch_id=<?php echo $_GET['branch_id']; ?>'" ></td>
    </tr>
<hr/>
</div>
<div class="page">
...
<table width="89%"  border="0" align="center" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" font style="font-weight:bold"><p align="center">PERATURAN-PERATURAN PEMBERIAN PINJAM WANG ( KAWALAN DAN  PERLESENAN ) 2003<br>
      ...
      REKOD TRANSAKSI TAHUNAN MENGIKUT PERINCIAN PINJAMAN  BAGI TAHUN <?php echo date("Y"); ?>
      </p>  </br></br></td>
  </tr>
  ...
  <tr>
    ...
    <table width="80%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td colspan="2"><p>:<input type="text" align="center" name="name" id="name" style="border: none" readonly size= "50" value="<?php echo $exp_d['name']; ?>"/></p></td>
      </tr>
	  
      <tr>
        <td><p>JENIS ORGANISASI</p></td>
        <td colspan="2"><p>:&nbsp;<input type="text" align="center" name="organisasi" id="organisasi" style="border: none" readonly value="<?php echo $exp_d['organisasi']; ?>" /></p></td>
      </tr>
	
      <tr>
        <td><p>INDIVIDU BOLEH DIBUHUNGI</p></td>
        <td width="33%"><p>:&nbsp;<input type="text" align="center" name="hubungan" id="hubungan" style="border: none" readonly value="<?php echo $exp_d['hubungan']; ?>"  /></p></td>
        <td width="31%"><p>TEL&nbsp;:&nbsp;<input type="text" align="center" name="tel" id="tel" style="border: none" readonly value="<?php echo $exp_d['tel']; ?>" /></p></td>
      </tr>
      <tr>
        <td><p>TEMPOH TRANSAKSI</p></td>
        <td><p>:&nbsp;DARI &nbsp;<input type="text" align="center" name="trans_from" id="trans_from" style="border: none" readonly value="<?php echo $exp_d['trans_from']; ?>"/></p></td>
        <td><p>HINGGA&nbsp;:&nbsp;<input type="text" align="center" name="trans_until" id="trans_until" style="border: none" readonly value="<?php echo $exp_d['trans_until']; ?>"/></p></td>
      </tr>
      <tr>
        <td><p>NO. LESEN PEMBERI PINJAMAN WANG</p></td>
        <td colspan="2"><p>:&nbsp;<input type="text" align="center" name="no_lesen" id="no_lesen" style="border: none" readonly value="<?php echo $exp_d['tel']; ?>"/></p></td>
      </tr>
    </table>
	</td>
  </tr>
    ...
    <table width="97%" align="center" border="1" cellspacing="0" cellpadding="0">
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					...
					<td width="65" ><center><p><input type="text" align="center" name="plulus" id="plulus" style="border: none" readonly value="<?php echo number_format($plulus['plulus'], '2'); ?>"/></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="k_tahun" id="k_tahun" style="border: none" readonly /></p></center></td>
				</tr>
			</table>
		</center>		
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="bercagar" id="bercagar" style="border: none" readonly /></p></center></td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="t_bercagar" id="t_bercagar" style="border: none" readonly /></p></center></td>
					<td width="30"><p>perjanjian</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="jumlah_pinjaman" id="jumlah_pinjaman" style="border: none" readonly /></p></center></td>
					<td width="30"><p>perjanjian</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="k_individu" id="k_individu" style="border: none" readonly /></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="k_syarikat" id="k_syarikat" style="border: none" readonly /></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="k_awam" id="k_awam" style="border: none" readonly /></p></center></td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="k_swasta" id="k_swasta" style="border: none" readonly /></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="peniaga" id="peniaga" style="border: none" readonly /></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="t_kerja" id="t_kerja" style="border: none" readonly /></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="t_info" id="t_info" style="border: none" readonly /></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="pmelayu" id="pmelayu" style="border: none" readonly value="<?php echo $pmelayu; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="pcina" id="pcina" style="border: none" readonly value="<?php echo $pcina; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="pindia" id="pindia" style="border: none" readonly value="<?php echo $pindia; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="plain" id="plain" style="border: none" readonly  value="<?php echo $plain; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="nmelayu" id="nmelayu" style="border: none" readonly value="<?php echo number_format($nmelayu['lamt'], '2'); ?>"></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65"><center><p><input type="text" align="center" name="ncina" id="ncina" style="border: none" readonly value="<?php echo number_format($ncina['lamt'], '2'); ?>"></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="nindia" id="nindia" style="border: none" readonly value="<?php echo number_format($nindia['lamt'], '2'); ?>"></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="nlain" id="nlain" style="border: none" readonly value="<?php echo number_format($nlain['lamt'], '2'); ?>"></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p500" id="p500" style="border: none" readonly value="<?php echo $p500; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p1000" id="p1000" style="border: none" readonly value="<?php echo $p1000; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p5000" id="p5000" style="border: none" readonly  value="<?php echo $p5000; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p10000" id="p10000" style="border: none" readonly value="<?php echo $p10000; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p10001" id="p10001" style="border: none" readonly value="<?php echo $p10001; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a1000" id="a1000" style="border: none" readonly value="<?php echo $a1000; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a5000" id="a5000" style="border: none" readonly value="<?php echo $a5000; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a10000" id="a10000" style="border: none" readonly value="<?php echo $a10k; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a50000" id="a50000" style="border: none" readonly value="<?php echo $a50k; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a100000" id="a100000" style="border: none" readonly value="<?php echo $a100k; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65"><center><p><input type="text" align="center" name="a1ml" id="a1ml" style="border: none" readonly value="<?php echo $a1m; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a1ml" id="a1ml" style="border: none" readonly value="<?php echo $a1ml; ?>"></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="p_bumiputera" id="p_bumiputera" style="border: none" readonly /></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="p_bukan_bumi" id="p_bukan_bumi" style="border: none"  readonly /></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="s_bumiputera" id="s_bumiputera" style="border: none" readonly /></p></center></td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="s_bukan_bumi" id="s_bukan_bumi" style="border: none" readonly /></p></center></td>
					<td width="30"><p>Syarikat</p></td>
				</tr>
			</table>
		</center>
