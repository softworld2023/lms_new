          ...
          <table width="85%" id="table_form">
            ...
            <tr>
			  ...
			  <?php $ctr_1=0; if($get_a['a_shoplotfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/".$id."/".$get_a['a_shoplotfile']; ?>" target="_blank"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
            ...
            <tr>
			  ...
			  <?php $ctr_3=0; if($get_a['a_bankfile'] != '') { ?>
                  <td><a href="<?php echo "../files/customer/".$id."/".$get_a['a_bankfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
						//callout uploaded files
            ...
            <tr>
			  ...
			  <?php $ctr_4=0; if($get_a['a_payslipfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/".$id."/".$get_a['a_payslipfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
						//callout uploaded files
            ...
            <tr>
			  ...
			  <?php $ctr_5=0; if($get_a['a_atmfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/".$id."/".$get_a['a_atmfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
					//callout uploaded files
            ...
            <tr>
			  ...
			  <?php $ctr_6=0; if($get_a['a_housefile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/".$id."/".$get_a['a_housefile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
						//callout uploaded files
