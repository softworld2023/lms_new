...
if (!file_exists($_SESSION['login_branchid'].'/appform/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/appform/'.$id, 0777, true);
}

if (!file_exists($_SESSION['login_branchid'].'/custic/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/custic/'.$id, 0777, true);
}

if (!file_exists($_SESSION['login_branchid'].'/bankstat/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/bankstat/'.$id, 0777, true);
}

if (!file_exists($_SESSION['login_branchid'].'/salaryslip/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/salaryslip/'.$id, 0777, true);
}

if (!file_exists($_SESSION['login_branchid'].'/atmcard/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/atmcard/'.$id, 0777, true);
}

if (!file_exists($_SESSION['login_branchid'].'/mortgage/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/mortgage/'.$id, 0777, true);
}

if (!file_exists($_SESSION['login_branchid'].'/guarantorform/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/guarantorform/'.$id, 0777, true);
}

if (!file_exists($_SESSION['login_branchid'].'/others/'.$id)) 
{
	mkdir($_SESSION['login_branchid'].'/others/'.$id, 0777, true);
}
        	...
        	<table width="85%" id="table_form">
                ...
                <tr>
					...
					<table>
						...
						if ($handle = opendir($_SESSION['login_branchid'].'/appform/'.$id.'/'))
						 {
						...
						?>
									<td align="center">
									<a href="<?php echo $_SESSION['login_branchid']; ?>/appform/<?php echo $id; ?>/<?php echo $entry; ?>" rel="shadowbox()"><img src="<?php echo $_SESSION['login_branchid']; ?>/appform/<?php echo $id; ?>/<?php echo $entry; ?>" width="30" /></a><br /><a href="javascript:deleteAF('<?php echo $entry; ?>', '<?php echo $_SESSION['login_branchid']; ?>/appform/<?php echo $id; ?>/')" title="Delete"><img src="../img/delete-btn.png" width="15" /></a>
									</td>
						<?php
						...
						<td><a href="multiimage/index.html" rel="shadowbox"><img src="../img/browse.JPG" /></a></td>
						</tr>
					</table>
					</td>
            	</tr>
                <tr>
                    ...
                    <td>
                      ...
                      <?php } ?>
						...
						if ($handle = opendir($_SESSION['login_branchid'].'/custic/'.$id.'/'))
						 {
							while (false !== ($entry = readdir($handle))) 
							{
								if ($entry != "." && $entry != "..") 
						...
						?>
									<td align="center">
									<a href="<?php echo $_SESSION['login_branchid']; ?>/custic/<?php echo $id; ?>/<?php echo $entry; ?>" rel="shadowbox()"><img src="<?php echo $_SESSION['login_branchid']; ?>/custic/<?php echo $id; ?>/<?php echo $entry; ?>" width="30" /></a><br /><a href="javascript:deleteAF('<?php echo $entry; ?>', '<?php echo $_SESSION['login_branchid']; ?>/custic/<?php echo $id; ?>/')" title="Delete"><img src="../img/delete-btn.png" width="15" /></a>
									</td>
						<?php
						...
						?>
						<td><a href="multiimage/ic.html" rel="shadowbox"><img src="../img/browse.JPG" /></a></td>
						</tr>
						</table>
					  </td>
                </tr>
						...
						if ($handle = opendir('bankstat/'.$id.'/'))
						 {
							while (false !== ($entry = readdir($handle))) 
							{
								if ($entry != "." && $entry != "..") 
								{
									...
									$filename = explode('.', $entry);
									$image_link = $_SESSION['login_branchid']."bankstat/".$id."/".$entry;
									$ctr_3++;
						?>
                ...
                <td align="left" style="padding-right:10px">Salary Slips </td>
                    <td>
                      ...
                      <?php } ?>
						...
						if ($handle = opendir($_SESSION['login_branchid'].'/salaryslip/'.$id.'/'))
						 {
							while (false !== ($entry = readdir($handle))) 
							{
								if ($entry != "." && $entry != "..") 
						...
						?>
									<td>
									<a href="<?php echo $_SESSION['login_branchid']; ?>/salaryslip/<?php echo $id; ?>/<?php echo $entry; ?>" rel="shadowbox()"><img src="<?php echo $_SESSION['login_branchid']; ?>/salaryslip/<?php echo $id; ?>/<?php echo $entry; ?>" width="30" /></a><br /><a href="javascript:deleteAF('<?php echo $entry; ?>', '<?php echo $_SESSION['login_branchid']; ?>/salaryslip/<?php echo $id; ?>/')" title="Delete"><img src="../img/delete-btn.png" width="15" /></a>
									</td>
						<?php
						...
						?>
                      	<td><a href="multiimage/salary.html" rel="shadowbox"><img src="../img/browse.JPG" /></a></td>
						</tr>
						</table>
					</td>
              </tr>
              <tr>
                ...
                <td>
					...
					if ($handle = opendir($_SESSION['login_branchid'].'/atmcard/'.$id.'/'))
					 {
						while (false !== ($entry = readdir($handle))) 
						{
							if ($entry != "." && $entry != "..") 
					...
					?>
								<td>
								<a href="<?php echo $_SESSION['login_branchid']; ?>/atmcard/<?php echo $id; ?>/<?php echo $entry; ?>" rel="shadowbox()"><img src="<?php echo $_SESSION['login_branchid']; ?>/atmcard/<?php echo $id; ?>/<?php echo $entry; ?>" width="30" /></a><br /><a href="javascript:deleteAF('<?php echo $entry; ?>', '<?php echo $_SESSION['login_branchid']; ?>/atmcard/<?php echo $id; ?>/')" title="Delete"><img src="../img/delete-btn.png" width="15" /></a>
								</td>
					<?php
                    ...
                    <td><a href="multiimage/atm.html" rel="shadowbox"><img src="../img/browse.JPG" /></a></td>
					</tr>
					</table>
					</td>
              </tr>
              ...
              <tr>
                    ...
                    <?php } ?>
						...
						if ($handle = opendir($_SESSION['login_branchid'].'/mortgage/'.$id.'/'))
						 {
							while (false !== ($entry = readdir($handle))) 
							{
								if ($entry != "." && $entry != "..") 
								{
									...
									$filename = explode('.', $entry);
						?>
									<a href="<?php echo $_SESSION['login_branchid']; ?>/mortgage/<?php echo $id; ?>/<?php echo $entry; ?>" rel="shadowbox()"><img src="<?php echo $_SESSION['login_branchid']; ?>/mortgage/<?php echo $id; ?>/<?php echo $entry; ?>" width="30" /></a>
						<?php
                    	...
                    	<a href="multiimage/mortgage.html" rel="shadowbox"><img src="../img/browse.JPG" /></a>
					</td>
              </tr>
              <tr>
					...
					<?php
						...
						if ($handle = opendir($_SESSION['login_branchid'].'/guarantorform/'.$id.'/'))
						 {
							while (false !== ($entry = readdir($handle))) 
							{
								if ($entry != "." && $entry != "..") 
								{
									...
									$filename = explode('.', $entry);
						?>
									<a href="<?php echo $_SESSION['login_branchid']; ?>/guarantorform/<?php echo $id; ?>/<?php echo $entry; ?>" rel="shadowbox()"><img src="<?php echo $_SESSION['login_branchid']; ?>/guarantorform/<?php echo $id; ?>/<?php echo $entry; ?>" width="30" /></a>
						<?php
                    	...
                    	<a href="multiimage/guarantorform.html" rel="shadowbox"><img src="../img/browse.JPG" /></a>
					</td>
              </tr>
              <tr>
						...
						if ($handle = opendir('others/'.$id.'/'))
						 {
							while (false !== ($entry = readdir($handle))) 
							{
								if ($entry != "." && $entry != "..") 
								{
									...
									$filename = explode('.', $entry);
									$image_link =  $_SESSION['login_branchid']/"others/".$id."/".$entry;
									$ctr_8++;
						?>
...
function checkForm()
{
	if((document.getElementById('name').value != '' && document.getElementById('mobile_contact').value != ''))
	{
		$('#message').empty();
		return true;	
	}
