...
if(isset($_POST['add_staff']))
{
	...
	//insert staff
	$insert_q = mysql_query("INSERT INTO user SET username = '".$username."', pswd = '".$hash_pswd."', fullname = '".$staffname."', level = '".$level."', branch_id = '".$branch_id."', branch_name = '".$get_branch['branch_name']."', time_created = now()");
	...
	if($insert_q)
	{
		...
		$ac_q = mysql_query("INSERT INTO accessright SET staffid = '".$id."', home_page = 'on', files_page = 'on', customer_page = 'on', loan_page = 'on', cashbook_page = 'on', report_page = 'on', setting_page = 'on', help_page = 'on'") or die(mysql_query());
...
if(isset($_POST['edit_staff']))
{
	...
	//update staff
	$update_q = mysql_query("UPDATE user SET username = '".$username."', fullname = '".$staffname."' WHERE id = '".$id."'")or die(mysql_error());
	...
	if($update_q)
	{
		...
		$_SESSION['msg'] = "<div class='success'>Your account has been successfully updated.</div>";
