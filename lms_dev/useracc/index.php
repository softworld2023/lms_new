...
<table width="1280" id="list_table">
    ...
    <tr>
        ...
        <input type="reset" id="reset" name="reset" value="">&nbsp;&nbsp;&nbsp;<input type="button" name="back" id="back" onClick="window.history.go(-1)" value="">        </td>
    </tr>
    <tr>
    	<td colspan="2">&nbsp;</td> 
    </tr>
...
function checkForm()
{
	if((document.getElementById('staffname').value != '' && document.getElementById('username').value != ''))
	{
