...
// if($_SESSION['login_database'] != '')
// {
// 	$conn_database = $_SESSION['login_database'];
// }else
// {
// 	$conn_database = "majusama";
...
$conn_username = "root";
$conn_password = "";
$conn_database = ""; // Set the appropriate default database name here

$conn_connection = mysql_connect($conn_hostname, $conn_username, $conn_password) or trigger_error(mysql_error(),E_USER_ERROR); 

if (!empty($_SESSION['login_database'])) {
    $database = $_SESSION['login_database'];
    mysql_select_db($database, $conn_connection);
    $conn_database = $database; // Set the value of $conn_database
}
?>