...
<table width="1280" id="list_table">
    ...
    <tr>
        ...
        <td><?php echo "RM ".number_format($get_p['bal1_initial_amount'], '2'); ?></td>
        <td><?php if($get_p['bal1_opening_date'] != '0000-00-00') { echo $get_p['bal1_opening_date']; } else { echo "-"; } ?></td>
        <td>
            ...
            <table>
            	<tr>
                    ...
                    <td style="padding:0px">
                   	  <input type="text" name="amount_<?php echo $ctr; ?>" id="amount_<?php echo $ctr; ?>" value="<?php echo $get_p['bal1_initial_amount']; ?>" class="currency">                    </td>
                    <td>Edit Date</td>
                    <td style="padding:0px">
                   	  <input type="text" name="opening_<?php echo $ctr; ?>" id="opening_<?php echo $ctr; ?>" value="<?php if($get_p['bal1_opening_date'] != '0000-00-00') { echo $get_p['opening_date']; }?>">                    </td>
                    <td>
