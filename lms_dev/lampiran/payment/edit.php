...
$loandetails_q = mysql_query("SELECT * FROM loan_payment_details WHERE nric = '".$ic."' AND customer_loanid='".$loanid."' ORDER BY month ASC ",$db2);

/* $cust_a = mysql_query("SELECT * FROM payment_customer_details WHERE nric = '".$ic."'",$db2);
$get_cust = mysql_fetch_assoc($cust_a); */

$loandetails_r = mysql_query("SELECT * FROM loan_payment_details WHERE nric = '".$ic."' AND month ='1' AND customer_loanid='".$loanid."'",$db2);
...
<table width="1280" id="list_table">
    ...
    <tr>
		...
		<input type="text" name="customercode" id="customercode" value="<?php echo $get_custa['cust_id']; ?>" style="width:230px" /></td>
    ...
    <tr>
      ...
      <td style="padding:0px">Loan Amount (RM) </td>
        ...
        <td><input type="text" name="a_paymentdate" id="a_paymentdate" style="width:230px" value="<?php  if ($ldrow['next_paymentdate'] == 0000-00-00){ echo "&nbsp;"; } else {  echo date('d-m-Y', strtotime($ldrow['next_paymentdate'])); } ?>" /></td>
    </tr> 
    <tr>
    ...
    <tr>
      ...
      <td rowspan="3"><textarea name="aremarks" id="aremarks" style="width:230px; height:90px"><?php echo $get_custa['notes']; ?></textarea></td>
...
&nbsp;month(s) </td>
      ...
      <td rowspan="3"><textarea name="loanremarks" id="loanremarks" style="width:230px; height:90px"><?php echo $get_custa['remark']; ?></textarea></td>
    </tr>
    <tr>
...
function payConfirm(month)
{
	if(document.getElementById('receipt_no').value == ""){
		...
		$loan_code = document.getElementById('loan_code').value;
