...
$loandetails_q = mysql_query("SELECT * FROM loan_payment_details WHERE nric = '".$ic."' AND customer_loanid='".$loanid."' ORDER BY customer_loanid ",$db2);
...
<table width="80%" id="" border="0" style="margin:10px 20px 10px 20px;">
    ...
    <tr>
      ...
      <td style="padding:0px">Loan Amount (RM) :</td>
        ...
        <td><input type="text" name="a_paymentdate" id="a_paymentdate" style="width:180px; border:none;" value="<?php  if ($ldrow['next_paymentdate'] == 0000-00-00){ echo "&nbsp;"; } else {  echo date('d-m-Y', strtotime($ldrow['next_paymentdate'])); } ?>" readonly  /></td>
    </tr> 
    <tr>
