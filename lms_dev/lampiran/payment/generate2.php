...
$get_cust = mysql_fetch_assoc($cust_q);
*/
$add_q = mysql_query("SELECT * FROM customer_address WHERE customer_id = '".$get_cust['id']."'", $db1);
...
*/
$acc_q = mysql_query("SELECT * FROM customer_account WHERE customer_id = '".$get_cust['id']."'", $db1);
...
<table width="1280" id="list_table">
    ...
    <tr>
        ...
        <td><input type="hidden" name="branch_id" id="branch_id" value="<?php echo $branch_id; ?>"><input type="text" name="customercode" id="customercode" value="<?php echo $get_cust['customercode2']; ?>" style="width:230px" /></td>
        <td style="padding:0px">Package</td>
      <td><input type="text" name="loan_package" id="loan_package" value=""  /></td>
    ...
    <tr>
      ...
      <td><input type="text" name="loan_code" id="loan_code"  value=""  /></td>
      ...
      <input type="text" name="payday" id="payday" placeholder="yyyy-mm-dd" value="" style="width:230px" /></td>
    </tr>
    <tr>
      ...
      <td style="padding:0px">Loan Amount (RM) </td>
        <td><input type="text" name="loan_amount" id="loan_amount" onkeyup="calculateInt()" value=""  />&nbsp;</td>
        <td style="padding:0px">Payment Date </td>
        <td><input type="text" name="a_paymentdate" id="a_paymentdate" placeholder="yyyy-mm-dd" style="width:230px" value="" /></td>
    </tr> 
    <tr>
      <td style="padding:0px">Mobile Phone </td>
      <td><input type="text" name="contact" id="contact" style="width:230px" value="<?php echo $get_add['mobile_contact']; ?>"  /></td>
      ...
      <td><input type="text" name="salary" id="salary" style="width:230px" value=""  /></td>
    </tr>
    <tr>
      <td style="padding:0px">Notes 
	  </td>
      <td rowspan="3"><textarea name="aremarks" id="aremarks" style="width:230px; height:90px"></textarea></td>
      <td style="padding:0px">Loan Period 
        </td>
      <td><input type="text" name="period" id="period" value="" onkeyup="calculateInt()" style="width:70px"  />
&nbsp;month(s) </td>
      <td style="padding:0px">Remarks
	  
	  </td>
      <td rowspan="3"><textarea name="loanremarks" id="loanremarks" style="width:230px; height:90px"></textarea></td>
    </tr>
    <tr>
		...
		<input type="text" name="loan_total" id="loan_total" value=""  /></td>
        <td style="padding:0px">&nbsp;</td>
    </tr>   
	<tr>
		<td  style="padding:0px">&nbsp;</td>
		<td  style="padding:0px">Monthly Payment (RM) </td>
		<td><input type="hidtextden" name="monthly_payment" id="monthly_payment" value="" /></td>
		<td  style="padding:0px">&nbsp;</td>
	</tr>  
