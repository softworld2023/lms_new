...
$loan_q = mysql_query("SELECT * FROM customer_loanpackage WHERE id = '".$id."'",$db2);
$loan = mysql_fetch_assoc($loan_q);

$pay_q = mysql_query("SELECT * FROM loan_payment_details WHERE customer_loanid = '".$loan['id']."' AND month = 1",$db2);
$pay = mysql_fetch_assoc($pay_q);

$cust_q = mysql_query("SELECT * FROM customer_details WHERE customer_id = '".$loan['customer_id']."'",$db2);
