...
$loan_q = mysql_query("SELECT * FROM customer_details2 WHERE id = '".$id."'",$db2);
$loan = mysql_fetch_assoc($loan_q);

$pay_q = mysql_query("SELECT * FROM loan_payment_details WHERE nric = '".$loan['nric']."' AND month = 2",$db2);
...
<input type="button" name="back" id="back" class="btn" onClick="window.location.href='../lampiranJ/index.php?branch_id=<?php echo $_GET['branch_id']?>'" value="Back">
<hr/>
</div>
<div class="page">
