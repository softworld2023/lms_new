...
$exp = mysql_query("SELECT * FROM customer_details2 WHERE id = '".$id."'",$db2);
 ...
 <tr>
  ...
  <tr align="left">
    <td><table width="97%" id="" align="center" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
      <tr align="center">
		...
		$ctr++;			?>
      <tr align="left">
        <td><input type="date" size="15" name="date_borrow" id="date_borrow" font style="font-weight:bold; border: none"  value="<?php echo $exp_t['apply_date']; ?>"></td></td>
        ...
        <td><input type="text" size="19" name="kadar_faedah" id="kadar_faedah" font style="font-weight:bold; border: none" onkeyup="calculateInt()" value="18"></td>
  ...
  <tr align="left">
    ...
    <table width="97%" align="center" id="my-table" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left"><input type="hidden" name="count" id="count" size="4" value="<?php echo $ctr; ?>">
		<input type="date" size="15" name="date_pay1" id="date_pay1" font style="font-weight:bold; border: none"></td>
...
<script>
var index = parseInt(document.getElementById('ctr').value) + 1;
function insertRow(){
