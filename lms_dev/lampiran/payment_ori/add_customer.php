...
<table width="1280" id="list_table">
    ...
    <tr>
        ...
        <td><input type="hidden" name="branch_id" id="branch_id" value="<?php echo $branch_id; ?>"><input type="text" name="customercode" id="customercode" value="" style="width:230px" /></td>
        <td style="padding:0px">Package</td>
      <td><input type="text" name="loan_package" id="loan_package" value=""  /></td>
      <td style="padding:0px">Bank</td>
      <td><input type="text" name="bankacc" id="bankacc" value="" style="width:230px" /></td>
    </tr>
    <tr>
      <td style="padding:0px">Full Name</td>
        <td><input type="text" name="name" id="name" value="" style="width:230px"  /></td>
      <td style="padding:0px">Loan Code</td>
      <td><input type="text" name="loan_code" id="loan_code"  value=""  /></td>
      <td style="padding:0px">Pay Date</td>
      <td>
      <input type="text" name="payday" id="payday" value="" style="width:230px" /></td>
    </tr>
    <tr>
    	<td style="padding:0px">New I/C. No.</td>
        <td><input type="text" name="nric"  id="nric" style="width:230px" value=""  /></td>
      <td style="padding:0px">Loan Amount (RM) </td>
        ...
        <td><input type="text" name="a_paymentdate" id="a_paymentdate" style="width:230px" value="" /></td>
    </tr> 
    <tr>
      <td style="padding:0px">Mobile Phone </td>
      <td><input type="text" name="contact" id="contact" style="width:230px" value=""  /></td>
