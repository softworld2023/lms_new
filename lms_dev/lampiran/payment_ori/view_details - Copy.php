 ...
 <tr>
  ...
  <tr align="left">
    <td><table width="97%" align="center" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
	  ...
	  <?php
		...
		?>
		<tr align="center">
        <td><input type="text" size="11" name="date_borrow" id="date_borrow" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['date_borrow']; ?>"></td></td>
        <td><input type="text" size="10" name="pinjaman_pokok" id="pinjaman_pokok" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['pinjaman_pokok']; ?>"></td>
        <td><input type="text" size="9" name="jumlah_faedah" id="jumlah_faedah" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['jumlah_faedah']; ?>"></td>
        <td><input type="text" size="11" name="jumlah_besar" id="jumlah_besar" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['jumlah_besar']; ?>"></td>
        <td><input type="text" size="14" name="kadar_faedah" id="kadar_faedah" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['kadar_faedah']; ?>"></td>
        ...
        <td><input type="text" size="15" name="tempoh_bayaran" id="tempoh_bayaran" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['tempoh_bayaran']; ?>"></td>
        <td><input type="text" size="14" name="bayaran_sebulan" id="bayaran_sebulan" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['bayaran_sebulan']; ?>"></td>
      </tr>
		<?php } ?>
    </table></td>
  </tr>
  ...
  <tr align="center">
    ...
    <table width="97%" align="center" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
	  ...
	  <?php
	   $expf = mysql_query("SELECT * FROM customer_payment WHERE nric = '".$ic."'",$db2);
		while($exp_f = mysql_fetch_assoc($expf)){
			?>
      <tr  align="center">
        <td align="center"><input type="text" size="11" name="date_pay" id="date_pay" readonly="readonly" value="<?php echo $exp_f['date_pay']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="13" name="jumlah_pinjaman" id="jumlah_pinjaman" readonly="readonly" value="<?php echo $exp_f['jumlah_pinjaman']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="13" name="bayaran_pinjaman" id="bayaran_pinjaman" readonly="readonly" value="<?php echo $exp_f['bayaran_pinjaman']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="13" name="baki_pinjaman" id="baki_pinjaman" readonly="readonly" value="<?php echo $exp_f['baki_pinjaman']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="14" name="resit_no" id="resit_no" readonly="readonly" value="<?php echo $exp_f['resit_no']; ?>" font style="font-weight:bold; border: none"></td>
