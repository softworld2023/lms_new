...
$sql_q = mysql_query("SELECT * FROM  customer_b1 WHERE branch_id = '".$branch_id."'" );
...
&nbsp;<button class="all_btn" onClick="print();">Print</button>&emsp;
  ...
  <tr>
    ...
    <table width="97%" align="center" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr align="center">
        ...
        <td><input type="hidden" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="13" id="name<?php echo $c; ?>" name="name<?php echo $c; ?>" value="<?php echo strtoupper($sql['name']); ?>"><?php echo strtoupper($sql['name']); ?></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;"readonly="readonly"  size="6" id="loan_total<?php echo $c; ?>" name="loan_total<?php echo $c; ?>"  value="<?php echo strtoupper($sql['loan_total']); ?>"></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;"readonly="readonly" size="6"  id="balance<?php echo $c; ?>" name="balance<?php echo $c; ?>"  value="<?php echo strtoupper($sql['balance']); ?>"></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="4" id="loan_period<?php echo $c; ?>" name="loan_period<?php echo $c; ?>"  value="<?php echo strtoupper($sql['loan_period']); ?>"></td>
        <td><input type="hidden" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="7" id="payout_date<?php echo $c; ?>" name="payout_date<?php echo $c; ?>"  value="<?php echo strtoupper($sql['payout_date']); ?>"><?php echo strtoupper($sql['payout_date']); ?></td>
        <td><input type="hidden" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="10" id="mobile_contact<?php echo $c; ?>" name="mobile_contact<?php echo $c; ?>" value="<?php echo $sql['mobile_contact']; ?>"><?php echo $sql['mobile_contact']; ?></td>
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="4" id="int_percent<?php echo $c; ?>" name="int_percent<?php echo $c; ?>" value="<?php echo $sql['int_percent']; ?>"></td>
        <td><input type="hidden" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="12" id="jenis_cagaran<?php echo $c; ?>" name="jenis_cagaran<?php echo $c; ?>"  value="<?php echo $sql['jenis_cagaran']; ?>"><?php echo $sql['jenis_cagaran']; ?>&nbsp;</td>
		<td colspan="2"><input type="hidden" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="8" id="taraf<?php echo $c; ?>" name="taraf<?php echo $c; ?>"  value="<?php echo $sql['taraf']; ?>"><?php echo $sql['taraf']; ?>&nbsp;</td>								
        <td><input type="text" style="font-weight:bold; font-size:14px; border: none; text-transform: uppercase;" readonly="readonly" size="7" id="race<?php echo $c; ?>" name="race<?php echo $c; ?>" value="<?php echo strtoupper($sql['race']); ?>"></td>
		<td><input type="text" style="font-weight:bold; font-size:14px; border: none; text-transform: uppercase;" readonly="readonly" size="8" id="employer<?php echo $c; ?>" name="employer<?php echo $c; ?>" value="<?php echo strtoupper($sql['employer']); ?>"></td>
		<td><input type="text" style="font-weight:bold; font-size:14px; border: none; text-transform: uppercase;"  readonly="readonly" size="5" id="salary<?php echo $c; ?>" name="salary<?php echo $c; ?>" value="<?php echo $sql['salary']; ?>"></td>
        <td><input type="hidden" style="font-weight:bold; font-size:14px; border: none;" readonly="readonly" size="4" id="remark<?php echo $c; ?>" name="remark<?php echo $c; ?>"  value="<?php echo strtoupper($sql['remark']); ?>"><?php echo strtoupper($sql['remark']); ?></td>
      </tr>
	  <?php } ?>
    </table></td>
  </tr>
