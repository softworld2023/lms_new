...
<table width="1280" id="list_table">
	...
	<tr>
        ...
        <td><input type="text" name="transfer_details" id="transfer_details" style="width:350px" /></td>
    </tr>
    <tr>
    	<th>Date</th>
        <td><input type="text" name="transfer_date" id="transfer_date" /></td>
    </tr>
    <tr>
        <th>Transfer From </th>
        <td>
    ...
    <tr>
        ...
        <td>
			<select name="to_package" id="to_package" style="height:30px">
				...
				{
				?>
				<option value="<?php echo $get_p2['id'] ?>"><?php echo $get_p2['scheme']; ?></option>
				<?php
				} 
				?>
			</select>
    ...
    <tr>
    	<th>Amount</th>
        <td><input type="text" name="transfer_amount" id="transfer_amount" class="currency" /></td>
	</tr>
    <tr>
    	<td colspan="2">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="2" align="right"><input type="submit" name="new_transfer" id="new_transfer" value="">&nbsp;&nbsp;&nbsp;
...
$('#transfer_date').click( function(e) {$(this).off('click').AnyTime_picker({ format: "%d-%m-%Y", labelTitle: "Select Date"}).focus(); } ).
keydown(
	function(e)
    {
