...
$sql = mysql_query("SELECT * FROM enquiry WHERE id = '".$id."'");
...
<center>
<form action="action.php" method="post" id="en" name="en" enctype="multipart/form-data" onSubmit="return checkForm()"><input type="hidden" name="id" id="id" value="<?php echo $id; ?>"/>
<table width="1280" id="list_table">
	<tr>
    	<td>
        	<table>
            	<tr>
                	<td style="padding-left:15px"><img src="../img/expenses.png" width="56"></td>
                    <td style="padding-left:15px">Edit Enquiry</td>
                </tr>
            </table>
      </td>
    </tr>
        	...
        	<center>
       	  <table width="85%" id="table_form">
                ...
                <tr>
                    ...
                    <td width="60%"><input type="text" name="enq_date" id="enq_date" tabindex="1" value="<?php echo date('d-m-Y', strtotime($get_q['enq_date'])); ?>" /></td>
            	</tr>
                <tr>
                	<td align="right" style="padding-right:10px">Full Name (as per I/C)</td>
                    <td><input type="text" name="cust_name" id="cust_name" tabindex="1" style="width:300px" value="<?php echo $get_q['cust_name']; ?>" /></td>
            	</tr>
                <tr>
               	  <td align="right" style="padding-right:10px">New I.C. Number</td>
                    <td><span style="padding-right:10px">
                      <input type="text" name="nric" id="nric" tabindex="1" value="<?php echo $get_q['icno']; ?>" />
                    </span></td>
                </tr>
                 <tr>
                	<td align="right" style="padding-right:10px">Old I.C. Number</td>
                    <td><input type="text" name="oldicno" id="oldicno" tabindex="1" value="<?php echo $get_q['oldic']; ?>" /></td>
            	</tr>
                 <tr >
                	<td align="right" style="padding-right:10px">Others&nbsp;<input type="radio" id="oth" name="otherno" value="other" style="margin-top: -1px;
  vertical-align: middle;"/>&nbsp;
                    Police&nbsp;<input type="radio" name="otherno" id="police" value="police" <?php if($get_q['othersno'] == 'police') { echo 'checked'; } ?> style="margin-top: -1px;
  vertical-align: middle;" />&nbsp;Army<input type="radio" name="otherno" id="army" value="army" <?php if($get_q['othersno'] == 'army') { echo 'checked'; } ?> style="margin-top: -1px;
  vertical-align: middle;" /></td>
                    <td><input type="text" name="no_oth" id="no_oth" tabindex="1" value="<?php echo $get_q['othersno_detail']; ?>" /></td>
            	</tr>
                 <tr>
                	<td align="right" style="padding-right:10px">Mobile Phone</td>
                    <td><input type="text" name="mobile" id="mobile" tabindex="1" value="<?php echo $get_q['mobile']; ?>" /></td>
            	</tr>
                 <tr>
                	<td align="right" style="padding-right:10px">Home Phone</td>
                    <td><input type="text" name="homephone" id="homephone" tabindex="1" value="<?php echo $get_q['home']; ?>" /></td>
            	</tr>
                 <tr>
                	<td align="right" style="padding-right:10px">Email Address</td>
                    <td><input type="text" name="email" id="email" tabindex="1" value="<?php echo $get_q['email']; ?>" /></td>
            	</tr>
                 <tr>
  ...
  vertical-align: middle;" <?php if($get_q['race'] == 'malay') { echo 'checked'; }?>/></td>
  ...
  vertical-align: middle;" <?php if($get_q['race'] == 'chinese') { echo 'checked'; }?> /></td>
  ...
  vertical-align: middle;" <?php if($get_q['race'] == 'indian') { echo 'checked'; }?> /></td>
								<td style="padding-left:5px; padding-right:20px">Indian</td>
								<td><input type="radio" name="race" value="others" onclick="show()" <?php if($get_q['race'] == 'others') { echo 'checked'; }?> id="others_race" style="margin-top: -1px; vertical-align: middle;" /></td>
                 ...
                 <tr>
                    ...
                    <td><?php if($get_q['race'] == 'others') { ?><input type="text" name="other_race_name" id="other_race_name" value="<?php echo $get_q['other_race']; ?>" /><?php } ?></td>
            	</tr>
                ...
                <tr>
                    ...
                    <td>
						...
						{
						?>
							<option value="<?php echo $branch['branch_name']; ?>" <?php if($get_q['branch'] == $branch['branch_name']) { echo 'selected'; }?>><?php echo $branch['branch_name']; ?></option>
						<?php } ?>
							<option value="OTHERS" <?php if($get_q['branch'] == 'OTHERS') { echo 'selected'; }?>>OTHERS</option>
						</select>
					</td>
            	</tr>
                <tr>
                	<td align="right" style="padding-right:10px; padding-top:10px" valign="top">Remarks</td>
                    <td style="padding-top:4px"><textarea name="remarks" id="remarks" style="width:300px; height:80px" tabindex="1"><?php echo $get_q['remarks']; ?></textarea></td>
            	</tr>
                <tr>
                	<td align="right" style="padding-right:10px">&nbsp;</td>
                    <td>&nbsp;</td>
    	...
    	<td>
        	<table width="100%">
            	<tr>
                    ...
                    <td align="right"><input type="submit" name="edit_enquiry" id="edit_enquiry" value="" tabindex="1">&nbsp;&nbsp;&nbsp;<input type="reset" id="reset" name="reset" value="">&nbsp;&nbsp;&nbsp;<input type="button" name="back" id="back" onClick="window.location.href='../enquiry/'" value=""></td>
                </tr>
            </table>
        </td>
    </tr>
