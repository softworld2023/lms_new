...
if(isset($_POST['search']))
{
	...
	$statement = "expenses_accountant 
				JOIN expenses ON expenses.expenses_type LIKE concat(expenses_accountant.expenses_type,'%') 
				AND expenses.expenses_details LIKE concat(expenses_accountant.expenses_details,'%')
				AND expenses.created_date = expenses_accountant.created_date
				AND expenses.month_receipt = expenses_accountant.month_receipt 
				WHERE expenses_accountant.display_status = 'SHOW' 
