...
$sql = mysql_query("SELECT * FROM expenses_setting ORDER BY description ASC");
?>
...
<table width="1280">
    ...
    <tr>
    	<td colspan="2">
        <div class="subnav">
			<a href="index.php">Expenses Listing</a><a href="setting.php" id="active-menu">Expenses Type Setting</a><a href="expenses_accountant.php">Expenses Listing (Accountant)</a>
		</div>	
        </td>
...
<table width="1280" id="list_table">
    ...
    <tr>
    	<td colspan="3" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../home/'" value=""></td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    </tr>
