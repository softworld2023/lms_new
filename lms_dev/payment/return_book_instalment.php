...
<table width="1280">
	...
	<tr>
        ...
        <div class="subnav">
            ...
            <a href="return_book_instalment.php" id="active-menu">Return Book (Instalment)</a>
...
<div id="print-only-header">
    <div style="font-size: 20px; font-weight: bold;">RETURN BOOK (INSTALMENT)</div>
