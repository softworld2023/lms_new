...
function recomputeAllNow(){
  ...
  for(r=5;r<=20;r++){ j21+=nv('#j'+r); k21+=nv('#k'+r); l21+=nv('#l'+r); s21+=nv('#s'+r); t21+=nv('#t'+r); u21+=nv('#u'+r); }
  ...
  for(r2=5;r2<=30;r2++){ j39+=nv('#j'+r2); k39+=nv('#k'+r2); l39+=nv('#l'+r2); s39+=nv('#s'+r2); t39+=nv('#t'+r2); u39+=nv('#u'+r2); }
  ...
  jQuery('#f7').html(f7);
  jQuery('#e21').html(nhtml('#f4') + f7 + nhtml('#e12') +nv('#e7')+nv('#e8')+nv('#e9')+nv('#e10'));
