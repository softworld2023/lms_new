<?php
    ...
    if (isset($_POST)) {
        ...
        $sql = "SELECT
            ...
            // =============================
            //  4. Merge non-Bad Debt records with same loan_code + customer_id
            // =============================
            $mergedResults = [];
            foreach ($results as $row) {
                ...
                if ($isBadDebt) {
                    // Keep Bad Debt records as they are
                    $mergedResults[] = $row;
                } else {
                    ...
                    if (!isset($mergedResults[$key])) {
                        ...
                        if (is_numeric($row['tepi'])) {
                            // $mergedResults[$key]['tepi'] += $row['tepi'];
                            $mergedResults[$key]['tepi'];
                        }
