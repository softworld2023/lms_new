...
$finalloan = mysql_fetch_assoc($loandetails_q);
...
<table width="1280" id="list_table">
	...
	<tr <?php echo $style;?>>
      	<td><?php echo $ctr; ?></td>
      	<td><?php if($_SESSION['login_username'] != 'softworld' && $_SESSION['login_username'] != 'fong') { echo date('d-m-Y', strtotime($get_l['next_paymentdate'])); } else { ?>
		...
		<input type="hidden" name="schedule" id="schedule" value="<?php echo date('Y', strtotime($get_l['next_paymentdate'])); ?>" />
			...
			<input type="text"  name="payment_date" id="payment_date" style="width:80px" value="<?php echo date('d-m-Y'); ?>" />
            <?php } ?>
            <?php } else { if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'zoey')) { ?>
