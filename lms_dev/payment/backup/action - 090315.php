...
if($_POST['action'] == 'payloanf2') //flexi tapi resit guna code yang sama
{
	...
	if($new_loan == '')
	{
		...
		if($loan_balance > 0)
		{
			...
			if($amount == 0)
			{
				...
				$cashbook3_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'COMMISSION', amount = '".$int_amount."', transaction = 'KOMISYEN2', customer_id = '".$get_lp['customer_id']."', receipt_no = '".$receipt_no."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
				
				//insert to balance2 record the interest
				$balance2_ql = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', interest2 = '".$int_amount."', month_receipt = '".$month_receipt."', bal_date = '".$date."'");
			...
			}else
			{
				...
				$cashbook_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'RECEIVED', amount = '".$amount."', transaction = 'CCM', code = '".$loancode."', receipt_no = '".$get_q['receipt_no']."', customer_id = '".$get_lp['customer_id']."', table_id = '".$id."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
				
				if($int_amount != 0)
				{				
					//insert to cashbook record the interest
					$cashbook3_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'COMMISSION', amount = '".$int_amount."', transaction = 'KOMISYEN2', customer_id = '".$get_lp['customer_id']."', receipt_no = '".$receipt_no."', date = '".$date."'");
				}
							
				//insert into balance1 rec the actual amount paid
				$balance1_qr = mysql_query("INSERT INTO balance_transaction SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$amount."', date = '".$date."'");
			
				//insert into balance2 rec the actual amount paid
				$balance2_qr = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$amount."', month_receipt = '".$month_receipt."', bal_date = '".$date."'");
				
				
				//insert into balance2 rec the int amount paid
				if($int_amount != 0)
				{
					$balance2_qri = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', interest2 = '".$int_amount."', month_receipt = '".$month_receipt."', bal_date = '".$date."'");
				}
		...
		}else
		{
			...
			{				
				...
				$cashbook3_q = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', interest2 = '".$int_amount."',  month_receipt = '".$get_q['month_receipt']."', bal_date = '".$date."'");
			}
	...
	{	
		...
		if($amount != 0)
		{
			...
			$cashbook_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'RECEIVED', amount = '".$amount."', transaction = 'REC', code = '".$loancode."', receipt_no = '".$get_q['receipt_no']."', customer_id = '".$get_lp['customer_id']."', table_id = '".$id."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
			
			//insert to cashbook (add new loan to record)
			$cashbook2_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'PAY', amount = '".$new_loan."', transaction = 'LOAN', code = '".$loancode."', receipt_no = '".$receipt_no."', customer_id = '".$get_lp['customer_id']."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
			
			//insert into cashbook interest transaction
			$cashbook3_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'COMMISSION', amount = '".$newinterest."', transaction = 'KOMISYEN', receipt_no = '".$receipt_no."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
			
			//insert into balance1 new loan amount
			$balance1_qr = mysql_query("INSERT INTO balance_transaction SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', loan = '".$new_loan."', date = '".$date."'");
			...
			$balance2_qr = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', loan = '".$new_loan."', month_receipt = '".$month_receipt."', bal_date = '".$date."'");
		...
		{// just add loan no payment
			...
			//insert to cashbook (add new loan to record)
			$cashbook2_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'PAY', amount = '".$new_loan."', transaction = 'EXT', code = '".$loancode."', receipt_no = '".$receipt_no."', customer_id = '".$get_lp['customer_id']."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
			...
			//insert new loan_payment_details
			$nm = $get_q['month'] + 1;
			$insert_lp_q = mysql_query("INSERT INTO loan_payment_details SET customer_loanid = '".$get_q['customer_loanid']."', month = '".$nm."', int_percent = '".$get_q['int_percent']."', balance = '".$nbalance."', next_paymentdate = '".$next_paymentdate."', package_id = '".$get_q['package_id']."', receipt_no = '".$receipt_no."', month_receipt = '".$month_receipt."'");
		...
		if($loan_balance > 0)
		{
			...
			if($amount == 0)
			{
				...
				{			
					...
					$cashbook_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'RECEIVED', amount = '".$loan_balance."', transaction = 'REC', code = '".$loancode."', receipt_no = '".$get_q['receipt_no']."', customer_id = '".$get_lp['customer_id']."', table_id = '".$id."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
					
					//insert to cashbook pay the loan (new receipt no)
					$cashbook2_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'PAY', amount = '".$loan_balance."', transaction = 'LOAN', code = '".$loancode."', receipt_no = '".$receipt_no."', customer_id = '".$get_lp['customer_id']."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
					
					//insert into balance1 (transaction shows that settle the loan but actually only pay for the interest (tukar resit)
				$balance1_qr = mysql_query("INSERT INTO balance_transaction SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$loan_balance."', date = '".$date."'");
				
					//insert to balance1 pay the loan (new receipt no)
					$balance1_ql = mysql_query("INSERT INTO balance_transaction SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', loan = '".$loan_balance."', date = '".$date."'");
					
					//insert into balance2 (transaction shows that settle the loan but actually only pay for the interest (tukar resit)
					$balance2_qr = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$loan_balance."', month_receipt = '".$get_q['month_receipt']."', bal_date = '".$date."'");
					
					//insert to balance2 pay the loan (new receipt no)
					$balance2_ql = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', loan = '".$loan_balance."', month_receipt = '".$month_receipt."', bal_date = '".$date."'");
				}
				
				//insert to cashbook record the interest
				$cashbook3_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'COMMISSION', amount = '".$int_amount."', transaction = 'INT', customer_id = '".$get_lp['customer_id']."', code = '".$receipt_no."', receipt_no = '".$receipt_no."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
			...
			}else
			{
				...
				{				
					//insert to cashbook record the interest
					$cashbook3_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'COMMISSION', amount = '".$int_amount."', transaction = 'KOMISYEN', receipt_no = '".$receipt_no."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
				}
...
if($_POST['action'] == 'payloan')
{
	...
	if($ar == 0)
	{
		...
		if($update_q)
		{
			$cashbook_q = mysql_query("INSERT INTO cashbook SET type = 'RECEIVED', package_id = '".$get_q['package_id']."', table_id = '".$id."', transaction = 'REC', code = '".$get_lp['loan_code']."', receipt_no = '".$get_q['receipt_no']."', customer_id = '".$get_lp['customer_id']."', amount = '".$amount."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
			
			/*if($num_select == '1')
			{*/
				$balance2_q = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$amount."', bal_date = '".$date."'");
				$balance1_q = mysql_query("INSERT INTO balance_transaction SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$amount."', date = '".$date."'");
			/*}
			else
			{
				$actamt = $amount - $min_int;
			...
			if($newmonth <= $period)
			{
				...
				if($newbalance > 0)
				{
					$insert_new = mysql_query("INSERT INTO loan_payment_details SET customer_loanid = '".$get_q['customer_loanid']."', month = '".$newmonth."', int_percent = '".$get_q['int_percent']."', balance = '".$newbalance."', monthly = '".$get_mq['monthly']."', pokok = '".$pokok."', interest = '".$get_q['interest']."', next_paymentdate = '".$next_paymentdate."', package_id = '".$get_q['package_id']."', receipt_no = '".$receipt_no."'");
	...
	}else
	{
		...
		if($update_q)
		{
			$cashbook_q = mysql_query("INSERT INTO cashbook SET type = 'RECEIVED', package_id = '".$get_q['package_id']."', table_id = '".$id."', transaction = 'REC', code = '".$get_lp['loan_code']."', amount = '".$amount."', customer_id = '".$get_lp['customer_id']."', receipt_no = '".$get_q['receipt_no']."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
			...
			if($newmonth <= $period)
			{
				...
				if($newbalance > 0)
				{
					$insert_new = mysql_query("INSERT INTO loan_payment_details SET customer_loanid = '".$get_q['customer_loanid']."', month = '".$newmonth."', int_percent = '".$get_q['int_percent']."', balance = '".$newbalance."', monthly = '".$get_mq['monthly']."', pokok = '".$pokok."', interest = '".$intmonthly."', next_paymentdate = '".$next_paymentdate."', package_id = '".$get_q['package_id']."', receipt_no = '".$receipt_no."'");
...
if($_POST['action'] == 'payloan_CEK')
{
	...
	$update_q = mysql_query("UPDATE loan_payment_details SET payment_date = '".$date."', payment = '".$amount."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now() WHERE id = '".$id."'");
	...
	{					
		...
		if($update_bal_q)
		{
			...
			$insert_cb_q = mysql_query("INSERT INTO cashbook SET package_id = '".$get_q['package_id']."', type = 'RECEIVED', transaction = 'REC', code = '".$receipt."', amount = '".$amount."', receipt_no = '".$receipt."', customer_id = '".$get_l['customer_id']."', date = '".$date."', staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."', created_date = now()");
		
			if($insert_cb_q)
			{
				//insert balance1
				$insert_bal1_q = mysql_query("INSERT INTO balance_transaction SET received = '".$amount."', package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', date = '".$date."'");
				
				if($insert_bal1_q)
				{
					//insert balance2
					$insert_bal2_q = mysql_query("INSERT INTO balance_rec SET received = '".$amount."', package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', bal_date = '".$date."'");
