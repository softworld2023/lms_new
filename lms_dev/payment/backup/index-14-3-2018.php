...
<table width="1280" id="list_table">
	...
	$statement = "balance_rec WHERE month_receipt = '".$_SESSION['pmonth']."' AND package_id = '".$_SESSION['package_id']."' AND branch_id = '".$_SESSION['login_branchid']."' AND bal_date <= '".$_SESSION['cdate']."' $cond  GROUP BY customer_loanid";
	$_SESSION['payment_s'] = $statement;
	
	$sql = mysql_query("SELECT * FROM balance_rec WHERE month_receipt = '".$_SESSION['pmonth']."' AND package_id = '".$_SESSION['package_id']."' AND branch_id = '".$_SESSION['login_branchid']."' AND bal_date <= '".$_SESSION['cdate']."' GROUP BY customer_loanid LIMIT {$fromRecordNum}, {$recordsPerPage}");
...
if($num>0){	
	...
	$loancheck_q = mysql_query("SELECT SUM(loan) AS loan FROM balance_rec WHERE customer_loanid = '".$get_q['customer_loanid']."' AND bal_date <= '".$_SESSION['cdate']."' AND month_receipt = '".$_SESSION['pmonth']."'");
	...
	*/
    ...
    <tr <?php echo $style; ?>>
    	...
    	<td><?php echo $get_cust['name'];//echo $loan['loan_code']; ?></td>
