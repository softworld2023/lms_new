...
<table width="1280" id="list_table">
    ...
    <tr <?php echo $style; ?>>
        ...
        <?php if($todaydate <= $get_l['next_paymentdate']){ ?>
		  ...
		  <?php if($get_l['payment'] == '0' && $get_l['payment_date'] == '0000-00-00') {  ?><input type="hidden" name="id" id="id" value="<?php echo $get_l['id']; ?>" /><input type="text" name="payment" id="payment" class="currency" style="width:130px" placeholder="RM <?php echo $get_l['monthly']; ?>" /><?php } else { echo "RM ".$get_l['payment']; } ?>        </td>
        <td>
			<?php if($get_l['payment_date'] != '0000-00-00'){ echo $get_l['payment_date']; } else {?><input type="text" name="payment_date" id="payment_date" style="width:130px" value="<?php echo date('Y-m-d'); ?>" /><?php } ?>        </td>
        <td>
			<?php if($get_l['payment_date'] == '0000-00-00'){?>
			<input type="text" name="new_receipt" id="new_receipt" style="width:100px" value="<?php echo $get_q['loan_code']; ?>"/>
			<?php } ?>		</td>
        <td>
		<?php if($get_l['payment_date'] != '0000-00-00'){
