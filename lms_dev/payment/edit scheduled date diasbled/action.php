...
$q_tokencheck = mysql_query("select * from balance_rec where token = '$_POST[token]'");
$tokencheck = mysql_num_rows($q_tokencheck);
if($tokencheck != ''){
...
if($_POST['action'] == 'payloanf2') //flexi tapi resit guna code yang sama
{
	...
	if($new_loan == '' || $new_loan == 0)
	{
		...
		if($loan_balance > 0)
		{
			...
			if($amount == 0)
			{
				...
				$balance2_ql = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', interest2 = '".$int_amount."', month_receipt = '".$month_receipt."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
			...
			}else
			{
				...
				$balance2_qr = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$amount."', month_receipt = '".$month_receipt."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
				
				
				//insert into balance2 rec the int amount paid
				if($int_amount != 0)
				{
					$balance2_qri = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', interest2 = '".$int_amount."', month_receipt = '".$month_receipt."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."',token = '$_POST[token]'");
				}
		...
		}else
		{
			...
			{				
				...
				$cashbook3_q = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', interest2 = '".$int_amount."',  month_receipt = '".$month_receipt."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
			}
	...
	{	
		...
		if($amount != 0)
		{
			...
			$balance2_qr = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', loan = '".$new_loan."', month_receipt = '".$month_receipt."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
		...
		if($loan_balance > 0)
		{
			...
			if($amount == 0)
			{
				...
				$balance1_qr = mysql_query("INSERT INTO balance_transaction SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$loan_balance."', date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."'");
					...
					$balance2_qr = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$loan_balance."', month_receipt = '".$get_q['month_receipt']."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
					
					//insert to balance2 pay the loan (new receipt no)
					$balance2_ql = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', loan = '".$loan_balance."', month_receipt = '".$month_receipt."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
				}
			...
			}else
			{
				...
				//insert into balance2 rec the actual amount paid
				$balance2_qr = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$amount."', month_receipt = '".$get_q['month_receipt']."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
...
if($_POST['action'] == 'payloan')
{
	...
	if($ar == 0)
	{
		...
		if($update_q)
		{
			...
			/*if($num_select == '1')
			{*/
				$balance2_q = mysql_query("INSERT INTO balance_rec SET package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', received = '".$amount."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
	...
	{					
		...
		if($update_bal_q)
		{
			...
			if($insert_cb_q)
			{
				...
				{
					//insert balance2
					$insert_bal2_q = mysql_query("INSERT INTO balance_rec SET received = '".$amount."', package_id = '".$get_q['package_id']."', customer_loanid = '".$get_q['customer_loanid']."', bal_date = '".$date."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', token = '$_POST[token]'");
