...
<input type="text" name="month_receipt" id="month_receipt" style="width:100px" value="<?php echo date('Y-m'); ?>" autocomplete="off"/>
		...
		<!-- schedule date -->
<!-- <?php if($_SESSION['login_username'] != 'softworld' && $_SESSION['login_username'] != 'fong' && $_SESSION['login_username'] != 'staff' && $_SESSION['login_username'] != 'huizhen') 
{ echo date('d-m-Y', strtotime($get_l['next_paymentdate'])); } else { ?><input type="hidden" name="edit_npd_<?php echo $ctr; ?>" id="edit_npd_<?php echo $ctr; ?>" style="width:80px" value="<?php if($get_l['next_paymentdate'] != '0000-00-00') { echo date('d-m-Y', strtotime($get_l['next_paymentdate'])); } ?>" /><?php } ?> -->
		<!---payment date-->
            ...
            <?php } ?>
            <?php } else { if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen' || $_SESSION['login_username'] == 'staff')) 
			{ ?><input type="text" name="payment_date_<?php echo $ctr; ?>" id="payment_date_<?php echo $ctr; ?>" style="width:80px" value="<?php echo date('d-m-Y', strtotime($get_l['payment_date']));  ?>">   <a href="javascript:edit_pdate('<?php echo $get_l['id']; ?>', '<?php echo $ctr; ?>')" title="save payment date"><img src="../img/document_save.png" /></a>  <?php }} ?>       </td>
		<!--loan Code-->
        ...
        <td><?php 
			if($get_l['payment'] == '0' && $get_l['payment_date'] == '0000-00-00' ) 
			{ ?>
				<a href="javascript:payConfirm('<?php echo $get_q['loan_period']; ?>', '<?php echo $get_l['month']; ?>')" title="pay"><img src="../img/payment-received/payment-received.png" width="30" /></a><a href="instalment_settlement.php?id=<?php echo $get_q['id']; ?>" rel="shadowbox; width=600px; height=420px"><img src="../img/customers/settle.png" width="23px;" height="23px;" title="Settlement"></a>&nbsp;<a href="bad_debt.php?id=<?php echo $get_q['id']; ?>" rel="shadowbox; width=600px; height=420px"><img src="../img/error.png" title="Bad Debt" width="25"></a><?php 
...
?>
   ...
   <?php } ?>
    ...
    <tr>
    	<td colspan="7" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../payment/payment_instalment.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="7">&nbsp;</td>
    </tr>
