...
<table width="1280">
        	...
        	<table>
				<tr>
                    ...
                    <td style="padding-right:8px">
                    	<input type="button" id="search" name="search" value="" onclick="searchHalfMonth();"/>
					</td>
                </tr>
	...
	<tr>
        ...
        <div class="subnav">
			...
			<a href="half_month.php" id="active-menu">Half Month Listing</a>
...
<div id="print-only-header">
    <div style="font-size: 20px; font-weight: bold;">RETURN BOOK (MONTHLY)</div>
    <div id="print-only-date" style="margin-top: 5px; font-size: 16px;"></div>
</div>


 <table width="1280" id="tbl-half-monthly">
    <thead>
        ...
        <tr style="page-break-before: always; margin-top: 30px;">
            ...
            <th width="30%" style="border-right:1px solid black;border-bottom: 1px solid black;border-top:1px solid black;">Customer Name</th>
            <th width="15%" style="border-right:1px solid black;border-bottom: 1px solid black;border-top:1px solid black; text-align: right;">Total Amount Pay</th>
            <th width="10%" style="border-right:1px solid black;border-bottom: 1px solid black;border-top:1px solid black; text-align: right;">Ori Instalment Amt</th>
            <th width="20%" style="border-right:1px solid black;border-bottom: 1px solid black;border-top:1px solid black; text-align: center;">More Details</th>
        </tr>
        <tr class="print-header follow-page-header">
            <th colspan="7" style="text-align:center; font-weight:bold; font-size:16px; display:none;" id="continued-header">
            </th>
...
<script>
    ...
    function searchHalfMonth() {
        $.ajax({
            url: 'get_half_month_listing_ajax.php',
            type: 'POST',
            data: {
            ...
            success: function(response) {
                ...
                $('#tbl-half-monthly tbody').html(response);
            }
        });
    }
    ...
    function searchYearMonth() {
        ...
        window.location.href = 'half_month.php?year=' + year + '&month=' + month;
    }
