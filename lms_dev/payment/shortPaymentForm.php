...
$id = $_GET['id'];
$package_q = mysql_query("SELECT * FROM short_record WHERE id = '".$id."'");
...
<center>
<form method="post" action="action_payShort.php" onSubmit="return checkForm()" autocomplete="off">
	<input type="hidden" name="short_id" id="short_id" value="<?php echo $id; ?>">
...
<table width="100%" id="list_table">
    ...
    <tr>
    	<td colspan="2" style="padding-right:10px" align="right">
			<input type="submit" name="pay_short" id="pay_Int" value="" tabindex="4">
			&nbsp;&nbsp;&nbsp;
