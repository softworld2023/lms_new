...
$prevbal13_q = mysql_query("SELECT SUM(amount) AS amtPay FROM cashbook WHERE package_id = '".$package_id."' AND branch_id = '".$_SESSION['login_branchid']."' AND type = 'PAY' AND code =' ' AND date < '".$month."'");
$get_pb13 = mysql_fetch_assoc($prevbal13_q);


$cf = $cf - $get_pb['amtOut'] + $get_pb2['amtIn'] - $get_pb3['amtEx'] + $get_pb4['amtKom'] + $get_pb5['amtOth'] + $get_pb6['amtKom2'] + $get_pb7['amtCCM'] - $get_pb8['amtTrans'] + $get_pb9['amtTrans2'] - $get_pb10['amtExt'] + $get_pb11['amtKInt'] + $get_pb12['amtKInt2'] - $get_pb13['amtPay'];
