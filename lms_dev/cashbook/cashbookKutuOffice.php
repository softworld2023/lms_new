...
$loan_q = mysql_query("SELECT * FROM cashbook_kutuoffice WHERE branch_id = '".$_SESSION['login_branchid']."' GROUP BY CONCAT(YEAR(date)) ORDER BY date DESC");
...
<table width="1280" id="list_table">
    ...
    <tr>
    	<td><?php echo $ctr; ?></td>
        <td><a href="cashbookdetailsKutuOffice.php?yr=<?php echo date('Y', strtotime($get_l['date'])); ?>"><?php echo date('Y', strtotime($get_l['date'])); ?></a></td>
    </tr>
    <?php } ?>
    <tr>
    	<td colspan="2">&nbsp;</td>
