...
$sql = mysql_query("SELECT * FROM monthly_payment_record WHERE  customer_id = '".$id."' AND status != 'DELETED' order by month DESC, monthly_date DESC");
...
<table width="1280" id="list_table">
    ...
    <tr <?php echo $style; ?>>
    	...
    	<td><?php echo "RM ". number_format($get_q['payout_amount'], 2); ?></td>
		...
		<td>
		 ...
		 ?>
			...
			&nbsp;&nbsp;
						<a href="javascript:deleteConfirmation('<?php echo $get_q['id']; ?>','<?php echo $_GET['id']; ?>' )"><img src="../img/customers/delete-icon.png" title="Delete"></a>
			<?php
					}
				}
			?>
    ...
    <tr>
    	<td colspan="8" align="right"><input type="button" name="back" id="back" onClick="window.location.href='monthly.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="8">&nbsp;</td>
    </tr>
...
function deleteConfirmation(id, custid){
	$id = id;
	$custid = custid;
