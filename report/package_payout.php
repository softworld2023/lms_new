...
$sql = mysql_query("SELECT * FROM customer_loanpackage WHERE branch_id = '".$_SESSION['login_branchid']."' AND loan_package = '".$scheme."'AND (loan_status = 'Paid' OR loan_status = 'Finished')");
?>
<style type="text/css">
<!--
.submit_style {
...
<table width="1280">
	<tr>
        ...
        <td>Reports: <strong><?php echo $get_p['scheme']; ?> Pay Out</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
...
<table width="1280" id="list_table">
	...
	while($get_q = mysql_fetch_assoc($sql))
	{
		...
		$payout_q = mysql_query("SELECT * FROM payout_details WHERE customer_id = '".$get_q['customer_id']."' AND customer_loanid = '".$get_q['id']."'");
		$get_pay = mysql_fetch_assoc($payout_q);
		
		$payout = $get_pay['cash_pay'] + $get_pay['cheque_pay'] + $get_pay['transfer_pay'];
    ...
    <tr>
        ...
        <td><?php echo "RM ".number_format($payout, '2', '.', ''); ?></td>
    </tr>
    <?php } ?>
    <tr>
    ...
    <tr>
    	<td colspan="4" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/payout.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="4">&nbsp;</td>
    </tr>
