...
<center>
		...
		<tr>
			<form method="post">
				<td style="font-size: 16px;"><br>SELECT YEAR
					...
					<select name="select" class="form-control" id="dropdownYear" style="width: 120px;height: 30px; font-size:16px;" onchange="getProjectReportFunc()">
					</select>
					<input class="btn btn-blue" type="submit" name="search" value="SEARCH" id="search">
				</td>
		</tr>
	...
	<table width="1280" id="list_table1">
		...
		if ($year_now == '2022' || $year_now == '2023') {
			...
			while ($result_statement = mysql_fetch_assoc($sql_statement)) {
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="total_profit" id="total_profit"  style="width:50px;height:18px; ' . $style_tp_bf . '" value=' . number_format($result_statement['total_profit']) . '></td>
			...
			<?php
			$counter_mth = 0;
			$sql_statement = $year_now == '2022' ? mysql_query("SELECT * FROM statement_2022") : mysql_query("SELECT * FROM statement_2023");
			while ($result_statement = mysql_fetch_assoc($sql_statement)) {
				$counter_mth++;
				...
				$save_statement_by_month_function = $year_now == '2022' ? 'save_statement_2022(' : 'save_statement_2023(';
				$save_statement_by_month_function .= $counter_mth . ')'; 
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="total_profit" id="total_profit_' . $counter_mth . '"  style="width:50px;height:18px; ' . $style_tp_bf . '" value=' . number_format($result_statement['total_profit']) . '></td>
			...
			<tr style="background-color:#b2ffff;">
				<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;"><a href="javascript:' . $save_statement_by_month_function . '" title="save statement"><img src="../img/document_save.png" /></a></td>
				<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>SALES</b> = </td>
				<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($sales_statement) . '</td>
				<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>INTEREST</b> =</td>
				<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($interest_statement) . '</td>
...
<script>
	...
	function save_statement_2023(counter_mth) {
