...
$sql = mysql_query("SELECT * FROM loan_payment_details pd, customer_loanpackage lp, adjustment a WHERE lp.branch_id = '".$_SESSION['login_branchid']."' AND lp.loan_package = '".$scheme."' AND pd.customer_loanid = lp.id AND a.reason = 'NEW RECEIPT' AND a.customer_loanid = pd.customer_loanid AND a.customer_paymentid = pd.id");
?>
<style type="text/css">
<!--
.submit_style {
...
<table width="1280">
	<tr>
        ...
        <td>Reports: <strong><?php echo $get_p['scheme']; ?> Collection</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    ...
    <tr>
        ...
        <div class="subnav">
			...
			<a href="latepayment.php" id="active-menu">Late Payment Collections</a>
			<?php
...
<table width="1280" id="list_table">
    ...
    <tr>
        ...
        <td><?php echo "RM ".$get_q['add_on']; ?></td>
    </tr>
    <?php } ?>
    <tr>
    ...
    <tr>
    	<td colspan="4" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/latepayment.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="4">&nbsp;</td>
    </tr>
