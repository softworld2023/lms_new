...
$sql = mysql_query("SELECT * FROM loan_payment_details pd, customer_loanpackage lp WHERE lp.branch_id = '".$_SESSION['login_branchid']."' AND lp.loan_package = '".$scheme."' AND pd.customer_loanid = lp.id AND pd.payment_date != '0000-00-00'");
?>
<style type="text/css">
<!--
.submit_style {
...
<table width="1280" id="list_table">
    ...
    <tr>
    	<td colspan="4" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/collection.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="4">&nbsp;</td>
    </tr>
