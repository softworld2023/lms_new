    ...
    <tr style="<?php echo $style.";"; ?>">
		...
		<td align="center" style="border-bottom: 1px dashed black;">
			...
			<?php 
				...
				|| substr($result_4['loan_code'],0,2) == 'CG')
...
//$opening_balance = $result_ob['amount'] + $totalcollected_ob + $totalamount_collected_desc_ob + $cash_balance_ob - $totalout_ob - $totalexpenses_ob;
		...
		$sql_4 = mysql_query("SELECT
								...
								late_interest_record.bd_from,
								late_interest_record.month_receipt
							FROM
								late_interest_record
							LEFT JOIN customer_details ON late_interest_record.customer_id = customer_details.id
		...
		$total_envelope = 0;
						...
						{ 
							...
							if ($result_4['bd_from'] == 'Monthly') {
								if ($result_4['loan_code'] != 'YW1210' && ($_SESSION['login_branch'] == 'YUWANG' && $result_4['loan_code'] !='2512-006') && ($_SESSION['login_branch'] == 'DK' && $result_4['loan_code'] !='DK 25134')) {
							...
							// var_dump($previous_months_bd_collected);
							...
							if ($amount == 0) {
								...
								// //Special Case Handling cross month payment (bad debt)
								// if($result_4['loan_code'] == '2512-006' && $payout_month == '2026-01'){
							...
							if ($branch_name == 'majusama' && $late_interest_record_id <= 46) {
								$previous_monthly_bd = 0;
								$envelope = 0;
							} else if ($branch_name == 'yuwang' && ($result_4['loan_code'] == 'YW1210' || $result_4['loan_code'] =='2512-006' || $result_4['loan_code'] =='DK 25134')) {
								$envelope = 0;
							}

							$balance = $amount + $previous_monthly_bd + $envelope;
							// var_dump($result_4['loan_code'] . '-' . $balance);
							// if ($branch_name == 'majusama' && $late_interest_record_id <= 46) {
...
?>			
			...
			<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				...
				<td width="10%" style = "text-align:center;border-top:1px solid;border-right:1px solid;border-left:1px solid;border-bottom: 1px solid;<?php echo $style_bd;?>"><a href="../payment/payLateInt.php?id=<?php echo $result_4['id'];?>" title="Make Payment">
					...
					|| substr($result_4['loan_code'],0,2) == 'TL' 
					|| substr($result_4['loan_code'],0,2) == 'YW'
					|| substr($result_4['loan_code'],0,2) == 'CG'){echo preg_replace('/^([a-z]{2})/i','<span style="color:red;">\1</span>',$result_4['loan_code']);}else { echo $result_4['loan_code'];} ?></a></a></td>
	...
	<tr ><td style = "text-align:center;">&nbsp;</td><td style = "text-align:center;">&nbsp;</td><td style = "text-align:center;"><?php echo $ctr2;?></td>
			<td style = "text-align:center;border-top:1px solid;border-right:1px solid;border-left:1px solid;border-bottom: 1px solid;background-color:orange;">
				...
				|| substr($result_5['loan_code'],0,2) == 'CG'){echo preg_replace('/^([a-z]{2})/i','<span style="color:red;">\1</span>',$result_5['loan_code']);}else { echo $result_5['loan_code'];} ?></td>
