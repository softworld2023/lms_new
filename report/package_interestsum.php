...
<table width="1280">
	<tr>
        ...
        <td>Reports: <strong>Interest Earn (Summary)</strong></td>
        <td align="right">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
...
<table width="1280" id="list_table">
	...
	while($get_q = mysql_fetch_assoc($sql))
	{
		...
		$sum_q = mysql_query("SELECT SUM(loan_interesttotal) AS int_sum FROM customer_loanpackage WHERE branch_id = '".$_SESSION['login_branchid']."' AND loan_package = '".$package."'");
    ...
    <tr>
        ...
        <td width="150"><?php echo "RM ".$get_s['int_sum']; ?></td>
    </tr>
    <?php } ?>
    <tr>
    ...
    <tr>
    	<td colspan="3" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../report/interest.php'" value=""></td>
    </tr>
    <tr>
    	<td colspan="3">&nbsp;</td>
    </tr>
