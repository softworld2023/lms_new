...
<?php } else {
			...
			if ($res) {
				...
				echo '<tr>
						...
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="balance_in_hand" id="balance_in_hand"  style="width:50px;height:18px;font-size:11px;" value=' . number_format($res['balance_in_hand']) . '></td>
