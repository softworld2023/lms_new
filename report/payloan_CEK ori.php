...
<table width="90%" id="list_table">
    ...
    <tr>
        ...
        <td><input type="text" readonly="readonly" style="width:80px" value="<?php echo $get_cust['customercode2']; ?>" /></td>
...
$('#ccm_date').click( function(e) {$(this).off('click').AnyTime_picker({ format: "%Y-%m-%d", earliest:(new Date((new Date()).valueOf() + 1000*3600*24)), labelTitle: "Select Date"}).focus(); } ).
keydown(
	function(e)
	{
		var key = e.keyCode || e.which;
