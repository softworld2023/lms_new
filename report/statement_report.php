...
<center>
	...
	<table width="1280" id="list_table1">
		<tr>
			...
			<th rowspan="3">RETURN CAPITAL</th>
		...
		if ($statement_year == '2022') {
			...
			while ($result_statement = mysql_fetch_assoc($sql_statement)) {
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="return_capital" id="return_capital"  style="width:50px;height:18px; color: red;" value="0"></td>

				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="pay_out_interest" id="pay_out_interest"  style="width:50px;height:18px; color: red;" value=' . number_format($result_statement['pay_out_interest']) . '></td>
			...
			<tr style="background-color:#b2ffff;">
				...
				<td colspan="5" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <input type="text" name="customer" id="customer"  style="width:50px;height:18px" value=' . number_format($result_statement['customer']) . '></td>
			...
			while ($result_statement = mysql_fetch_assoc($sql_statement)) {
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="return_capital" id="return_capital_' . $counter_mth . '"  style="width:50px;height:18px; color: red;" value="0"></td>

				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="pay_out_interest" id="pay_out_interest_' . $counter_mth . '"  style="width:50px;height:18px; color: red;" value=' . number_format($result_statement['pay_out_interest']) . '></td>
			...
			<tr style="background-color:#b2ffff;">
				...
				<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>INTEREST</b> =</td>
				<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($interest_statement) . '</td>
				<td colspan="5" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <input type="text" name="customer" id="customer_' . $counter_mth . '"  style="width:50px;height:18px" value=' . number_format($result_statement['customer']) . '></td>
				<td colspan="4" style="text-align:center;border-bottom: 1px solid black;"><b>LOAN OUT/ PERSON</b> = </td>
				<td colspan="2" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($loan_out_person) . '</td>
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
			...
			?>
				...
				<tr>
					...
					<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($return_capital); ?></td>
				...
				<tr style="background-color:#b2ffff;">
					...
					<td colspan="5" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <?php echo $ctr; ?></td>
					<td colspan="4" style="text-align:center;border-bottom: 1px solid black;"><b>LOAN OUT/ PERSON</b> = </td>
			...
			<tr>
				...
				<td id="total_capital_in" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($capital_in_counter_mth); ?></td>
				<td id="total_return_capital" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($return_capital_counter_mth); ?></td>
...
<?php } else {
			...
			$ctr = 0;
			$sql = "SELECT * FROM statement WHERE month_year = '$bf_payout_month'";
			$q = mysql_query($sql);
			$res = $q ? mysql_fetch_assoc($q) : NULL;
			if ($res) {
				$sales = $res['loan_out_monthly'] + $res['loan_out_10percent'] + $res['loan_out_8percent'] + $res['loan_out_6_2percent'] + $res['loan_out_5_5percent'] + $res['loan_out_5percent'];
				$interest = $res['interest_received_monthly'] + $res['interest_received_10percent'] + $res['interest_received_8percent'] + $res['interest_received_6_2percent'] + $res['interest_received_5_5percent'] + $res['interest_received_5percent'];
				$loan_out_person = $sales / $res['customer'];

				if ($res['monthly_profit'] < 0) {
					$style_mp_bf = "color:red;";
				} else {
					$style_mp_bf = 'color:#3D91DD;';
				}
				...
				$bf_balance_in_hand = $res['balance_in_hand'];
				$bf_capital_in = $res['capital_in'];

				echo '<tr>
						<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;">BF Dec - ' . $previousYear . '
						<input type="hidden" name="bf_payout_month" id="bf_payout_month" style="width:50px;height:18px" value=' . $bf_payout_month . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_monthly" id="loan_out_monthly" style="width:50px;height:18px;color:#FF00FF;" value=' . number_format($res['loan_out_monthly']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_10percent" id="loan_out_10percent"  style="width:50px;height:18px;color:#FF00FF;" value=' . number_format($res['loan_out_10percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_8percent" id="loan_out_8percent"  style="width:50px;height:18px;color:#7F7F00;" value=' . number_format($res['loan_out_8percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_6_2percent" id="loan_out_6_2percent"  style="width:50px;height:18px;color:blue;" value=' . number_format($res['loan_out_6_2percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_5_5percent" id="loan_out_5_5percent"  style="width:40px;height:18px;color:#7F7F00;" value=' . number_format($res['loan_out_5_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_5percent" id="loan_out_5percent"  style="width:40px;height:18px;color:#004242;" value=' . number_format($res['loan_out_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_monthly" id="interest_received_monthly"  style="width:50px;height:18px;color:#FF00FF;" value=' . number_format($res['interest_received_monthly']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_10percent" id="interest_received_10percent"  style="width:50px;height:18px;color:#FF00FF;" value=' . number_format($res['interest_received_10percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_8percent" id="interest_received_8percent"  style="width:50px;height:18px;color:#7F7F00;" value=' . number_format($res['interest_received_8percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_6_2percent" id="interest_received_6_2percent"  style="width:50px;height:18px;color:blue;" value=' . number_format($res['interest_received_6_2percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_5_5percent" id="interest_received_5_5percent"  style="width:40px;height:18px;color:#7F7F00;" value=' . number_format($res['interest_received_5_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_5percent" id="interest_received_5percent"  style="width:40px;height:18px;color:#004242;" value=' . number_format($res['interest_received_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="capital_in" id="capital_in"  style="width:50px;height:18px" value=' . number_format($res['capital_in']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="return_capital" id="return_capital"  style="width:50px;height:18px; color: red;" value=' . number_format($res['total_return_capital']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="pay_out_interest" id="pay_out_interest"  style="width:50px;height:18px; color: red;" value=' . number_format($res['pay_out_interest']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="expenses" id="expenses"  style="width:50px;height:18px;color:red;" value=' . number_format($res['expenses']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="expenses_2" id="expenses_2"  style="width:50px;height:18px;color:red;" value=' . number_format($res['expenses_2']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_monthly" id="loan_return_monthly"  style="width:50px;height:18px;color:#FF00FF;" value=' . number_format($res['loan_return_monthly']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_10percent" id="loan_return_10percent"  style="width:50px;height:18px;color:#FF00FF;" value=' . number_format($res['loan_return_10percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_8percent" id="loan_return_8percent"  style="width:50px;height:18px;color:#7F7F00;" value=' . number_format($res['loan_return_8percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_6_2percent" id="loan_return_6_2percent"  style="width:50px;height:18px;color:blue;" value=' . number_format($res['loan_return_6_2percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_5_5percent" id="loan_return_5_5percent"  style="width:40px;height:18px;color:#7F7F00;" value=' . number_format($res['loan_return_5_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_5percent" id="loan_return_5percent"  style="width:40px;height:18px;color:#004242;" value=' . number_format($res['loan_return_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_monthly" id="bad_debt_monthly"  style="width:50px;height:18px;color:brown;" value=' . number_format($res['bad_debt_monthly']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_10percent" id="bad_debt_10percent"  style="width:50px;height:18px;color:brown;" value=' . number_format($res['bad_debt_10percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_8percent" id="bad_debt_8percent"  style="width:50px;height:18px;color:brown;" value=' . number_format($res['bad_debt_8percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_6_2percent" id="bad_debt_6_2percent"  style="width:50px;height:18px;color:brown;" value=' . number_format($res['bad_debt_6_2percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_5_5percent" id="bad_debt_5_5percent"  style="width:40px;height:18px;color:brown;" value=' . number_format($res['bad_debt_5_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_5percent" id="bad_debt_5percent"  style="width:40px;height:18px;color:brown;" value=' . number_format($res['bad_debt_5percent']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_collected" id="bad_debt_collected"  style="width:50px;height:18px" value=' . number_format($res['bad_debt_collected']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;' . $style_mp_bf . '"><input type="text" name="monthly_profit" id="monthly_profit" style="width:50px;height:18px;' . $style_mp_bf . '" value=' . number_format($res['monthly_profit']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;' . $style_tp_bf . '"><input type="text" name="total_profit" id="total_profit"  style="width:50px;height:18px;' . $style_tp_bf . '" value=' . number_format($res['total_profit']) . '></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="balance_in_hand" id="balance_in_hand"  style="width:50px;height:18px;font-size:11px;" value=' . number_format($bf_balance_in_hand) . '></td>

					</tr>
					<tr style="background-color:#b2ffff;">
						<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;"><a href="javascript:save_statement(' . $bf_payout_month . ')" title="save statement"><img src="../img/document_save.png" /></a></td>
						<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>SALES</b> = </td>
						<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($sales) . '</td>
						<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>INTEREST</b> =</td>
						<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($interest) . '</td>
						<td colspan="5" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <input type="text" name="customer" id="customer"  style="width:50px;height:18px" value=' . number_format($res['customer']) . '></td>
						<td colspan="4" style="text-align:center;border-bottom: 1px solid black;"><b>LOAN OUT/ PERSON</b> = </td>
						<td colspan="2" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($loan_out_person) . '</td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						...
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						<td colspan = "2" style="text-align:center;border-bottom: 1px solid black;"><b>CASH BALANCE</b> =</td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="cash_balance" id="cash_balance"  style="width:50px;height:18px" value=' . number_format($res['cash_balance']) . '></td>
				...
				echo '<tr>
						...
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_monthly" id="loan_out_monthly" style="width:50px;height:18px;color:#FF00FF;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_10percent" id="loan_out_10percent"  style="width:50px;height:18px;color:#FF00FF;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_8percent" id="loan_out_8percent"  style="width:50px;height:18px;color:#7F7F00;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_6_2percent" id="loan_out_6_2percent"  style="width:50px;height:18px;color:blue;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_5_5percent" id="loan_out_5_5percent"  style="width:40px;height:18px;color:#7F7F00;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_out_5percent" id="loan_out_5percent"  style="width:40px;height:18px;color:#004242;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_monthly" id="interest_received_monthly"  style="width:50px;height:18px;color:#FF00FF;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_10percent" id="interest_received_10percent"  style="width:50px;height:18px;color:#FF00FF;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_8percent" id="interest_received_8percent"  style="width:50px;height:18px;color:#7F7F00;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_6_2percent" id="interest_received_6_2percent"  style="width:50px;height:18px;color:blue;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_5_5percent" id="interest_received_5_5percent"  style="width:40px;height:18px;color:#7F7F00;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="interest_received_5percent" id="interest_received_5percent"  style="width:40px;height:18px;color:#004242;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="capital_in" id="capital_in"  style="width:50px;height:18px" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="return_capital" id="return_capital"  style="width:50px;height:18px; color: red;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="pay_out_interest" id="pay_out_interest"  style="width:50px;height:18px; color: red;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="expenses" id="expenses"  style="width:50px;height:18px;color:red;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="expenses_2" id="expenses_2"  style="width:50px;height:18px;color:red;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_monthly" id="loan_return_monthly"  style="width:50px;height:18px;color:#FF00FF;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_10percent" id="loan_return_10percent"  style="width:50px;height:18px;color:#FF00FF;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_8percent" id="loan_return_8percent"  style="width:50px;height:18px;color:#7F7F00;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_6_2percent" id="loan_return_6_2percent"  style="width:50px;height:18px;color:blue;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_5_5percent" id="loan_return_5_5percent"  style="width:40px;height:18px;color:#7F7F00;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="loan_return_5percent" id="loan_return_5percent"  style="width:40px;height:18px;color:#004242;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_monthly" id="bad_debt_monthly"  style="width:50px;height:18px;color:brown;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_10percent" id="bad_debt_10percent"  style="width:50px;height:18px;color:brown;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_8percent" id="bad_debt_8percent"  style="width:50px;height:18px;color:brown;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_6_2percent" id="bad_debt_6_2percent"  style="width:50px;height:18px;color:brown;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_5_5percent" id="bad_debt_5_5percent"  style="width:40px;height:18px;color:brown;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_5percent" id="bad_debt_5percent"  style="width:40px;height:18px;color:brown;" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="bad_debt_collected" id="bad_debt_collected"  style="width:50px;height:18px" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;' . $style_mp_bf . '"><input type="text" name="monthly_profit" id="monthly_profit" style="width:50px;height:18px;' . $style_mp_bf . '" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;' . $style_tp_bf . '"><input type="text" name="total_profit" id="total_profit"  style="width:50px;height:18px;' . $style_tp_bf . '" value="0"></td>

						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="balance_in_hand" id="balance_in_hand"  style="width:50px;height:18px;font-size:11px;" value="0"></td>

					</tr>
					<tr style="background-color:#b2ffff;">
						<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;"><a href="javascript:save_statement(' . $bf_payout_month . ')" title="save statement"><img src="../img/document_save.png" /></a></td>
						<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>SALES</b> = </td>
						<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">0</td>
						<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>INTEREST</b> =</td>
						<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">0</td>
						<td colspan="5" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <input type="text" name="customer" id="customer"  style="width:50px;height:18px" value="0"></td>
						<td colspan="4" style="text-align:center;border-bottom: 1px solid black;"><b>LOAN OUT/ PERSON</b> = </td>
						<td colspan="2" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">0</td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						...
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						<td colspan = "2" style="text-align:center;border-bottom: 1px solid black;"><b>CASH BALANCE</b> =</td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="cash_balance" id="cash_balance"  style="width:50px;height:18px" value="0"></td>
	...
	?>
		...
		<?php
				...
				if ($i == 12) {
					$december = $statement_year . '-' . $i;
					// var_dump($december);
	
					// check if statement row for $december is created or not in database, insert new row for it if it's not exists yet
					$sql = "SELECT id FROM statement WHERE month_year = '$december'";
					$q = mysql_query($sql);
					if (mysql_num_rows($q) == 0) {
						$sql = "INSERT INTO statement SET month_year = '$december'";
						mysql_query($sql);
					}
					...
					if (empty($interest_paid_out)) {
						$interest_paid_out = 0;
					}

					$cash_balance_mth = $cash_balance_mth - $total_return_capital;
					$balance_in_hand = $balance_in_hand - $total_return_capital;
					
					
					$sql = "UPDATE statement SET 
								loan_out_monthly = '".$totalpayout."',
								loan_out_10percent = '".$total_loan_percent1."',
								loan_out_8percent = '".$total_loan_percent2."',
								loan_out_6_2percent = '".$total_loan_percent3."',
								loan_out_5_5percent = '".$total_loan_percent4."',
								loan_out_5percent = '".$total_loan_percent5."',
								interest_received_monthly = '". ($totalpayout * 0.1) ."',
								interest_received_10percent = '".$after_total_loan_percent1."',
								interest_received_8percent = '".$after_total_loan_percent2."',
								interest_received_6_2percent = '".$after_total_loan_percent3."',
								interest_received_5_5percent = '".$after_total_loan_percent4."',
								interest_received_5percent = '".$after_total_loan_percent5."',
								capital_in = '".$capital_in."',
								pay_out_interest = '".$interest_paid_out."',
								expenses = '".$expenses_k."',
								expenses_2 = '".$expenses_k2."',
								loan_return_monthly = '".$totalreturn."',
								loan_return_10percent = '". ($total_return_percent1 - $total_baddebt_amount1) ."',
								loan_return_8percent = '". ($total_return_percent2 - $total_baddebt_amount2) ."',
								loan_return_6_2percent = '". ($total_return_percent3 - $total_baddebt_amount3) ."',
								loan_return_5_5percent = '". ($total_return_percent4 - $total_baddebt_amount4) ."',
								loan_return_5percent = '". ($total_return_percent5 - $total_baddebt_amount5) ."',
								bad_debt_monthly = '".$totalbaddebt."',
								bad_debt_10percent = '".$total_baddebt_amount1."',
								bad_debt_8percent = '".$total_baddebt_amount2."',
								bad_debt_6_2percent = '".$total_baddebt_amount3."',
								bad_debt_5_5percent = '".$total_baddebt_amount4."',
								bad_debt_5percent = '".$total_baddebt_amount5."',
								bad_debt_collected = '".$totalamount_collected_desc."',
								monthly_profit = '".$monthlyprofit."',
								balance_in_hand = '".$balance_in_hand."',
								customer = '".$ctr."',
								total_profit = '".$total_profit."',
								cash_balance = '".$cash_balance_mth."',
								total_return_capital = '".$total_return_capital."'
								WHERE month_year = '".$december."'";
					$update_q = mysql_query($sql);
				}
		?>
		<tr>
			<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo $mth . ' - ' . $statement_year; ?></td>
			...
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:#7F7F00;"><?php echo number_format($after_total_loan_percent4); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:#004242;"><?php echo number_format($after_total_loan_percent5); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;" id="capital_in_<?= $i; ?>"><?php echo number_format($capital_in); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black; color: red;" id="return_capital_<?= $i; ?>"><?php echo number_format($return_capital); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black; color: red;"><?php echo number_format($interest_paid_out); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:red;"><?php echo number_format($expenses_k); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:red;"><?php echo number_format($expenses_k2); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:#FF00FF;"><?php echo number_format($totalreturn); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:#FF00FF;"><?php echo number_format($total_return_percent1 - $total_baddebt_amount1); ?></td>
		...
		<tr style="background-color:#b2ffff;">
			<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;"></td>
			<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>SALES</b> = </td>
			<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;" id="sales_<?= $i;?>"><?php echo number_format($totalpayout + $total_loan_percent1 + $total_loan_percent2 + $total_loan_percent3 + $total_loan_percent4 + $total_loan_percent5); ?></td>
			<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>INTEREST</b> =</td>
			<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;" id="interest_<?= $i; ?>"><?php echo number_format(($totalpayout * 0.1) + $after_total_loan_percent1 + $after_total_loan_percent2 + $after_total_loan_percent3 + $after_total_loan_percent4 + $after_total_loan_percent5); ?></td>
			<td colspan="5" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <?php echo $ctr; ?></td>
			<td colspan="4" style="text-align:center;border-bottom: 1px solid black;"><b>LOAN OUT/ PERSON</b> = </td>
			<td colspan="2" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format(($totalpayout + $total_loan_percent1 + $total_loan_percent2 + $total_loan_percent3 + $total_loan_percent4 + $total_loan_percent5) / $ctr); ?></td>
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
			...
			<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">
				<?php if($i == 12){
					echo number_format($cash_balance_mth);
				}else {
					echo number_format($cash_balance_mth - $next_month_return_capital);
				} ?>
			</td>
		</tr>
	...
	<?php
		...
		$net_capital = $result_statement['capital_in'] + $total_capital - ($result_statement['return_capital'] + $total_return_capital);
	?>
	<tr>
		<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;">&nbsp;</td>
		<td colspan="6" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
	...
	<tr>
		<td colspan="13" style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;">Total Capital In:</td>
		<td id="total_capital_in" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($result_statement['capital_in'] + $total_capital); ?></td>
		<td id="total_return_capital" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black; color: red;"><?php echo number_format($result_statement['return_capital'] + $total_return_capital); ?></td>
	...
	<tr>
		...
		<td colspan="6" style="text-align:right;">Net Capital:</td>
		<td id="net_capital" colspan="2" style="text-align:center;"><?= number_format($net_capital); ?></td>
		<td colspan="6" style="text-align:center;"></td>
		<td colspan="6" style="text-align:center;"></td>
		<td style="text-align:center;"></td>
		<td style="text-align:center;"></td>
...
<script>
	...
	function save_statement_2022(counter_mth) {
		var loan_out_monthly = document.getElementById('loan_out_monthly_' + counter_mth).value;
		var loan_out_10percent = document.getElementById('loan_out_10percent_' + counter_mth).value;
		var loan_out_8percent = document.getElementById('loan_out_8percent_' + counter_mth).value;
		var loan_out_6_2percent = document.getElementById('loan_out_6_2percent_' + counter_mth).value;
		var loan_out_5_5percent = document.getElementById('loan_out_5_5percent_' + counter_mth).value;
		var loan_out_5percent = document.getElementById('loan_out_5percent_' + counter_mth).value;
		var interest_received_monthly = document.getElementById('interest_received_monthly_' + counter_mth).value;
		var interest_received_10percent = document.getElementById('interest_received_10percent_' + counter_mth).value;
		var interest_received_8percent = document.getElementById('interest_received_8percent_' + counter_mth).value;
		var interest_received_6_2percent = document.getElementById('interest_received_6_2percent_' + counter_mth).value;
		var interest_received_5_5percent = document.getElementById('interest_received_5_5percent_' + counter_mth).value;
		var interest_received_5percent = document.getElementById('interest_received_5percent_' + counter_mth).value;
		var capital_in = document.getElementById('capital_in_' + counter_mth).value;
		var pay_out_interest = document.getElementById('pay_out_interest_' + counter_mth).value;
		var expenses = document.getElementById('expensesm_' + counter_mth).value;
		var expenses_2 = document.getElementById('expensesm_2_' + counter_mth).value;
		var loan_return_monthly = document.getElementById('loan_return_monthly_' + counter_mth).value;
		var loan_return_10percent = document.getElementById('loan_return_10percent_' + counter_mth).value;
		var loan_return_8percent = document.getElementById('loan_return_8percent_' + counter_mth).value;
		var loan_return_6_2percent = document.getElementById('loan_return_6_2percent_' + counter_mth).value;
		var loan_return_5_5percent = document.getElementById('loan_return_5_5percent_' + counter_mth).value;
		var loan_return_5percent = document.getElementById('loan_return_5percent_' + counter_mth).value;
		var bad_debt_monthly = document.getElementById('bad_debt_monthly_' + counter_mth).value;
		var bad_debt_10percent = document.getElementById('bad_debt_10percent_' + counter_mth).value;
		var bad_debt_8percent = document.getElementById('bad_debt_8percent_' + counter_mth).value;
		var bad_debt_6_2percent = document.getElementById('bad_debt_6_2percent_' + counter_mth).value;
		var bad_debt_5_5percent = document.getElementById('bad_debt_5_5percent_' + counter_mth).value;
		var bad_debt_5percent = document.getElementById('bad_debt_5percent_' + counter_mth).value;
		var bad_debt_collected = document.getElementById('bad_debt_collected_' + counter_mth).value;
		var monthly_profit = document.getElementById('monthly_profit_' + counter_mth).value;
		var total_profit = document.getElementById('total_profit_' + counter_mth).value;
		var balance_in_hand = document.getElementById('balance_in_hand_' + counter_mth).value;
		var customer = document.getElementById('customer_' + counter_mth).value;
		var cash_balance = document.getElementById('cash_balance_' + counter_mth).value;
		var bf_payout_month = document.getElementById('bf_payout_month_' + counter_mth).value;
	...
	function save_statement(bf_payout_month) {
		var loan_out_monthly = document.getElementById('loan_out_monthly').value;
		var loan_out_10percent = document.getElementById('loan_out_10percent').value;
		var loan_out_8percent = document.getElementById('loan_out_8percent').value;
		var loan_out_6_2percent = document.getElementById('loan_out_6_2percent').value;
		var loan_out_5_5percent = document.getElementById('loan_out_5_5percent').value;
		var loan_out_5percent = document.getElementById('loan_out_5percent').value;
		var interest_received_monthly = document.getElementById('interest_received_monthly').value;
		var interest_received_10percent = document.getElementById('interest_received_10percent').value;
		var interest_received_8percent = document.getElementById('interest_received_8percent').value;
		var interest_received_6_2percent = document.getElementById('interest_received_6_2percent').value;
		var interest_received_5_5percent = document.getElementById('interest_received_5_5percent').value;
		var interest_received_5percent = document.getElementById('interest_received_5percent').value;
		var capital_in = document.getElementById('capital_in').value;
		var pay_out_interest = document.getElementById('pay_out_interest').value;
		var expenses = document.getElementById('expenses').value;
		var expenses_2 = document.getElementById('expenses_2').value;
		var loan_return_monthly = document.getElementById('loan_return_monthly').value;
		var loan_return_10percent = document.getElementById('loan_return_10percent').value;
		var loan_return_8percent = document.getElementById('loan_return_8percent').value;
		var loan_return_6_2percent = document.getElementById('loan_return_6_2percent').value;
		var loan_return_5_5percent = document.getElementById('loan_return_5_5percent').value;
		var loan_return_5percent = document.getElementById('loan_return_5percent').value;
		var bad_debt_monthly = document.getElementById('bad_debt_monthly').value;
		var bad_debt_10percent = document.getElementById('bad_debt_10percent').value;
		var bad_debt_8percent = document.getElementById('bad_debt_8percent').value;
		var bad_debt_6_2percent = document.getElementById('bad_debt_6_2percent').value;
		var bad_debt_5_5percent = document.getElementById('bad_debt_5_5percent').value;
		var bad_debt_5percent = document.getElementById('bad_debt_5percent').value;
		var bad_debt_collected = document.getElementById('bad_debt_collected').value;
		var monthly_profit = document.getElementById('monthly_profit').value;
		var total_profit = document.getElementById('total_profit').value;
		var balance_in_hand = document.getElementById('balance_in_hand').value;
		var customer = document.getElementById('customer').value;
		var cash_balance = document.getElementById('cash_balance').value;
		var bf_payout_month = document.getElementById('bf_payout_month').value;
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		let branch = '<?= $_SESSION['login_branch'];?>';
		console.log('branch: ' + branch);

		/* if (branch != 'KTL') { */
			let balanceInHandBF = parseFloat($('#balance_in_hand').val().replace(/,/g, ''));
			let sales1 = parseFloat($('#sales_01').text().replace(/,/g, ''));
			let interest1 = parseFloat($('#interest_01').text().replace(/,/g, ''));
			let capitalIn1 = parseFloat($('#capital_in_01').text().replace(/,/g, ''));
			let returnCapital1 = parseFloat($('#return_capital_01').text().replace(/,/g, ''));
			let cashBalanceBF = 0;

			if (branch == 'TSY' || branch == 'ANSENG' || branch == 'KTL') {
				cashBalanceBF = balanceInHandBF - sales1 + interest1 + capitalIn1 - returnCapital1;
			} else {
				cashBalanceBF = balanceInHandBF - sales1 + interest1;
			}
			
			$('#cash_balance').val(cashBalanceBF.toLocaleString());
			console.log('balanceInHandBF: ' + balanceInHandBF);
			console.log('sales1: ' + sales1);
			console.log('interest1: ' + interest1);
			console.log('cashBalanceBF: ' + cashBalanceBF);
			
			let loan_out_monthly = document.getElementById('loan_out_monthly').value;
			let loan_out_10percent = document.getElementById('loan_out_10percent').value;
			let loan_out_8percent = document.getElementById('loan_out_8percent').value;
			let loan_out_6_2percent = document.getElementById('loan_out_6_2percent').value;
			let loan_out_5_5percent = document.getElementById('loan_out_5_5percent').value;
			let loan_out_5percent = document.getElementById('loan_out_5percent').value;
			let interest_received_monthly = document.getElementById('interest_received_monthly').value;
			let interest_received_10percent = document.getElementById('interest_received_10percent').value;
			let interest_received_8percent = document.getElementById('interest_received_8percent').value;
			let interest_received_6_2percent = document.getElementById('interest_received_6_2percent').value;
			let interest_received_5_5percent = document.getElementById('interest_received_5_5percent').value;
			let interest_received_5percent = document.getElementById('interest_received_5percent').value;
			let capital_in = document.getElementById('capital_in').value;
			let pay_out_interest = document.getElementById('pay_out_interest').value;
			let expenses = document.getElementById('expenses').value;
			let expenses_2 = document.getElementById('expenses_2').value;
			let loan_return_monthly = document.getElementById('loan_return_monthly').value;
			let loan_return_10percent = document.getElementById('loan_return_10percent').value;
			let loan_return_8percent = document.getElementById('loan_return_8percent').value;
			let loan_return_6_2percent = document.getElementById('loan_return_6_2percent').value;
			let loan_return_5_5percent = document.getElementById('loan_return_5_5percent').value;
			let loan_return_5percent = document.getElementById('loan_return_5percent').value;
			let bad_debt_monthly = document.getElementById('bad_debt_monthly').value;
			let bad_debt_10percent = document.getElementById('bad_debt_10percent').value;
			let bad_debt_8percent = document.getElementById('bad_debt_8percent').value;
			let bad_debt_6_2percent = document.getElementById('bad_debt_6_2percent').value;
			let bad_debt_5_5percent = document.getElementById('bad_debt_5_5percent').value;
			let bad_debt_5percent = document.getElementById('bad_debt_5percent').value;
			let bad_debt_collected = document.getElementById('bad_debt_collected').value;
			let monthly_profit = document.getElementById('monthly_profit').value;
			let total_profit = document.getElementById('total_profit').value;
			let balance_in_hand = document.getElementById('balance_in_hand').value;
			let customer = document.getElementById('customer').value;
			let cash_balance = document.getElementById('cash_balance').value;
			let bf_payout_month = document.getElementById('bf_payout_month').value;
			...
			$.ajax({
				...
				url: 'action.php',
				success: function() {
					console.log('Updated BF ' + bf_payout_month);
				}
			});
		/* } */

		let net_capital = $('#net_capital').text();
		/* console.log(total_capital_in); */
		let year = $('#statement_year').val();
		...
		if (year != '2022') {
			$.ajax({
				type: 'POST',
				data: {
					action: 'update_statement_capital',
					month_year: `${year}-12`,
					net_capital: net_capital,
				},
				url: 'action.php',
				success: function() {
					console.log(`Updated statement capital ${year}-12`);
				}
			});
		}
	});
