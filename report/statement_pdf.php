...
if ($statement_year == '2022') {
	...
	while ($result_statement = mysql_fetch_assoc($sql_statement)) {
		if ($bf_payout_month == $result_statement['month_year']) {
			...
			$html .= '		<tr>
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black; color: red;">' . number_format($result_statement['total_return_capital']) . '</td>
	...
	while ($result_statement = mysql_fetch_assoc($sql_statement)) {
		...
		$return_capital_counter_mth += $result_statement['total_return_capital'];
	...
	$html .= '
		...
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black; color: red;">' . number_format($result_statement['total_return_capital'] + $return_capital_counter_mth) . '</td></td>
