				...
				<tr>
					<td>
						<table id="list_table" width="350">
							...
							//RENTAL
							$rental_q = mysql_query("SELECT SUM(amount) AS sumLate FROM cashbook WHERE package_id = '".$package_id."' AND branch_id = '".$_SESSION['login_branchid']."' AND type = 'RECEIVED2' AND transaction LIKE '%SEWA%' AND date BETWEEN '".$startM."' AND '".$newM."'");
