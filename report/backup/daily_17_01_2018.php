		...
		<td>
			<table id="list_table" width="100%">
				...
				while($get_q = mysql_fetch_assoc($sql))
				{
					...
					$payment_q = mysql_query("SELECT * FROM cashbook WHERE branch_id = '".$_SESSION['login_branchid']."' AND package_id = '".$id."' AND date LIKE '%".$date."%' AND receipt_no = '".$get_q['receipt_no']."' AND customer_id ='".$get_q['customer_id']."'");
