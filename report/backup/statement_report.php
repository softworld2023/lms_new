...
<table width="1280" id="list_table">
    ...
    <tr>     		<form method="post">                    <td style="font-size: 16px;"><br>SELECT YEAR
...
<select 
         ...
         onchange="getProjectReportFunc()">
                   ...
                   <input class="btn btn-blue" type="submit" name="search" value="SEARCH" id="search" ></td> </tr>
 ...
 if(isset($_POST['search'])){
 	$year_now = $_POST['select'];
 }
 else{
	  $year_now = date("Y");}

	  echo ' <tr><td style="font-size:16px;"><a href="statement_pdf.php?year='.$year_now.'" target="_blank">STATEMENT '.$year_now.'</a></td></tr>';
    ?> 
     	</form>
 </table>
...
{ 
	...
	if($result_statement['monthly_profit']<='-1')
	{
	...
	echo '		<tr>
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="total_profit" id="total_profit"  style="width:50px;height:18px" value='.number_format($result_statement['total_profit']).'></td>
...
if($mth=='2022-01'){$mth = 'Jan - 2022';}
		else if($mth=='2022-02'){$mth = 'Feb - 2022';}
		else if($mth=='2022-03'){$mth = 'March - 2022';}
		else if($mth=='2022-04'){$mth = 'April - 2022';}
		else if($mth=='2022-05'){$mth = 'May - 2022';}
		else if($mth=='2022-06'){$mth = 'June - 2022';}
		else if($mth=='2022-07'){$mth = 'July - 2022';}
		else if($mth=='2022-08'){$mth = 'Aug - 2022';}
	...
	echo '		<tr>
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="total_profit" id="total_profit_'.$counter_mth.'"  style="width:50px;height:18px" value='.number_format($result_statement['total_profit']).'></td>
...
$date_from = $year_now.'-'.$i.'-01';
$date_to = $year_now.'-'.$i.'-31';
$payout_month = $year_now.'-'.$i;
...
$ctr=0;
    ...
    $sql_bd_collected = mysql_query("SELECT
						...
						$capital_in2 = $result_statement['capital_in'] + $capital_in1;
							...
							if($i=='01')
						{
							$payout_month_cb = $year_now.'-02';
							
						}
						else if($i=='02')
						{
							$payout_month_cb = $year_now.'-03';
							
						}else if($i=='03')
						{
							$payout_month_cb = $year_now.'-04';
							
						}else if($i=='04')
						{
							$payout_month_cb = $year_now.'-05';
							
						}else if($i=='05')
						{
							$payout_month_cb = $year_now.'-06';
							
						}else if($i=='06')
						{
							$payout_month_cb = $year_now.'-07';
							
						}else if($i=='07')
						{
							$payout_month_cb = $year_now.'-08';
							
						}else if($i=='08')
						{
							$payout_month_cb = $year_now.'-09';
							
						}else if($i=='09')
						{
							$payout_month_cb = $year_now.'-10';
							
						}else if($i=='10')
						{
							$payout_month_cb = $year_now.'-11';
							
						}else if($i=='11')
						{
							$payout_month_cb = $year_now.'-12';
    ...
    $sql_monthly = mysql_query("SELECT
						...
						?>
						<tr>
				<td style="text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo $mth.' - '.$year_now;?></td>
				...
				<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($total_profit);?></td>
	...
	<tr>
		...
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($result_statement['capital_in'] +$capital_in_counter_mth + $total_capital);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($pay_out_interest_counter_mth + $total_paid_out_interest);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color: red;"><?php echo number_format($expenses_counter_mth + $total_expenses);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:red;"><?php echo number_format($expenses_2_counter_mth + $total_expenses2);?></td>
		<td colspan="6" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:brown;"><?php echo number_format($baddebt_month_counter_mth + $total_totalbaddebt);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:brown;"><?php echo number_format($baddebt_amount1_counter_mth + $total_total_baddebt_amount1);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:brown;"><?php echo number_format($baddebt_amount2_counter_mth + $total_total_baddebt_amount2);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:brown;"><?php echo number_format($baddebt_amount3_counter_mth + $total_total_baddebt_amount3);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:brown;"><?php echo number_format($baddebt_amount4_counter_mth + $total_total_baddebt_amount4);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;color:brown;"><?php echo number_format($baddebt_amount5_counter_mth + $total_total_baddebt_amount5);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($total_bd_collected_counter_mth + $total_bd_collected);?></td>
		<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><?php echo number_format($monthlyprofit_counter_mth + $total_monthly_profit);?></td>
		<td colspan="2" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
	</tr>
			</table>
