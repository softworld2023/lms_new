...
<table width="100%" id="list_table" border="0" cellpadding="0" cellspacing="0">
	<tr>
	  ...
	  <td><p>
	    ...
	    <?php } else { if($payoutdate['payout_date'] != '0000-00-00') { echo date('d-m-Y', strtotime($payoutdate['payout_date'])); } }?>
	  </p></td>
    </tr>  <tr>
        <td align="left" style="padding-left:30px;">Customer Name</td>
        <td><input type="text" name="stamping2" style="height:15px; width:300px;" id="stamping2" value="<?php echo $cust_p['a_name']; ?>" class="currency" onKeyUp="st()"></td>
      </tr>  
      <tr>
        <td align="left" style="padding-left:30px;">I/C No.</td>
        <td><input type="text" name="stamping3" style="height:15px" id="stamping3" value="<?php echo $cust_p['a_nric']; ?>" class="currency" onKeyUp="st()"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left"><input type="text" name="stamping4" style="height:15px" id="stamping4" value="<?php echo $get_l['approved_amount']; ?>" class="currency" onKeyUp="st()"></td>
      </tr>
      <tr>
        <td style="padding-left:30px;">Interest</td>
        <td align="left"><input type="text" name="stamping5" style="height:15px; width:30px" id="stamping5" value="<?php echo 100 - (($get_l['cash_pay'] / $get_l['approved_amount']) * 100) ?>" class="currency" onKeyUp="st()"> 
          RM  <input type="text" name="stamping7" style="height:15px" id="stamping7" value="<?php echo $get_l['approved_amount'] - $get_l['cash_pay']; ?>" class="currency" onKeyUp="st()"></td>
      </tr>
      <tr bgcolor="#CCCCCC" style="height:auto">
        <td style="padding-left:30px;;"><strong>Sub Total Loan</strong></td>
        <td align="left"><input type="text" name="stamping6" style="height:15px" id="stamping6" value="<?php echo $get_l['cash_pay']; ?>" class="currency" onKeyUp="st()"></td>
      </tr>
      <tr>
    	<td width="40%" style="padding-left:30px;">Stamping</td>
        <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="stamping" style="height:15px" id="stamping" value="<?php echo $get_l['stamping']; ?>" class="currency" onKeyUp="st()"><?php } else { echo $get_l['stamping']; } ?></td>
    </tr>
    <tr>
    	<td style="padding-left:30px;">CTOS</td>
        <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="ctos" id="ctos" style="height:15px" value="<?php echo $get_l['ctos']; ?>" class="currency" onKeyUp="st()" ><?php } else { echo $get_l['ctos']; } ?></td>
    </tr>
    <tr>
      <td style="padding-left:30px;">CCRIS</td>
      <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="ccris" id="ccris" style="height:15px" value="<?php echo $get_l['ccris']; ?>" class="currency" onKeyUp="st()"><?php } else { echo $get_l['ccris']; } ?></td>
    </tr>
    <tr>
      <td style="padding-left:30px;">ML Settlement </td>
      <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="mlsettle" id="mlsettle" style="height:15px" value="<?php echo $get_l['mlsettle']; ?>" class="currency" onKeyUp="st()"><?php } else { echo $get_l['mlsettle']; } ?></td>
    </tr>
    <tr>
      <td style="padding-left:30px;">Overlap</td>
      <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="overlap" id="overlap" style="height:15px" value="<?php echo $get_l['overlap']; ?>"class="currency" onKeyUp="st()"><?php } else { echo $get_l['overlap']; } ?></td>
    </tr>
    <tr>
      <td style="padding-left:30px;">Commission</td>
      <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="cm" id="cm" style="height:15px" value="<?php echo $get_l['cm']; ?>"class="currency" onKeyUp="st()"><?php } else { echo $get_l['cm']; } ?></td>
    </tr>
    <tr>
      <td style="padding-left:30px;">Lawyer Fee</td>
      <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="lawyer_fees" id="lawyer_fees" style="height:15px" value="<?php echo $get_l['lawyer_fees']; ?>"class="currency" onKeyUp="st()"><?php } else { echo $get_l['lawyer_fees']; } ?></td>
    </tr>
    <tr>
      <td style="padding-left:30px;">Processing Fee </td>
      <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="processing_fees" id="processing_fees" style="height:15px" value="<?php echo $get_l['processing_fees']; ?>"class="currency" onKeyUp="st()"><?php } else { echo $get_l['processing_fees']; } ?></td>
    </tr>
    <tr>
    	<td style="padding-left:30px;">Others</td>
        <td align="left">RM <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) { ?><input type="text" name="others" id="others" style="height:15px" value="<?php echo number_format($get_l['others'], '2', '.', ''); ?>"class="currency" onKeyUp="st()"><?php } else { echo number_format($get_l['others'], '2'); } ?></td>
    </tr>
	<tr height="10">
