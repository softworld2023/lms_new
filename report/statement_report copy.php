...
<?php } else {
			...
			if ($q) {
				...
				echo '<tr>
						...
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="pay_out_interest" id="pay_out_interest"  style="width:50px;height:18px" value=' . number_format($res['pay_out_interest']) . '></td>
					...
					<tr style="background-color:#b2ffff;">
						...
						<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <input type="text" name="customer" id="customer"  style="width:50px;height:18px" value=' . number_format($res['customer']) . '></td>
						<td colspan="4" style="text-align:center;border-bottom: 1px solid black;"><b>LOAN OUT/ PERSON</b> = </td>
						<td colspan="2" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">' . number_format($loan_out_person) . '</td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"></td>
				...
				echo '<tr>
						...
						<td style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><input type="text" name="pay_out_interest" id="pay_out_interest"  style="width:50px;height:18px" value="0"></td>
					...
					<tr style="background-color:#b2ffff;">
						...
						<td colspan="2" style="text-align:center;border-bottom: 1px solid black;"><b>INTEREST</b> =</td>
						<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;">0</td>
						<td colspan="4" style="text-align:center;border-right:1px solid black;border-bottom: 1px solid black;"><b>CUSTOMER</b> = <input type="text" name="customer" id="customer"  style="width:50px;height:18px" value="0"></td>
						<td colspan="4" style="text-align:center;border-bottom: 1px solid black;"><b>LOAN OUT/ PERSON</b> = </td>
