...
if(isset($_POST['edit_cust']))
{
	...
	if($fin_row != 0)
	{
		$update_financial_q = mysql_query("UPDATE customer_financial SET basic_salary = '".$basic_salary."', net_salary = '".$net_salary."', total_cc = '".$total_cc."', car_installment = '".$car_installment."', house_installment = '".$house_installment."', personal_loan = '".$personal_loan."', bank_loan = '".$bank_loan."', remarks = '".$remarks."' WHERE customer_id = '".$customer_id."'");
	}else
	{
		$insert_financial_q = mysql_query("INSERT INTO customer_financial SET customer_id = '".$customer_id."',basic_salary = '".$basic_salary."', net_salary = '".$net_salary."', total_cc = '".$total_cc."', car_installment = '".$car_installment."', house_installment = '".$house_installment."', personal_loan = '".$personal_loan."', bank_loan = '".$bank_loan."', remarks = '".$remarks."'");
	}
	...
	if($acc_row != 0)
	{
		...
		// cannot update Account Particular when a_remarks = '".$a_remarks
		//$update_account_q = mysql_query("UPDATE customer_account SET a_bankbranch = '".$a_bankbranch."' , a_payday = '".$a_payday."' , a_paymentdate = '".$a_paymentdate."' , a_name = '".$a_name."' , a_nric = '".$a_nric."' , a_pinno = '".$a_pinno."' , a_bankname = '".$a_bankname."' , a_bankaccno = '".$a_bankaccno."' , transfer_accountbank = '".$transfer_accountbank."' , transfer_accountno = '".$transfer_accountno."' , transfer_accountholder = '".$transfer_accountholder."' , internet_username = '".$internet_username."' , internet_password = '".$internet_password."' , a_remarks = '".$a_remarks."' WHERE customer_id = '".$customer_id."'");
		
		$update_account_q = mysql_query("UPDATE customer_account SET a_bankbranch = '".$a_bankbranch."' , a_payday = '".$a_payday."' , a_paymentdate = '".$a_paymentdate."' , a_name = '".$a_name."' , a_nric = '".$a_nric."' , a_pinno = '".$a_pinno."' , a_bankname = '".$a_bankname."' , a_bankaccno = '".$a_bankaccno."' , transfer_accountbank = '".$transfer_accountbank."' , transfer_accountno = '".$transfer_accountno."' , transfer_accountholder = '".$transfer_accountholder."' , internet_username = '".$internet_username."' , internet_password = '".$internet_password."' , a_remarks = '".$a_remarks2."' WHERE customer_id = '".$customer_id."'");
	...
	$file_path = "../files/customer/" . $branch_name . '/' . $customer_id."/";
	...
	if($a_bankfile != '')
	{
		...
		move_uploaded_file($_FILES["a_icfile"]["tmp_name"], '../files/customer/' . $branch_name . '/' . $customer_id.'/'.$a_bankfile);
...
if(isset($_POST['add_loan']))
{
	...
	if($_SESSION['login_level'] != 'Staff')
	{
		...
		//update customer_details
		$update_details_q = mysql_query("UPDATE customer_details SET bis = '".$bis."', `from` = '".$source."', name = '".$name."', title = '".$title."', dob = '".$dob."', nationality = '".$nationality."', old_ic = '".$old_ic."', nric = '".$nric."', gender = '".$gender."', race = '".$race."', marital_status = '".$marital_status."',no_dependents = '".$no_dependents."',   academic_qualification = '".$academic_qualification."', mother_name = '".$mother_name."', customercode1 = '".$customercode1."', customercode2 = '".$customercode2."', branch_id = '".$_SESSION['login_branchid']."', branch_name = '".$_SESSION['login_branch']."', others_ic = '".$others_ic."', others_ic2 = '".$others_ic2."', recruitor = '".$recruitor."' ,dependent1 = '".$dependent1."',dependent2 = '".$dependent2."',dependent3 = '".$dependent3."',dependent4 = '".$dependent4."',dependent5 = '".$dependent5."',dependent6 = '".$dependent6."' WHERE id = '".$customer_id."'");
	...
	$insert_q = mysql_query("INSERT INTO monthly_payment_record 
		...
		$msg .= "Customer monthly has been successfully add into record!";
...
if($_POST['action'] == 'delete_customer')
{
	...
	if($delete_q)
	{
		...
		while($get_q = mysql_fetch_assoc($sql))
		{
			...
			$delete_q13 = mysql_query("DELETE FROM loan_lejar_details WHERE customer_loanid = '".$get_q['id']."'");
		...
		$delete_q14 = mysql_query("DELETE FROM customer_loanpackage_draft WHERE customer_id = '".$id."'");
