...
<center>
<form method="post" action="action_blacklist.php" onSubmit="return checkForm()"><input type="hidden" name="custid" id="custid" value="<?php echo $cust_id; ?>"><input type="hidden" name="blacklisttype" id="blacklisttype" />
	...
	<tr>
        ...
        <tr>
          <td style="padding-left:10px; padding-right:10px">
		  	<table style="border-collapse:collapse" id="inner">
				<tr>
					<td>Type (CTOS / CCRIS)</td>
					<td>&nbsp;</td>
					<td><input type="radio" name="blacklisttype1" id="blacklisttype1" onClick="changeType(this.value)" value="CTOS"></td>
					<td>CTOS</td>
					<td><input type="radio" name="blacklisttype1" id="blacklisttype1" onClick="changeType(this.value)" value="CCRIS"></td>
					<td>CCRIS</td>
				</tr>
				<tr>
					<td>Amount (RM)</td>
					<td>&nbsp;</td>
					<td colspan="4"><input type="text" name="blacklistamt" id="blacklistamt" class="currency" /></td>
				</tr><tr>
					<td>Reason</td>
					<td>&nbsp;</td>
					<td colspan="4"><textarea name="blacklistreason" id="blacklistreason" rows="4" cols="50" ></textarea></td>
				</tr>
			</table>
		  </td>
        </tr>
...
function checkForm()
{
	if((document.getElementById('blacklisttype').value != '' && document.getElementById('blacklistamt').value != ''))
	{
		$('#message').empty();
		return true;	
	}
