...
if (!file_exists('../bankstat/'.$customer_id)) 
{
	mkdir('../bankstat/'.$customer_id, 0777, true);
}
$output_dir = "../bankstat/".$customer_id."/";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	for($i = 0; $i < $fileCount; $i++)
	{
		...
		else
		{
			...
			$filename = "../bankstat/".$customer_id."/". $_FILES['file']['name'][$i];
