...
if (!file_exists('../guarantorform/'.$customer_id)) 
{
	mkdir('../guarantorform/'.$customer_id, 0777, true);
}
$output_dir = "../guarantorform/".$customer_id."/";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	for($i = 0; $i < $fileCount; $i++)
	{
		...
		else
		{
			...
			$filename = "../guarantorform/".$customer_id."/". $_FILES['file']['name'][$i];
			
			//$filename1 = "../images/small/". $_FILES['file']['name'][$i];
   ...
   <div id="con">
		...
		<tr>
          ...
          <td width="350" align="left">
            <div align="left">
              <input size="25" name="file[]" type="file" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10pt" class="box" multiple/>
			  
              </div></td>
			  
        </tr>
		<tr><Td></Td>
		<Td valign="top" height="35px" class="help">&nbsp;</Td>
		</tr>
