...
$branch_name = $db_name != '' ? $db_name : strtolower($_SESSION['login_database']); 
...
$sql = mysql_query("SELECT * FROM $branch_name.customer_details WHERE id = '".$id."'");
$get_q = mysql_fetch_assoc($sql);
// var_dump("SELECT * FROM $branch_name.customer_details WHERE id = '".$id."'");
$sql2 = mysql_query("SELECT * FROM $branch_name.customer_address WHERE customer_id = '".$id."'");
$get_add = mysql_fetch_assoc($sql2);

$sql3 = mysql_query("SELECT * FROM $branch_name.customer_employment WHERE customer_id = '".$id."'");
$get_c = mysql_fetch_assoc($sql3);

$sql4 = mysql_query("SELECT * FROM $branch_name.customer_financial WHERE customer_id = '".$id."'");
$get_f = mysql_fetch_assoc($sql4);

$sql5 = mysql_query("SELECT * FROM $branch_name.customer_emergency WHERE customer_id = '".$id."'");
$get_e = mysql_fetch_assoc($sql5);

$sql6 = mysql_query("SELECT * FROM $branch_name.customer_spouse WHERE customer_id = '".$id."'");
$get_s = mysql_fetch_assoc($sql6);

$sql7 = mysql_query("SELECT * FROM $branch_name.customer_relative WHERE customer_id = '".$id."'");

$sql8 = mysql_query("SELECT * FROM $branch_name.customer_account WHERE customer_id = '".$id."'");
...
<table width="1280" id="list_table">
    	...
    	<td>
        	<center>
              ...
              <td>
                ...
                $image_link = "../files/customer/" . $branch_name . "/" . $id."/".$get_q['cust_pic'];
                ?>
                  <a href="<?php echo $image_link; ?>" rel="shadowbox"><img src="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_q['cust_pic']; ?>" name="cust_pic2" id="cust_pic2" style="height:115px; width:115px" onerror='this.style.display = "none"'></a>
                <?php } else { ?>
              ...
              <td>
                ...
                $image_link = "../files/customer/" . $branch_name . "/" . $id."/".$get_q['cust_pic2'];
                ?>
                  <a href="<?php echo $image_link; ?>" rel="shadowbox">
                  <img src="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_q['cust_pic2']; ?>" name="cust_pic4" id="cust_pic4" style="height:115px; width:115px" onerror='this.style.display = "none"'>
                  </a>
                <?php } else { ?>
              ...
              <td>
                ...
                $image_link = "../files/customer/" . $branch_name . "/" . $id . "/".$get_q['cust_pic3'];
                ?>
                  <a href="<?php echo $image_link; ?>" rel="shadowbox">
                  <img src="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_q['cust_pic3']; ?>" name="cust_pic6" id="cust_pic6" style="height:115px; width:115px" onerror='this.style.display = "none"'>
                  </a>
                <?php } else { ?>
                ...
                <tr>
                  ...
                  <td bgcolor="#CCCCCC"><table id="radio_table2">
                      <tr>
                        <td><input type="radio" disabled name="title" id="title2" value="MR." <?php if($get_q['title'] == 'MR.') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">MR.</td>
                        <td><input type="radio" disabled name="title" id="title2" value="MISS" <?php if($get_q['title'] == 'MISS') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">MISS</td>
                        <td><input type="radio" disabled name="title" id="title2" value="MADAM" <?php if($get_q['title'] == 'MADAM') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">MADAM</td>
                        <td><input type="radio" disabled name="title" id="title2" value="DR." <?php if($get_q['title'] == 'DR.') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">DR.</td>
                        <td><input type="radio" disabled name="title" id="title2" value="Others" <?php if($get_q['title'] == 'OTHERS') { echo 'checked'; } ?> /></td>
                ...
                <tr>
                  ...
                  <td bgcolor="#CCCCCC"><table id="radio_table2">
                      <tr>
                        <td><input type="radio" disabled name="gender" id="gender2" value="Male" <?php if($get_q['gender'] == 'Male') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Male</td>
                        <td><input type="radio" disabled name="gender" id="gender2" value="Female" <?php if($get_q['gender'] == 'Female') { echo 'checked'; } ?> /></td>
                ...
                <tr>
                  ...
                  <td bgcolor="#CCCCCC"><table id="radio_table">
                      <tr>
                        <td><input type="radio" disabled name="race" id="race" value="Malay" onclick="raceOther2();" <?php if($get_q['race'] == 'Malay') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Malay</td>
                        <td><input type="radio" disabled name="race" id="race" value="Chinese" onclick="raceOther2();" <?php if($get_q['race'] == 'Chinese') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Chinese</td>
                        <td><input type="radio" disabled name="race" id="race" value="Indian" onclick="raceOther2();" <?php if($get_q['race'] == 'Indian') { echo 'checked'; } ?> /></td>
                ...
                <tr>
                  ...
                  <td bgcolor="#CCCCCC"><table id="radio_table">
                      <tr>
                        <td><input type="radio" disabled name="race" id="radio" value="Others" onclick="raceOther();" <?php if($get_q['race'] != 'Malay' && $get_q['race'] != 'Chinese' && $get_q['race'] != 'Indian' && $get_q['race'] != '') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Others</td>
                ...
                <tr>
                  ...
                  <td bgcolor="#CCCCCC"><table id="radio_table2">
                      <tr>
                        <td><input type="radio" disabled name="marital_status" id="marital_status2" value="Single" <?php if($get_q['marital_status'] == 'Single') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Single</td>
                        <td><input type="radio" disabled name="marital_status" id="marital_status2" value="Married" <?php if($get_q['marital_status'] == 'Married') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Married</td>
                        <td><input type="radio" disabled name="marital_status" id="marital_status2" value="Widowed / Divorced" <?php if($get_q['marital_status'] == 'Widowed / Divorced') { echo 'checked'; } ?> /></td>
                  ...
                  <td bgcolor="#CCCCCC"><?php echo $get_q['from']; ?></td>
                  <td align="left" style="padding-right:10px">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td  bgcolor="#CCCCCC"><table id="radio_table2">
                      <tr>
                        <td><input type="checkbox" disabled name="dependent1" id="dependent1" value="Father" <?php if($get_q['dependent1'] == 'Father') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Father &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><input type="checkbox" disabled name="dependent2" id="dependent2" value="Mother" <?php if($get_q['dependent2'] == 'Mother') { echo 'checked'; } ?> /></td>
                  ...
                  <td  bgcolor="#CCCCCC"><table id="radio_table2">
                      <tr>
                        <td><input type="checkbox" disabled name="dependent3" id="dependent3" value="FatherIL" <?php if($get_q['dependent3'] == 'FatherIL') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Father in Law</td>
                        <td><input type="checkbox" disabled name="dependent4" id="dependent4" value="MotherIL" <?php if($get_q['dependent4'] == 'MotherIL') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Mother in Law</td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" disabled name="dependent5" id="dependent5" value="Child" <?php if($get_q['dependent5'] == 'Child') { echo 'checked'; } ?> /></td>
                        <td style="padding-left:5px; padding-right:20px">Child</td>
                        <td><input type="checkbox" disabled name="dependent6" id="dependent6" value="HorW" <?php if($get_q['dependent6'] == 'HorW') { echo 'checked'; } ?> /></td>
        	...
        	<center>
        	    ...
        	    <tr>
        	      ...
        	      <td rowspan="2" bgcolor="#CCCCCC"><table width="100%" id="radio_table5">
        	        <tr>
        	          <td width="10%" bgcolor="#CCCCCC"><input type="radio" disabled name="m_residence" id="m_residence1" value="Owned-No-Loan" <?php if($get_add['m_residence'] == 'Owned-No-Loan') { echo 'checked'; } ?> /></td>
        	          <td width="44%" style="padding-left:5px" bgcolor="#CCCCCC">Owned-No-Loan</td>
        	          <td width="8%" bgcolor="#CCCCCC"><input type="radio" disabled name="m_residence" id="m_residence2" value="Rented" <?php if($get_add['m_residence'] == 'Rented') { echo 'checked'; } ?> /></td>
        	          <td width="38%" style="padding-left:5px" bgcolor="#CCCCCC">Rented</td>
      	          </tr>
        	        <tr>
        	          <td bgcolor="#CCCCCC"><input type="radio" disabled name="m_residence" id="m_residence3" value="Owned-With-Loan" <?php if($get_add['m_residence'] == 'Owned-With-Loan') { echo 'checked'; } ?> /></td>
        	          <td style="padding-left:5px" bgcolor="#CCCCCC">Owned-With-Loan</td>
        	          <td bgcolor="#CCCCCC"><input type="radio" disabled name="m_residence" id="m_residence4" value="Employers" <?php if($get_add['m_residence'] == 'Employers') { echo 'checked'; } ?> /></td>
        	          <td style="padding-left:5px" bgcolor="#CCCCCC">Employer's</td>
      	          </tr>
        	        <tr>
        	          <td bgcolor="#CCCCCC"><input type="radio" disabled name="m_residence" id="m_residence5" value="Parents / Relatives" <?php if($get_add['m_residence'] == 'Parents / Relatives') { echo 'checked'; } ?> /></td>
        	    ...
        	    <tr>
        	      ...
        	      <td bgcolor="#CCCCCC"><table width="100%" id="radio_table6">
        	        <tr>
        	          <td width="9%" bgcolor="#CCCCCC"><input type="radio" disabled name="residence" id="residence1" value="Owned-No-Loan" <?php if($get_add['residence'] == 'Owned-No-Loan') { echo 'checked'; } ?> /></td>
        	          <td width="37%" style="padding-left:5px" bgcolor="#CCCCCC">Owned-No-Loan</td>
        	          <td width="7%" bgcolor="#CCCCCC"><input type="radio" disabled name="residence" id="residence2" value="Rented" <?php if($get_add['residence'] == 'Rented') { echo 'checked'; } ?> /></td>
        	          <td width="47%" style="padding-left:5px" bgcolor="#CCCCCC">Rented</td>
      	          </tr>
        	        <tr>
        	          <td bgcolor="#CCCCCC"><input type="radio" disabled name="residence" id="residence3" value="Owned-With-Loan" <?php if($get_add['residence'] == 'Owned-With-Loan') { echo 'checked'; } ?> /></td>
        	          <td style="padding-left:5px" bgcolor="#CCCCCC">Owned-With-Loan</td>
        	          <td bgcolor="#CCCCCC"><input type="radio" disabled name="residence" id="residence4" value="Employers" <?php if($get_add['residence'] == 'Employers') { echo 'checked'; } ?> /></td>
        	          <td style="padding-left:5px" bgcolor="#CCCCCC">Employer's</td>
      	          </tr>
        	        <tr>
        	          <td bgcolor="#CCCCCC"><input type="radio" disabled name="residence" id="residence5" value="Parents / Relatives" <?php if($get_add['residence'] == 'Parents / Relatives') { echo 'checked'; } ?> /></td>
        	          <td style="padding-left:5px" bgcolor="#CCCCCC">Parent's / Relative's</td>
        	          <td></td>
        	          <td style="padding-left:5px"></td>
      	          </tr>
        	...
        	<table width="85%" id="table_form">
                ...
                <tr>
					...
					<table id="radio_table7">
					  <tr>
						<td bgcolor="#CCCCCC"><input type="radio" disabled name="c_workingtype" id="c_workingtype" value="SELF EMPLOYED" <?php if($get_c['c_workingtype'] == 'SELF EMPLOYED') { echo 'checked'; } ?> onclick="wt2()" /></td>
						<td style="padding-left:5px; padding-right:15px" bgcolor="#CCCCCC">Self Employed</td>
						<td bgcolor="#CCCCCC"><input type="radio" disabled name="c_workingtype" id="c_workingtype" value="PRIVATE" <?php if($get_c['c_workingtype'] == 'PRIVATE') { echo 'checked'; } ?> onclick="wt2()" /></td>
						<td style="padding-left:5px; padding-right:15px" bgcolor="#CCCCCC">Private</td>
						<td bgcolor="#CCCCCC"><input type="radio" disabled name="c_workingtype" id="c_workingtype" value="GOVERNMENT" <?php if($get_c['c_workingtype'] == 'GOVERNMENT') { echo 'checked'; } ?> onclick="wt2()" /></td>
                ...
                <tr>
                  ...
                  <td bgcolor="#CCCCCC">
					  <table id="radio_table8">
						<tr>
						  <td bgcolor="#CCCCCC"><input type="radio" disabled name="c_workingtype" id="c_workingtype2" value="RETIRED" <?php if($get_c['c_workingtype'] == 'RETIRED') { echo 'checked'; } ?> onclick="wt2()" /></td>
						  <td style="padding-left:5px; padding-right:15px" bgcolor="#CCCCCC">Retired</td>
						  <td bgcolor="#CCCCCC"><input type="radio" disabled name="c_workingtype" id="c_workingtype2" value="others" <?php if($get_c['c_workingtype'] != 'GOVERNMENT' && $get_c['c_workingtype'] != 'RETIRED' && $get_c['c_workingtype'] != 'PRIVATE' && $get_c['c_workingtype'] != 'SELF EMPLOYED' && $get_c['c_workingtype'] != '') { echo 'checked'; } ?> onclick="wt()" /></td>
        	...
        	<table width="85%" id="table_form">
            	<tr>
                  ...
                  <td width="18%" style="padding-right:10px">Basic Salary</td>
                    <td width="27%" bgcolor="#CCCCCC"><?php echo $get_f['basic_salary']; ?></td>
        ...
        <center>
        	<table width="85%" id="table_form">
                ...
                <td><table id="radio_table7">
                  <tr>
                    <td bgcolor="#CCCCCC"><input type="radio" disabled name="s_workingtype" id="s_workingtype" value="SELF EMPLOYED" <?php if($get_s['s_workingtype'] == 'SELF EMPLOYED') { echo 'checked'; } ?> onclick="swt2()" /></td>
                    <td style="padding-left:5px; padding-right:15px" bgcolor="#CCCCCC">Self Employed</td>
                    <td bgcolor="#CCCCCC"><input type="radio" disabled name="s_workingtype" id="s_workingtype" value="PRIVATE" <?php if($get_s['s_workingtype'] == 'PRIVATE') { echo 'checked'; } ?> onclick="swt2()" /></td>
                    <td style="padding-left:5px; padding-right:15px" bgcolor="#CCCCCC">Private</td>
                    <td bgcolor="#CCCCCC"><input type="radio" disabled name="s_workingtype" id="s_workingtype" value="GOVERNMENT" <?php if($get_s['s_workingtype'] == 'GOVERNMENT') { echo 'checked'; } ?> onclick="swt2()" /></td>
                    <td style="padding-left:5px" bgcolor="#CCCCCC">Government</td>
                  </tr>
                </table></td>
              </tr>
                <tr>
        	      ...
        	      <td><table id="radio_table4">
                    <tr>
                      <td bgcolor="#CCCCCC"><input type="radio" disabled name="s_others_ic" id="s_others_ic" value="police" <?php if($get_s['s_others_ic'] == 'police') { echo 'checked'; } ?> onclick="apic2();" /></td>
                      <td style="padding-left:5px; padding-right:20px"bgcolor="#CCCCCC">Police</td>
                      <td bgcolor="#CCCCCC"><input type="radio" disabled name="s_others_ic" id="s_others_ic" value="army" <?php if($get_s['s_others_ic'] == 'army') { echo 'checked'; } ?> onclick="apic2();" /></td>
				  ...
				  <table id="radio_table8">
                    <tr>
                      <td bgcolor="#CCCCCC"><input type="radio" disabled name="s_workingtype" id="s_workingtype2" value="RETIRED" <?php if($get_s['s_workingtype'] == 'RETIRED') { echo 'checked'; } ?> onclick="swt2()" /></td>
                      <td style="padding-left:5px; padding-right:15px" bgcolor="#CCCCCC">Retired</td>
                      <td bgcolor="#CCCCCC"><input type="radio" disabled name="s_workingtype" id="s_workingtype2" value="others" <?php if($get_s['s_workingtype'] != 'GOVERNMENT' && $get_s['s_workingtype'] != 'RETIRED' && $get_s['s_workingtype'] != 'PRIVATE' && $get_s['s_workingtype'] != 'SELF EMPLOYED' && $get_s['s_workingtype'] != '') { echo 'checked'; } ?> onclick="swt()" /></td>
                      <td style="padding-left:5px; padding-right:15px" bgcolor="#CCCCCC">Others</td>
					  <td bgcolor="#CCCCCC"><?php if($get_s['s_workingtype'] != 'GOVERNMENT' && $get_s['s_workingtype'] != 'RETIRED' && $get_s['s_workingtype'] != 'PRIVATE' && $get_s['s_workingtype'] != 'SELF EMPLOYED' && $get_s['s_workingtype'] != '') { echo $get_s['s_workingtype']; } ?></td>
                    </tr>
                  </table>
				  </td>
                </tr>
    ...
    <tr>
          ...
          <table width="85%" id="table_form">
            ...
            <tr>
			  ...
			  <?php $ctr_1=0; if($get_a['a_shoplotfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_shoplotfile']; ?>" target="_blank"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
            ...
            <tr>
			  ...
			  <?php $ctr_2=0; if($get_a['a_icfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_icfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
						//callout uploaded files
            ...
            <tr>
			  ...
			  <?php $ctr_3=0; if($get_a['a_bankfile'] != '') { ?>
                  <td><a href="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_bankfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
						//callout uploaded files
            ...
            <tr>
			  ...
			  <?php $ctr_4=0; if($get_a['a_payslipfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_payslipfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
						//callout uploaded files
        ...
        <?php $ctr_5=0; if($get_a['a_atmfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_atmfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
          //callout uploaded files
          ...
          ?>
            ...
            <tr>
              <td style="padding-right:10px">Expired (Month/Year)  </td>
        ...
        <?php $ctr_6=0; if($get_a['a_housefile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_housefile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
            //callout uploaded files
            ...
            <tr>
              <td style="padding-right:10px">Card Pin No </td>
        ...
        <?php $ctr_8=0; if($get_a['a_landfile'] != '') { ?>
               <td>   <a href="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_landfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                  <?php } ?>
                  </td>
                  <?php
            //callout uploaded files
              ...
              <td rowspan="5"><table width="100%">
                  ...
                  <tr>
                    <td width="50%" bgcolor="#CCCCCC"><?php if($get_a['a_lefthand'] != '') { ?>
                        <img src="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_lefthand']; ?>" name="lh_img" id="lh_img" style="height:115px; width:115px" />
                        <?php } else { ?>
                    ...
                    <td width="50%" bgcolor="#CCCCCC"><?php if($get_a['a_righthand'] != '') { ?>
                        <img src="<?php echo "../files/customer/" . $branch_name . "/" . $id."/".$get_a['a_righthand']; ?>" name="rh_img" id="rh_img" style="height:115px; width:115px" />
                        <?php } else { ?>
