				  	...
				  	<table>
						<tr>
							<td>
								...
								?>
									<a href="<?php echo $image_link; ?>" rel="shadowbox"><img src="<?php echo "../files/customer/".$id."/".$get_q['cust_pic']; ?>" name="cust_pic2" id="cust_pic2" style="height:115px; width:115px"></a>
								<?php } else { ?>
    ...
    <tr>
        ...
        <center>
        	<table width="85%" id="table_form">
                ...
                <tr>
                	<td align="left" style="padding-right:10px">Employment<br/><a onClick=reset_c_Employment()><u>Reset</u></a></td>
        	...
        	<table width="85%" id="table_form">
                ...
                <tr>
					...
					<table>
						...
						<td>
                    	<a href="<?php echo "../files/customer/".$id."/".$get_a['a_shoplotfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_1; ?></a>
