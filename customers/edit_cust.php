...
<table width="1280" id="list_table">
    <tr>
    	<td>
			<table>
				<tr>
					<td>Created By: <?php if($get_q['staff_name'] != '') { echo $get_q['staff_name']; } else { echo 'System Admin'; echo $_SESSION['dn'];} ?></td>
    	...
    	<td>
        	<center>
        	  <table width="85%" id="table_form2">
				  	...
				  	<table>
						<tr>
							<td>
								...
								?>
									<a href="<?php echo $image_link; ?>" rel="shadowbox"><img src="<?php echo "../files/customer/" . $branch_name . "/" .$id."/".$get_q['cust_pic']; ?>" name="cust_pic2" id="cust_pic2" style="height:115px; width:115px"></a>
								<?php } else { ?>
							...
							<td>
								...
								?>
									...
									<img src="<?php echo "../files/customer/"  . $branch_name . "/" .$id."/".$get_q['cust_pic2']; ?>" name="cust_pic4" id="cust_pic4" style="height:115px; width:115px">
									</a>
								<?php } else { ?>
							...
							<td>
								...
								?>
									<a href="<?php echo $image_link; ?>" rel="shadowbox">
									<img src="<?php echo "../files/customer/" . $branch_name . "/" .$id."/".$get_q['cust_pic3']; ?>" name="cust_pic6" id="cust_pic6" style="height:115px; width:115px">
									</a>
								<?php } else { ?>
                ...
                <tr>
                  <td align="left" style="padding-right:10px">Others<br/><a onClick=reset_others()><u>Reset</u></a></td>
    	...
    	<td>
        	<center>
        	    ...
        	    <tr>
        	      ...
        	      <td align="right" style="padding-right:100px"><a onClick=deleteResAdd()><u>Reset Address</u></a></td>
        	      <td ></td>
        	     <td align="right" style="padding-right:30px"><a onClick=deleteMailAdd()><u>Reset Address</u></a></td>
       	        </tr>
    ...
    <tr>
        ...
        <center>
        	<table width="85%" id="table_form">
                ...
                <tr>
                	<td align="left" style="padding-right:10px">Employment<br> <br><a onClick=reset_c_Employment()><u>Reset</u></a></td>
                ...
                <td align="left" style="padding-right:10px">State</td>
                <td><input type="text" name="c_state" id="c_state" tabindex="6" value="<?php echo $get_c['c_state']; ?>" />
					&nbsp;&nbsp;<a onClick=deleteComAdd()><u>Reset Address</u></a></td>
                </tr>
                <tr>
                  <td align="left" style="padding-right:10px">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td>
                	...
                	<td align="left" style="padding-right:10px">Email Address</td>
                    <td><input type="text" name="c_email" id="c_email" class="email" style="width:300px" tabindex="6" value="<?php echo $get_c['c_email']; ?>" /></td>
               	</tr>
                <tr>
                	<td>&nbsp;</td>
                    <td>&nbsp;</td>
        	...
        	<table width="85%" id="table_form">
                ...
                <tr>
                	<td align="left" style="padding-right:10px">Old I/C</td>
           	        ...
           	        <td align="left" style="padding-right:10px">Employment<br/><a onClick=resetEmployment()><u>Reset</u></a></td>
                <td><table id="radio_table7">
                  <tr>
                ...
                <tr>
				  ...
				  <table id="radio_table8">
                    <tr>
                      ...
                      <td style="padding-left:5px; padding-right:15px">Others</td>
					  <td><input type="text" name="s_other_wt" id="s_other_wt" <?php if($get_s['s_workingtype'] != 'GOVERNMENT' && $get_s['s_workingtype'] != 'RETIRED' && $get_s['s_workingtype'] != 'PRIVATE' && $get_s['s_workingtype'] != 'SELF EMPLOYED' && $get_s['s_workingtype'] != '') { ?>value="<?php echo $get_s['s_workingtype']; ?>"<?php } else { echo 'disabled'; }?> /></td>
                    </tr>
                  </table>
				  </td>
                </tr>
        	...
        	<center>
				...
				?>
                    <tr id="row_<?php echo $ctr_r; ?>">
                        ...
                        <td><textarea name="r_address_<?php echo $ctr_r; ?>" id="r_address_<?php echo $ctr_r; ?>" style="width:300px; height:40px; color:#666666; font-size:13px" tabindex="13"><?php echo $get_r['r_address']; ?></textarea></td>
        	...
        	<table width="85%" id="table_form">
                ...
                <tr>
					...
					<table>
						...
						<?php $ctr_1 = 0; if($get_a['a_shoplotfile'] != '') { $ctr_1++; ?>
						<td>
                    	<a href="<?php echo "../files/customer/" . $branch_name . "/" .$id."/".$get_a['a_shoplotfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_1; ?></a>
						<?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
								<br />
								<a href="javascript:deleteAF('<?php echo $get_a['a_shoplotfile']; ?>', '../files/customer/<?php echo $branch_name; ?>/<?php echo $id; ?>/','<?php echo $id; ?>')" title="Delete">
						...
						?>
									<td align="center">
									<a href="<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_1; ?></a>
									<?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
						...
						<td><a href="multiimage/index.php" rel="shadowbox(width=900px)"><img src="../img/browse.JPG" /></a></td>
						</tr>
					</table>					</td>
            	</tr>
                <tr>
                    ...
                    <td>
						...
						<td>
                      <a href="<?php echo "../files/customer/"  . $branch_name . "/" .$id."/".$get_a['a_icfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
					  <?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
										<br /><a href="javascript:deleteAF('<?php echo $get_a['a_icfile']; ?>', '../files/customer/<?php echo $branch_name; ?>/<?php echo $id; ?>/')" title="Delete"><img src="../img/delete-btn.png" width="15" /></a>
									<?php } ?>	
					  </td>
                      <?php } ?>
						<?php
						...
						?>
									...
									<td align="center">
									<a href="<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_2; ?>	</a>
										<?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
						...
						?>
						<td><a href="multiimage/ic.php" rel="shadowbox(width=900px)"><img src="../img/browse.JPG" /></a></td>
						</tr>
						</table>					  </td>
                </tr>
                <tr>
                    ...
                    <td>
						...
						<?php $ctr_3 = 0; if($get_a['a_bankfile'] != '') { ?>
							<td>
						  <a href="<?php echo "../files/customer/" . $branch_name . "/" .$id."/".$get_a['a_bankfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
								<?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
									<br /><a href="javascript:deleteAF('<?php echo $get_a['a_bankfile']; ?>', '../files/customer/<?php echo $branch_name; ?>/<?php echo $id; ?>/')" title="Delete"><img src="../img/delete-btn.png" width="15" /></a>
									<?php } ?>	
						  </td>
						  <?php } ?>
						<?php
						...
						?>
									...
									<td>
									<a href="<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_3; ?>	</a></a>
									<?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
						...
						?>
                      	...
                      	<td><a href="multiimage/bs.php" rel="shadowbox(width=900px)"><img src="../img/browse.JPG" /></a></td>
						</tr>
						</table>			  		</td>
              </tr>
              <tr>
                ...
                <td align="left" style="padding-right:10px">Salary Slips </td>
                    <td>
						...
						<td>
                      <a href="<?php echo "../files/customer/" . $branch_name . "/" .$id."/".$get_a['a_payslipfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
						<?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
									<br /><a href="javascript:deleteAF('<?php echo $get_a['a_payslipfile']; ?>', '../files/customer/<?php echo $branch_name; ?>/<?php echo $id; ?>/')" title="Delete"><img src="../img/delete-btn.png" width="15" /></a>
									<?php } ?>	
					  </td>
                      <?php } ?>
						<?php
						...
						?>
									...
									<td>
									<a href="<?php echo $image_link; ?>" rel="shadowbox()"><img src="../img/view_source.png" width="20" /><br /><?php echo $ctr_4; ?></a>
									<?php if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld'  || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'huizhen')){	?>
						...
						?>
                      	<td><a href="multiimage/salary.html" rel="shadowbox(width=900px)"><img src="../img/browse.JPG" /></a></td>
						</tr>
						</table>					</td>
              </tr>
              <tr>
             ...
             <td align="left" style="padding-right:10px">ATM Card </td>
                <td>
					...
					<?php $ctr_5 = 0;if($get_a['a_atmfile'] != '') { ?>
                      <td>
					  <a href="<?php echo "../files/customer/" . $branch_name . "/" .$id."/".$get_a['a_atmfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>					  </td>
                      <?php } ?>
					<?php
					//callout uploaded files
              ...
              <tr>
                ...
                <td align="left" style="padding-right:10px">Mortgage</td>
                    <td>
						...
						<td>
                    	<a href="<?php echo "../files/customer/"  . $branch_name . "/" .$id."/".$get_a['a_housefile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>
                    <?php } ?>
						</td>
						<?php
						//callout uploaded files
              ...
              <tr>
				...
				<table>
					...
					<td>
                    	<a href="<?php echo "../files/customer/" . $branch_name . "/" .$id."/".$get_a['a_landfile']; ?>" rel="shadowbox"><img src="../img/view_source.png" width="20" /></a>					</td>
                    <?php } ?>
					<?php
						//callout uploaded files
              ...
              <tr>
                ...
                <td><select name="a_paymentdate" id="a_paymentdate" style="height:30px">
                  <option value=""></option>
                  <?php for($i = 1; $i <= 31; $i++) {?>
                  ...
                  <?php } ?>
                    ...
                    <tr>
                  	<td width="18%" align="left" style="padding-right:10px"></td>
                  	<td width="32%"></td>
...
function SBClose() {
	  ...
	  window.open('edit_cust.php?id='+$idReload, '_self');     // Reload parent window.
...
function deleteResAdd()
{
		...
		document.getElementById('month_stay').value = '';
		document.getElementById('year_stay').value = '';
		document.getElementById('residence1').checked = false;
		document.getElementById('residence2').checked = false;
		document.getElementById('residence3').checked = false;
		document.getElementById('residence4').checked = false;
		document.getElementById('residence5').checked = false;
	
}

function deleteMailAdd()
{
		document.getElementById('m_address1').value = '';
		document.getElementById('m_address2').value = '';
		document.getElementById('m_address3').value = '';
...
function deleteComAdd()
{
		document.getElementById('c_address1').value = '';
		document.getElementById('c_address2').value = '';
		document.getElementById('c_address3').value = '';
		document.getElementById('c_postcode').value = '';
...
function resetEmployment()
{
	...
	document.getElementById('s_workingtype').checked = reset;
	document.getElementById('s_other_wt').value = "";
	document.getElementById('s_workingtype').checked = false;
...
function reset_c_Employment()
{
	
	document.getElementById('c_workingtype').checked = reset;
	document.getElementById('other_wt').value = "";
	document.getElementById('c_workingtype').checked = false;
	document.getElementById('company').value = "";
	document.getElementById('nature_business').value = "";
	document.getElementById('department').value = "";
	document.getElementById('position').value = "";
	document.getElementById('c_monthworking').value = "";
	document.getElementById('c_yearworking').value = "";
