...
<table width="1280" id="list_table">
    ...
    <tr>
      <td style="padding:0px"><span style="padding:0px; padding-top:5px">Notes</span></td>
...
months </td>
	...
	<tr>
		...
		<td><input type="text" readonly="readonly" value="RM <?php echo number_format($intrate['monthly'], '2'); ?>" /></td>
		<td  style="padding:0px">&nbsp;</td>
	</tr>  
...
<table width="1280" id="list_table">
	...
	$latecount_q = mysql_query("SELECT * FROM loan_payment_details 
    ...
    <tr <?php echo $style; ?>>
      ...
      <?php } else { echo date('d-m-Y', strtotime($get_l['payment_date'])); } ?>        </td>
          ...
          <?php } ?>
          <?php } ?></td>
  	  <td><?php if($get_l['payment'] == '0' && $get_l['payment_date'] == '0000-00-00') {  ?>
            <?php if($style == '') {?>
  ...
  <?php } else { ?>
		...
		<?php if($get_l['payment_date'] == '0000-00-00') {  ?>
			...
			<?php if($latectr == $latecount) { ?><?php } else { 
				$nxtm = $get_l['month'] + 1;
				$nxtd_q = mysql_query("SELECT * FROM loan_payment_details 
										WHERE month = '".$nxtm."' 
										AND customer_loanid = '".$get_l['customer_loanid']."'");
    ...
    <tr>
    	<td colspan="7" align="right"><input type="button" name="back" id="back" onClick="history.go(-1)" value=""></td>
    </tr>
    <tr>
    	<td colspan="7">&nbsp;</td>
    </tr>
