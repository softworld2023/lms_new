...
<table width="1280" background="../img/menu-bg.jpg" height="47" id="hideprint">
    <tr>
        <td style="padding-left:10px">
               ...
               <a href="../baddebt/" title="Bad Debt" id="header">
                  <table id="navigation_button">
                        <tr>
                            <td style="padding-right:3px"><img src="../img/cash-register-icon.png" width="25"></td>
                            <td style="padding-right:7px">Bad Debt (All Branch)</td>
                            <td><img src="../img/menu-line.jpg"></td>
                        </tr>
                  </table>
                </a>
                            <a href="../reject/" title="Reject List" id="header">
                  <table id="navigation_button">
                        <tr>
                            <td style="padding-right:3px"><img src="../img/error.png" width="25"></td>
                            <td style="padding-right:7px">Reject List (All Branch)</td>
                            <td><img src="../img/menu-line.jpg"></td>
                        </tr>
                  </table>
                </a>
