<?php
session_start();
include("../include/dbconnection3.php");
include("../config.php");
...
<table width="1280" background="../img/menu-bg.jpg" height="47" id="hideprint">
    <tr>
        ...
        ?>
				...
				<a href="../cashbookhq/setting.php" title="Cashbook Setting" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/expenses-icon.png"></td>
                		<td style="padding-right:7px">Cashbook Setting</td>
                        <td style="padding-right:3px"><img src="../img/menu-line.jpg"></td>
                    </tr>
                </table>
                </a>
				
				<a href="../cashbookhq/report.php" title="Daily Reports" id="header">
                <table id="navigation_button">
                	<tr>
				...
				<!--<a href="../lampiran/" title="Lampiran" id="header">
                <table id="navigation_button">
                	<tr>
                    	<td style="padding-right:3px"><img src="../img/attach-icon.jpg" width="20"></td>
                		<td style="padding-right:7px">Attachment</td>
        ...
        <?php
    		...
    		?>
				<?php
				if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'joey' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff'))
				{
				?>
