...
<center>
<form method="post" action="action_expenses_minus_accountant.php" onSubmit="return checkForm()">
<table width="1280">
	<tr>
    	<td width="65"><img src="../img/expenses.png" width="56"></td>
        <td>Add New Expenses</td>
    </tr>
    <tr>
    	<td colspan="2">
...
<table width="1280" id="list_table">
	...
	<tr>
        ...
        <td>
			...
			<select name="details1" id="details1" style="height:30px;" onchange="eType(this.value)">
				<option value=""></option>
	...
	<tr>
        ...
        <td>
			...
			<input type="text" name="details2" id="details2" style="width:250px" />
		</td>
    </tr>
    <tr>
    	<th>Date</th>
     ...
     <tr>
    	<th>Pay Month</th>
        <td><input type="text" name="month_receipt" id="month_receipt" value="<?php echo date('Y-m'); ?>"/></td>
    </tr>
    <tr>
        <th>Amount</th>
