...
<table width="1280" id="hideprint">
    ...
    <tr>
        ...
        <div class="subnav">
			<div class="subnav">
			<a href="report.php" id="active-menu">HQ Cashbook Daily</a><a href="customerChannnel.php">Customer Channel</a><a href="loanstatus.php">Loan Status</a><a href="settle.php">Customer Settle Report</a>
		</div>	
		</div>	
        </td>
