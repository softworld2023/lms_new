...
<table width="1280">
    ...
    <tr>
    	<td colspan="2">
        <div class="subnav">
			<a href="index.php" id="active-menu">Borrow Out</a><a href="payout.php">Actual Payout</a><a href="collection.php">Total Collection</a><a href="profit.php">Profit & Loss</a><a href="expenses.php">Expenses</a><a href="interest.php">Interest Earn</a><a href="latepayment.php">Late Payment Collections</a><a href="daily.php">Daily Collections</a><a href="statement.php">Statement</a>
		</div>	
        </td>
...
<table width="1280" id="list_table">
    ...
    <tr>
    	<td><?php echo $ctr."."; ?></td>
        <td><a href="package_borrowout.php?id=<?php echo $get_p['id']; ?>"><?php echo $get_p['scheme']; ?></a></td>
    </tr>
    <?php } ?>
    <tr>
    	<td><?php echo ($ctr+1)."."; ?></td>
        <td><a href="package_borrowoutsum.php">SUMMARY</a></td>
    </tr>
    <tr>
    	<td colspan="2">&nbsp;</td>
    </tr>
