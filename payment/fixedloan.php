...
<table width="1280" id="list_table">
    ...
    <tr>
      ...
      <td><input type="text" name="period" id="period" value="<?php echo $get_q['loan_period']; ?>" style="width:50px" onchange="changePeriod(this.value,'<?php echo $get_q['loan_period']; ?>')" /> months <div id="save_period" style="display:none"><a href="javascript:updatePeriod('<?php echo $get_q['loan_period'] ?>', '<?php echo $id; ?>')"><input type="button" name="saveperiod" id="saveperiod" value="" /></a></div></td>
    </tr>
    <tr>
...
<table width="1280" id="list_table">
    ...
    <tr>
    	...
    	<td><?php echo "RM ".$get_l['loan_balance']; ?></td>
    	<td><?php echo "RM ".$get_l['loan_permonth']; ?></td>
        <td><?php echo "RM ".$get_l['interest_permonth']; ?></td>
      <td>
        ...
        <td>
            ...
            <a href="javascript:payConfirm('<?php echo $get_q['loan_period'] ?>', '<?php echo $get_l['month']; ?>')"><img src="../img/payment-received/payment-received.png" width="30" /></a>
            <?php } ?>
    	</td>
    </tr>
    <?php } ?>
