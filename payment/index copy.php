...
<table width="1280">
	...
	<tr>
        ...
        <div class="subnav">
			...
			<a href="payment_monthly.php">Monthly Listing</a><a href="payment_instalment.php" >Instalment Listing</a>
...
<table width="1280" id="list_table">
	...
	if($r>0){	
		$currentDate = false;
	while($get_q = mysql_fetch_assoc($sql)){
		if (substr($get_q['loan_code'],0,2) == 'TL') {
			continue;
		} else if (!(substr($get_q['loan_code'],0,2) == 'BP' || substr($get_q['loan_code'],0,2) == 'KT' || substr($get_q['loan_code'],0,2) == 'AS' || substr($get_q['loan_code'],0,2) == 'TS')) {
			continue;
		}
