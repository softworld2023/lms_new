...
elseif($_POST['action'] == 'update_amount1')
{
	...
	$cf_q1 = mysql_query("SELECT * FROM skimkutu_payment WHERE skim_id = '".$id1."'");
	$cfq1 = mysql_fetch_assoc($cf_q1);
	
	if($cfq1)
	{
		//update
		$update_q1 = mysql_query("UPDATE skimkutu_payment SET payment_date = '".$editdate1."', amount = '".$editout1."' WHERE id = '".$id1."'");
	}
