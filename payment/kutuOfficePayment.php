...
<center>
<form method="post" action="actionkutuOffice.php" onSubmit="return checkForm()" autocomplete="off">
<input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
<table width="100%" id="list_table">
	<tr>
    	<th colspan="2">Payment For <?php echo $get_q['title']; ?></th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="left"><input type="text" name="amount" id="amount" class="currency" placeholder="RM" value="<?php echo $get_q['monthlyamt']; ?>" /></td>
    </tr>
    <tr>
