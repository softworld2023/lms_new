	...
	<tr <?php echo $style; ?>>
        ...
        <td>
            ...
            <td>
				...
				<?php } else { echo "RM ".$get_l['payment']; } ?>
				<?php } ?>
				<?php } else { echo "RM ".$get_l['payment_int']; } ?>    
		  
            </td>
            <td>
				<?php if($get_l['payment_date'] == '0000-00-00') {  ?>
				<?php if($style == '') {?>
				<input type="text" name="payment_date" id="payment_date" style="width:80px" value="<?php echo date('Y-m-d'); ?>" />
				<?php } else { ?>
				<?php if($latectr == $latecount) { ?>
				<input type="text" name="payment_date" id="payment_date" style="width:80px" value="<?php echo date('Y-m-d'); ?>" />
				<?php } else { ?>
            ...
            <td>
				<?php if($get_l['payment_date'] == '0000-00-00') {  ?>
				<?php if($style == '') {?>
				<input type="text" name="new_receipt" id="new_receipt" style="width:120px" value="<?php echo $get_q['loan_code']; ?>"/>
				<?php } else { ?>
				<?php if($latectr == $latecount) { ?>
				<input type="text" name="new_receipt" id="new_receipt" style="width:120px" value="<?php echo $get_q['loan_code']; ?>"/>
