...
$initial_jumlah_besar = $cash_in_hand + ($cash_in_hand * $loan_period * 0.015);
$monthly_payment = $initial_jumlah_besar / $loan_period;

$jumlah_besar = floor($monthly_payment) * $loan_period;
...
$header .=
	...
	<div>
		...
		<tr>
			...
			<td width="8%" style="text-align:center;border-bottom: 1px solid; border-right: 1px solid;">'.number_format(floor($cash_in_hand), 2).'</td>
			<td width="10%" style="text-align:center;border-bottom: 1px solid; border-right: 1px solid;">'.number_format(floor($jumlah_faedah), 2).' </td>
			<td width="8%" style="text-align:center;border-bottom: 1px solid; border-right: 1px solid;">'.number_format(floor($jumlah_besar), 2).'</td>
			...
			<td width="10%" style="text-align:center;border-bottom: 1px solid; border-right: 1px solid;"> '.$loan_period.'</td>
			<td width="17%" style="text-align:center;border-bottom: 1px solid; border-right: 1px solid;">'.number_format(floor($monthly_payment), 2).'</td>
		</tr>
		</table>
	</div>
