...
// Set the memory limit to 512 megabytes
...
$payment = strtoupper(convert_number($mth_payment));
...
for ($i = 1; $i <= $maxrow; $i += 2)
{
    ...
    <tr>
    		<td >Received from</td>
    		<td>: {$result_2['name']}</td>
    		<td style='border-right:1px solid black; border-top:1px solid black; border-left:1px solid black;'></td>
    </tr>
    <tr>
    ...
    <tr>
    		<td height='15' style='border-left:1px solid black; border-top:1px solid black;text-align:center;font-size:10px'><b>RM ".number_format($mth_payment,2)."</b></td>
    			<td style=' border-left:1px solid black; border-top:1px solid black;'></td>
    			<td style='border-right:1px solid black; border-left:1px solid black;'></td>
    </tr>
    <tr>
    		<td height='15' style='border-left:1px solid black; border-top:1px solid black;border-bottom:1px solid black;'><b>Cheque No.</b></td>
    			<td style=' border-left:1px solid black; border-top:1px solid black;border-bottom:1px solid black;text-align:center;'><b>Received By</b></td>
