...
if($_POST['action'] == 'update_remarks')
{
	...
	// $update_q = mysql_query("UPDATE customer_loanpackage SET loan_remarks = '".$a_remarks."' WHERE id = '".$id."'");
		...
		$update_q = mysql_query("UPDATE customer_loanpackage SET loan_remarks = '".$a_remarks2."', update_loan_remarks_date = now(), update_loan_remarks_by = '".$_SESSION['login_name']."' WHERE id = '".$id."'");
...
if($_POST['action'] == 'update_remarks_boss')
{
	...
	$update_q = mysql_query("UPDATE customer_loanpackage SET loan_remarks = '".$a_remarks."', update_loan_remarks_date = now(), update_loan_remarks_by = '".$_SESSION['login_name']."' WHERE id = '".$id."'");
