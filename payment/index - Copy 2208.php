	...
	//{
		if($_POST['month'] != '')
		{
			...
			if($_POST['outdate'] != '')
			{
				...
				$cond .= " and pd.month_receipt = '".$_POST['month']."' and pd.payment_date < '".$outdate."' and (lp.loan_status = 'Paid' OR lp.loan_status = 'Finished') AND (lp.payout_date <= '".$_SESSION['cdate']."' OR lp.payout_date = '0000-00-00')";
			}else
			{
				$cond .= " and lp.loan_status = 'Paid' and pd.month_receipt = '".$_POST['month']."' and pd.payment_date = '0000-00-00'";
				$_SESSION['cdate'] = '';
				$ccond .= '';
			}
		...
		}else
		{
			...
			{
				$cond .= " and lp.loan_status = 'Paid' and pd.payment_date = '0000-00-00'";
				$_SESSION['cdate'] = '';
				$ccond .= '';
			}
			$_SESSION['pmonth'] = '';
