...
<input type="hidden" name="loan_id" id="loan_id" value="<?php echo $get_p['customer_loanid']; ?>"><input type="hidden" name="payment_id" id="payment_id" value="<?php echo $payment_id; ?>">
<table width="100%" id="list_table">
    ...
    <tr>
    	<td width="35%" style="padding-right:10px;" align="right">Loan Period</td>
        <td align="left"><input type="text" name="loan_period" id="loan_period" value="<?php echo $period; ?>" style="width:75px"> months</td>
    </tr>
    <tr>
    	<td style="padding-right:10px;" align="right">Add On</td>
        <td align="left"><input type="text" name="add_on" id="add_on" class="currency" placeholder="RM" onChange="addOn()" /></td>
    </tr>
    <tr>
    	<td style="padding-right:10px;" align="right">Reduce</td>
        <td align="left"><input type="text" name="reduce" id="reduce" class="currency" placeholder="RM" onChange="reduceV()" /></td>
    </tr>
    <tr>
    	<td style="padding-right:10px; padding-top:17px" valign="top" align="right">Reason</td>
        <td align="left">
        	<textarea name="reason" id="reason" style="width:300px; height:55px"></textarea>
        </td>
    </tr>
    <tr>
    	<td colspan="2" style="padding:0px">&nbsp;</td>
    ...
    <tr>
    	<td colspan="2" style="padding-right:10px" align="right"><input type="submit" name="adjust_flexiloan" id="adjust_flexiloan" value="" tabindex="4">&nbsp;&nbsp;&nbsp;<input type="reset" id="reset" name="reset" value=""></td>
    </tr>
    <tr>
    	<td>&nbsp;</td>
    </tr>
...
$(document).ready(function() {
	document.getElementById('loan_period').focus();
});
