...
<center>
<form method="post" action="actionadjust.php" onSubmit="return checkForm()" autocomplete="off">
...
<table width="100%" id="list_table">
    ...
    <tr>
      <td align="right" style="padding-right:10px;">Late Interest Date </td>
      <td align="left"><input type="text" name="late_intdate" id="late_intdate" />&nbsp;</td>
    </tr>
    <tr>
    	<td width="35%" align="right" style="padding-right:10px;">Late Payment Interest</td>
        <td align="left"><input type="text" name="late_int" id="late_int" class="currency" placeholder="RM" /></td>
    </tr>
    <tr>
    	<td colspan="2" style="padding:0px">&nbsp;</td>
    </tr>
    <tr>
    	<td colspan="2" style="padding-right:10px" align="right"><input type="submit" name="adjust_late" id="adjust_late" value="" tabindex="4">&nbsp;&nbsp;&nbsp;<input type="reset" id="reset" name="reset" value=""></td>
    </tr>
    <tr>
    	<td>&nbsp;</td>
    </tr>
...
<script>
$('#late_intdate').click( function(e) {$(this).off('click').AnyTime_picker({ format: "%Y-%m-%d", labelTitle: "Select Date"}).focus(); } ).
keydown(
	function(e)
	{
...
function checkForm()
{
	if((document.getElementById('late_int').value != '' && document.getElementById('late_intdate').value != ''))
	{
		$('#message').empty();
		return true;	
	}
	...
	{
		var msg = "<div class='error'>You must fill in late interest charges & date!</div>";
		$('#message').empty();
		$('#message').append(msg); 
		$('#message').html();
		return false;
