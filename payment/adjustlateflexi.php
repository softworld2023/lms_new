...
#adjust_lateflexi:hover
{
	background:url(../img/add-enquiry/submit-roll-over.jpg);
}
</style>
<center>
<form method="post" action="actionadjust.php" onSubmit="return checkForm()">
...
<table width="100%" id="list_table">
    ...
    <tr>
    	<td width="35%" style="padding-right:10px;" align="right">Late Period</td>
        <td align="left"><input type="text" name="late_period" id="late_period" style="width:75px"> months</td>
    </tr>
	<!--<tr>
    ...
    <tr>
    	<td style="padding-right:10px;" align="right">Late Payment Interest</td>
    ...
    <tr>
    	<td colspan="2" style="padding-right:10px" align="right"><input type="submit" name="adjust_lateflexi" id="adjust_lateflexi" value="" tabindex="4">&nbsp;&nbsp;&nbsp;<input type="reset" id="reset" name="reset" value=""></td>
    </tr>
    <tr>
    	<td>&nbsp;</td>
    </tr>
...
function checkForm()
{
	if((document.getElementById('late_period').value != '' && document.getElementById('late_int').value != ''))
	{
		$('#message').empty();
		return true;	
	}
	...
	{
		var msg = "<div class='error'>You must fill in all the fields!</div>";
		$('#message').empty();
		$('#message').append(msg); 
		$('#message').html();
		return false;
