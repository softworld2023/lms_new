...
<table width="1280" id="list_table">
    ...
    <tr <?php echo $style; echo $get_l['id']; ?>>
        ...
        <td>
			<?php if($get_l['payment_date'] != '0000-00-00'){ if($_SESSION['login_level'] == 'Boss' || ($_SESSION['login_username'] == 'softworld' || $_SESSION['login_username'] == 'fong' || $_SESSION['login_username'] == 'staff')) 
