...
<tr>
    ...
    <td><?php if($get_p['inamt'] != 0) { echo "RM ".number_format($get_p['inamt'],'2'); }?></td>
	<td><?php if($get_p['outamt'] != 0) { echo "RM ".number_format($get_p['outamt'],'2'); }?></td>	
    <td><?php echo "RM ".number_format($get_p['amount'],'2'); ?></td>
	<td>
