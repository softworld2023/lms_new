...
<table width="1280" id="list_table">
	...
	//LOAN OUTSTANDING - PROBLEM FROM HERE
	
	$outb_q = mysql_query("SELECT SUM(loan) AS loan FROM balance_rec WHERE customer_loanid = '1240'");
...
<table width="1280" id="list_table">
	...
	if($_SESSION['cdate'] != '')
	{
		...
		{
			//CHECK FIRST MONTH OF CUSTOMER LOAN PAYMENT
			...
			if($_SESSION['loanpackage'] != 'SKIM CEK'){
