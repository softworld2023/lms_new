...
<table width="1280" id="list_table">
	...
	while($get_q = mysql_fetch_assoc($sql)){
		...
		// 
		if (substr($get_q['loan_code'],0,2) == 'MJ' 
		|| substr($get_q['loan_code'],0,2) == 'PP' 
		|| substr($get_q['loan_code'],0,2) == 'TL' 
		|| substr($get_q['loan_code'],0,2) == 'YW' 
		|| substr($get_q['loan_code'],0,2) == 'BT' 
		|| substr($get_q['loan_code'],0,2) == 'CL') {
			continue;
		}
