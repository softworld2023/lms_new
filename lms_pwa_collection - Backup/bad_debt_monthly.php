...
$sql_1 = mysql_query("SELECT 
					...
					AND 
						(r.status ='PAID') order by r.month DESC, r.monthly_date DESC");
if (mysql_num_rows($sql_1) < 1) {
	echo "<script>
			alert('This customer does not have any bad debt.');
        	window.history.back();
		  </script>";
...
<center>
<form method="post" action="../lms_dev/payment/action_lateCust.php" onSubmit="return checkForm()">
...
<table width="100%" id="list_table" border="0">
    ...
    <tr>
	  	<table style="border-collapse:collapse" id="inner" align="center">
			...
			<tr>
				<td><b>Date</b></td>
				<td>&nbsp;</td>
				<td colspan="4"><input type="text" name="bd_date" id="bd_date" required="" autocomplete="off" /></td>
			</tr>
			<tr>
				<td></td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>&nbsp;</td>
				<td colspan="4">
					<input type="number" name="baki_pinjaman" id="baki_pinjaman" class="currency" value="<?php echo $payout_amount;?>" <?php echo ($payout_amount > 0) ? 'readonly' : ''; ?> />
				</td>
			</tr>
		</table>
    </tr>
    ...
    <tr>
    	<td style="padding-right:10px" align="right"><input type="submit" name="add_lateCust_monthly" id="send_toblacklist" value="" tabindex="4">&nbsp;&nbsp;&nbsp;<input type="reset" id="reset" name="reset" value=""></td>
    </tr>
</table>
<br>
</form>
