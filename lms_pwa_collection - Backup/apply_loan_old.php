...
<center>
<form id="mainForm" action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm()">
...
<table width="1280" id="list_table">
	<tr>
    	<td>
        	<table>
            	<tr>
                	<td style="padding-left:15px"><img src="../img/customers-icon.png"></td>
                    <td style="padding-left:15px; font-weight: bold;">Register Customer</td>
                </tr>
            </table>
      </td>
    </tr>
	...
	<tr>
    	<th height="23">Personal Details</th>
  	</tr>
    <tr>
    	<td>
        	<center>
...
<!-- <div id="rejectModal" class="modal" style="display:none;">
  <div class="modal-content">
    <h2>Please enter reject reason:</h2><br>
    <textarea id="reject_reason" rows="4" style="width: 100%;"></textarea><br><br>
    <button class="colored-button green-button" onclick="submitReject()">Submit</button>
    <button class="colored-button red-button" onclick="$('#rejectModal').hide();">Cancel</button>
  </div>
</div> -->
...
keydown(
	...
	function checkForm() {
		...
		if (name === '' || nric === '') {
			...
			$('#message').html("<div class='error'>Full Name & NRIC must be filled!</div>");
			return false;
		}

		if (mobile === '') {
			$('html, body').animate({scrollTop: 150}, 'fast');
			$('#message').html("<div class='error'>Mobile Contact must be filled!</div>");
			return false;
		}
...
//   $('#hidden_reject_reason').val(reason);
//   $('#customerForm').submit();
// }
...
//   form.action = 'action.php'; // approval handler
//   document.getElementById('submit_approve').click();
// }
...
//   var form = document.getElementById('mainForm');
//   <a href="reject.php" title="Reject" rel="shadowbox; width=600px; height=550px">Add Reject</a> // rejection handler
//   document.getElementById('submit_reject').click();
// }
Shadowbox.init();
function submitReject() {
    var name = document.getElementById('name').value;
...
//   // Set form action to reject.php
//   document.getElementById('mainForm').action = '../lms_dev/reject/reject.php';

//   // Submit the form via hidden submit button
//   document.getElementById('submit_reject').click();
// }
