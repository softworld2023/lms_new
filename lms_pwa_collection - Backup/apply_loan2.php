...
<!--                       <select name="loan_package" id="loan_package" tabindex="16" style="height:30px">
					  ...
					  <input type="text" name="loan_package" id="loan_package" value="NEW PACKAGE" readonly autocomplete="OFF" />   </td>
 ...
 <!--                  <td width="20%"style="padding-right:10px" hidden="">Interest Rate </td>
                  ...
                  <td><input type="text" name="loan_amount" id="loan_amount" placeholder="RM" class="currenciesOnly" tabindex="16" onkeyup="hideloanamt(this.value)" autocomplete="OFF" />
					...
					<td style="padding-right:10px">Loan Period (months) </td>
                  	<td>
						<input type="text" name="loan_period" id="loan_period" tabindex="16" onkeyup="calculateAmountMonth()" autocomplete="OFF" />
                	</td>
...
<!--                       <select name="loan_package" id="loan_package" tabindex="16" style="height:30px">
    	...
    	<td>
        	<table width="100%">
            	<tr>
                    ...
                    <td align="right"><input type="submit" name="save_loan" id="save_loan" value="">&nbsp;&nbsp;&nbsp;<input type="reset" id="reset" name="reset" value=""></td>
                </tr>
            </table>
        </td>
    </tr>
 ...
 <script src="https://cdn.jsdelivr.net/npm/signature_pad@2.3.2/dist/signature_pad.min.js"></script>
    ...
    signaturePad.onEnd = function () {
        ...
        // Draw signature over the white background
        tempCtx.drawImage(canvas, 0, 0);

        // Save the base64 image in hidden input
        document.getElementById('signature_data').value = tempCanvas.toDataURL("image/png");
    };
</script>
<script>
...
function checkForm()
{
	var signatureValue = document.getElementById('signature_data').value;
	
	// Check if signature is empty (just a blank string or default "data:image/png;base64,iVBOR..." placeholder)
