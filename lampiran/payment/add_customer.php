...
<table width="1280" id="list_table">
    ...
    <tr>
        ...
        <td><input type="hidden" name="branch_id" id="branch_id" value="<?php echo $branch_id; ?>"><input type="text" name="customercode" id="customercode" value="<?php echo $get_custa['cust_id']; ?>" style="width:230px" /></td>
        <td style="padding:0px">Package</td>
      <td><input type="text" name="loan_package" id="loan_package" value=""  /></td>
      <td style="padding:0px">Bank</td>
      <td><input type="text" name="bankacc" id="bankacc" value="<?php echo $get_custa['bankacc']; ?>" style="width:230px" /></td>
    </tr>
    <tr>
      ...
      <td>
      <input type="text" name="payday" id="payday" value="" placeholder="yyyy-mm-dd" style="width:230px" /></td>
    </tr>
    <tr>
      ...
      <td style="padding:0px">Loan Amount (RM) </td>
        ...
        <td><input type="text" name="a_paymentdate" id="a_paymentdate" style="width:230px" value="" placeholder="yyyy-mm-dd" /></td>
    </tr> 
    <tr>
      <td style="padding:0px">Mobile Phone </td>
      <td><input type="text" name="contact" id="contact" style="width:230px" value="<?php echo $get_custa['phone_no']; ?>"  /></td>
      ...
      <td><input type="text" name="salary" id="salary" style="width:230px" value="<?php echo $get_custa['salary']; ?>"  /></td>
    </tr>
    <tr>
...
&nbsp;month(s) </td>
    ...
    <tr>
        ...
        <td><input type="text" name="loan_total" id="loan_total" value=""  /></td>
        <td style="padding:0px">&nbsp;</td>
    </tr>   
	<tr>
		<td  style="padding:0px">&nbsp;</td>
