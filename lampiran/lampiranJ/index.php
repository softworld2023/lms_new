...
<table width="1280" id="list_table" align="center">
	...
	?> 
		<tr align="center">
			...
			<td><a href="generate.php?id=<?php echo $exp_d['id']; ?>&branch_id=<?php echo $_GET['branch_id']; ?>">
					<img src="../img/view_source.png"/></a>&nbsp;
				<!--<a href="view_details.php?id=<?php echo $exp_d['id']; ?>">
					<img src="../img/view.png"/>&nbsp;-->
				<a href="edit.php?id=<?php echo $exp_d['id']; ?>&branch_id=<?php echo $_GET['branch_id']; ?>">
