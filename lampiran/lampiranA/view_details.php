...
<tr>
		...
		<!--<input type="Submit" name="submit" id="submit" value="Save"  class="all_btn">-->
		&nbsp;&nbsp;&nbsp;<input type="button" name="back" value="Back" class="all_btn" onClick="window.location.href='../lampiranA/index.php?branch_id=<?php echo $_GET['branch_id']?>'" ></td>
    </tr>
<hr/>
</div>
<div class="page">
 ...
 <tr>
  ...
  <tr align="left">
    <td><table width="97%" align="center" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
	  ...
	  <?php
	    $expe = mysql_query("SELECT * FROM customer_loan WHERE nric = '".$ic."'",$db2);
		while($exp_e = mysql_fetch_assoc($expe)){
		?>
		<tr align="center">
        <td><input type="text" size="11" name="date_borrow" id="date_borrow" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo date('d-m-Y', strtotime($exp_e['date_borrow'])); ?>"></td></td>
        <td><input type="text" size="10" name="pinjaman_pokok" id="pinjaman_pokok" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['loan_amount']; ?>"></td>
        <td><input type="text" size="9" name="jumlah_faedah" id="jumlah_faedah" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['int_total']; ?>"></td>
        <td><input type="text" size="11" name="jumlah_besar" id="jumlah_besar" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['loan_total']; ?>"></td>
        <td><input type="text" size="14" name="kadar_faedah" id="kadar_faedah" font style="font-weight:bold; border: none" readonly="readonly" value="18"></td>
        <td><input type="text" size="16" name="bercagar" id="bercagar" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['bercagar']; ?>"></td>
        <td><input type="text" size="15" name="tempoh_bayaran" id="tempoh_bayaran" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['loan_period']; ?>"></td>
        <td><input type="text" size="14" name="bayaran_sebulan" id="bayaran_sebulan" font style="font-weight:bold; border: none" readonly="readonly" value="<?php echo $exp_e['monthly_payment']; ?>"></td>
      </tr>
		<?php } ?>
    </table></td>
  </tr>
  ...
  <tr align="center">
    ...
    <table width="97%" align="center" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
	  ...
	  <?php
	   $expf = mysql_query("SELECT * FROM loan_payment_details WHERE nric = '".$ic."'",$db2);
		while($exp_f = mysql_fetch_assoc($expf)){
			?>
      <tr  align="center">
        <td align="center"><input type="text" size="11" name="date_pay" id="date_pay" readonly="readonly" value="<?php if ($exp_f['payment_date'] == 0000-00-00){echo "&nbsp;";} else { echo date('d-m-Y', strtotime($exp_f['payment_date'])); } ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="13" name="jumlah_pinjaman" id="jumlah_pinjaman" readonly="readonly" value="<?php echo $exp_f['loan_total']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="13" name="bayaran_pinjaman" id="bayaran_pinjaman" readonly="readonly" value="<?php echo $exp_f['monthly_payment']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="13" name="baki_pinjaman" id="baki_pinjaman" readonly="readonly" value="<?php echo $exp_f['balance']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="14" name="resit_no" id="resit_no" readonly="readonly" value="<?php echo $exp_f['receipt_no']; ?>" font style="font-weight:bold; border: none"></td>
        <td align="center"><input type="text" size="36" name="remark" id="remark" readonly="readonly" value="<?php echo $exp_f['remark']; ?>" font style="font-weight:bold; border: none"></td>
      </tr>
		<?php } ?>
    </table></td>
  </tr>
