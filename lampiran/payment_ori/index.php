...
<tr>
    	<td colspan="8" align="right"><input type="button" name="add" id="add" class="btn"  value="Add" onClick="window.location.href='add_customer.php?branch_id=<?php echo $_GET['branch_id']; ?>'" >
...
<table width="1280" border="1" id="list_table" align="center">
	...
	$exp = mysql_query("SELECT * FROM customer_details2 WHERE branch_id = '".$_GET['branch_id']."' ORDER BY id DESC", $db2);
	...
	?> 
		<tr align="center">
			...
			<td><?php echo $chkr['receipt_no']; ?></td>
