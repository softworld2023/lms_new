...
if($_POST['action'] == 'payloanf2') //flexi tapi resit guna code yang sama
{
	...
	$update_p = mysql_query("UPDATE loan_payment_details SET payment_date = '".$payment_date."',  receipt_no = '".$receipt_no."',  staff_id = '".$_SESSION['taplogin_id']."', staff_name = '".$_SESSION['login_name']."',branch_id = '".$branch_id."', created_date = now() WHERE  nric ='".$nric."' AND month = '".$month."' ",$db2);
