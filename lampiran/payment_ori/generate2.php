...
<table width="1280" id="list_table">
    ...
    <tr>
        ...
        <td><input type="hidden" name="branch_id" id="branch_id" value="<?php echo $branch_id; ?>"><input type="text" name="customercode" id="customercode" value="<?php echo $get_cust['customer_id']; ?>" style="width:230px" /></td>
