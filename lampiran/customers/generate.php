...
$id = $_GET['id'];
$exp = mysql_query("SELECT * FROM customer_details WHERE id = '".$_GET['id']."'",$db2);
  ...
  <tr>
    ...
    <table width="97%" bordercolor="#000000" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr align="left">
        ...
        <td>PENDAPATAN: RM<input type="text" name="salary" id="salary" readonly="readonly" font style="font-weight:bold; border: none" value="<?php echo number_format($exp_d['salary'],'2'); ?>"></td>
      </tr>
      <tr align="left">
