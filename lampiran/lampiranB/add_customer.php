    ...
    <td align="center">
     <table width="80%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td colspan="2"><p> : &nbsp;<input type="text" align="center" name="name" id="name" font style="font-weight:bold; border: none" size= "50" value=""/></p></td>
      </tr>
	  
      <tr>
        <td><p>JENIS ORGANISASI</p></td>
        <td colspan="2"><p>:&nbsp;<input type="text" align="center" name="organisasi" id="organisasi" value="" /></p></td>
      </tr>
	
      <tr>
        <td><p>INDIVIDU BOLEH DIBUHUNGI</p></td>
        <td width="33%"><p>:&nbsp;<input type="text" align="center" name="hubungan" id="hubungan" value=""  /></p></td>
        <td width="31%"><p>TEL&nbsp;:&nbsp;<input type="text" align="center" name="tel" id="tel" value="" /></p></td>
      </tr>
      <tr>
        <td><p>TEMPOH TRANSAKSI</p></td>
        <td><p>&nbsp;:&nbsp;DARI &nbsp;<input type="text" align="center" name="trans_from" id="trans_from" value=""/></p></td>
        <td><p>HINGGA&nbsp;:&nbsp;<input type="text" align="center" name="trans_until" id="trans_until" value=""/></p></td>
      </tr>
      <tr>
        <td><p>NO. LESEN PEMBERI PINJAMAN WANG</p></td>
        <td colspan="2"><p>:&nbsp;<input type="text" align="center" name="no_lesen" id="no_lesen" value=""/></p></td>
      </tr>
    </table>
	</td>
  </tr>
    ...
    <table width="97%" align="center" border="1" cellspacing="0" cellpadding="0">
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					...
					<td width="65" ><center><p><input type="text" align="center" name="plulus" id="plulus" value=""/></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="pmelayu" id="pmelayu" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="pcina" id="pcina" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="pindia" id="pindia" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="plain" id="plain"  value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="nmelayu" id="nmelayu" value=""></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65"><center><p><input type="text" align="center" name="ncina" id="ncina" value=""></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="nindia" id="nindia" value=""></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="30"><p>RM</p></td>
					<td width="65" ><center><p><input type="text" align="center" name="nlain" id="nlain" value=""></p></center></td>
				</tr>
			</table>
		</center>
		</td>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p500" id="p500" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p1000" id="p1000" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p5000" id="p5000"  value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p10000" id="p10000" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="p10001" id="p10001" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a1000" id="a1000" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a5000" id="a5000" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a10000" id="a10000" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a50000" id="a50000" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65" ><center><p><input type="text" align="center" name="a100000" id="a100000" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
	  ...
	  <tr>
		...
		<center>
			<table style="border-collapse:collapse">
				<tr>
					<td width="65"><center><p><input type="text" align="center" name="a1ml" id="a1ml" value=""></p></center></td>
					<td width="30"><p>orang</p></td>
				</tr>
			</table>
		</center>
