...
<table width="280" id="list_table" align="center">
    ...
    <tr>
		...
		<!--<input type="button" name="add" id="add" class="btn"  value="Add" onClick="window.location.href='add_customer.php?branch_id=<?php echo $_GET['branch_id']; ?>'" >-->
		&emsp;&emsp;<input type="button" class="btn" name="back" id="back" value="Back" onClick="window.location.href='../'"></td>
    </tr>
    <tr>
    	<td colspan="8">&nbsp;</td>
    </tr>
