...
<table width="100%" id="list_table">
	<tr>
    	<th colspan="2">Edit Date Issue </th>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" style="padding-right:10px;">Date Issue</td>
      <td align="left">
		<input type="text" name="date_issue" id="date_issue" autocomplete="off" />&nbsp;
	</td>
    </tr>
    ...
    <tr>
    	<td colspan="2" style="padding-right:10px" align="center">
			<input type="submit" name="edit_dateissue" id="edit_dateissue" value="" tabindex="4">
			&nbsp;&nbsp;&nbsp;
...
<script>
	$('#date_issue').click( function(e) {$(this).off('click').AnyTime_picker({ format: "%d-%m-%Y", labelTitle: "Select Date"}).focus(); } ).
keydown(
	function(e)
	{
