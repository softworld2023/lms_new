...
<table width="100%" id="list_table">
    ...
    <tr>
        ...
        <td align="left"><input type="text" name="payout_date" id="payout_date" value="<?php echo date('Y-m-d'); ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="left"><input type="text" name="approved_amount" id="approved_amount" value="<?php echo "RM ".$get_l['loan_amount']; ?>" readonly="readonly" /><input type="hidden" name="approved_amount1" id="approved_amount1" value="<?php echo $get_l['loan_amount']; ?>" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="left"><input type="text" name="cash_pay" id="cash_pay" class="currency" placeholder="RM" onKeyUp="calculateTotal()" tabindex="1" /></td>
    </tr>
    <tr>
    	<td style="padding-right:10px;" align="right">Cheque</td>
        <td align="left"><input type="text" name="cheque_pay" id="cheque_pay" class="currency" placeholder="RM" onKeyUp="calculateTotal()" tabindex="2" /></td>
    </tr>
    <tr>
    	<td style="padding-right:10px;" align="right">Transfer</td>
        <td align="left"><input type="text" name="transfer_pay" id="transfer_pay" class="currency" placeholder="RM" onKeyUp="calculateTotal()" tabindex="3" /></td>
    </tr>
	<tr>
    	<td style="padding-right:10px;" align="right">Reciept No. </td>
        <td align="left"><input type="text" name="receipt_no" id="receipt_no" tabindex="3"  onBlur="checkReceipt(this.value)"></td>
    </tr>
	<?php
    ...
    <tr>
      ...
      <td align="left"><input type="text" name="payment_date" id="payment_date" tabindex="3" /></td>
    </tr>
    <tr>
    	<td colspan="2" style="padding:0px">&nbsp;</td>
    </tr>
...
$('#payment_date').click( function(e) {$(this).off('click').AnyTime_picker({ format: "%Y-%m-%d", earliest:(new Date((new Date()).valueOf() + 1000*3600*24)), labelTitle: "Select Date"}).focus(); } ).
keydown(
	function(e)
    {
...
$('#payout_date').click( function(e) {$(this).off('click').AnyTime_picker({ format: "%Y-%m-%d", labelTitle: "Select Date"}).focus(); } ).
keydown(
	function(e)
    {
    	var key = e.keyCode || e.which;
