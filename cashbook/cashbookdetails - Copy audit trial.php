...
<table width="1280" id="list_table">
    ...
    <?php } ?>
	<tr>
    	<?php if($get_p['type'] != 'Fixed Loan'){ if($get_p['receipt_type'] == '1') {?><td colspan="7">&nbsp;</td><?php } else { ?>
		<td colspan="5">&nbsp;</td>
		<?php } } else { ?>
		<td colspan="4">&nbsp;</td>
		<?php } ?>
    ...
    <tr>
		<?php if($get_p['type'] != 'Fixed Loan'){ if($get_p['receipt_type'] == '1') {?>
    	<td colspan="9" align="right"><input type="button" name="back" id="back" onClick="window.location.href='../cashbook/cashbook.php?id=<?php echo $package_id; ?>'" value=""></td>
		<?php } else { ?>
