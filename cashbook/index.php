...
<table width="1280" id="list_table">
	...
	?>
	<?php if($get_p['scheme'] != 'SKIM KUTU' AND $get_p['scheme'] != 'KUTU OFFICE') { 
	
		$cash_cf = mysql_query("SELECT * FROM cashbook_cf WHERE branch_id = '".$_SESSION['login_branchid']."' AND package_id = '".$get_p['id']."'");
            ...
            <table>
            	<tr>
                    ...
                    <td style="padding:0px">
                   	  <input type="text" name="amount_<?php echo $ctr; ?>" id="amount_<?php echo $ctr; ?>" value="<?php echo $cashcf['amount']; ?>" class="currency">
                    </td>
                    <td>Edit Date</td>
                    <td style="padding:0px">
                   	  <input type="text" name="opening_<?php echo $ctr; ?>" id="opening_<?php echo $ctr; ?>" value="<?php if($cashcf['date'] != '0000-00-00') { echo date('d-m-Y', strtotime($cashcf['date'])); }?>">
                    </td>
                    <td>
	...
	<?php } else if ($get_p['scheme'] == 'SKIM KUTU'){ ?>
	<tr>
    	<td><?php echo $ctr."."; ?></td>
	...
	<?php }else if ($get_p['scheme'] == 'KUTU OFFICE')
	{ ?>
	<tr>
    	<td><?php echo $ctr."."; ?></td>
        <td><a href="cashbookKutuOffice.php"><?php echo $get_p['scheme']; ?></a></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td></td>
