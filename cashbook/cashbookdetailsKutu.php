...
//get_cf
$cf_q = mysql_query("SELECT * FROM cashbook_skimkutu WHERE branch_id = '".$_SESSION['login_branchid']."' AND date < '".$year."-'");
...
<table width="1280" id="list_table">
	...
	$ctr = 0;
	$cf = 0;
	$sql = mysql_query("SELECT * FROM cashbook_skimkutu WHERE branch_id = '".$_SESSION['login_branchid']."' AND date LIKE '%".$year."%' ORDER BY date ASC, id ASC");
	...
	$sql1 = mysql_query("SELECT * FROM cashbook_skimkutu WHERE branch_id = '".$_SESSION['login_branchid']."' ORDER BY id ASC LIMIT 1");
	$get1 = mysql_fetch_assoc($sql1);
	$cf = $get1['inamt'];
	
	$year1 = $year .'-01-01';
	
	$sum1q = mysql_query("SELECT SUM(inamt) as sumIn FROM cashbook_skimkutu WHERE date < '".$year1."-' AND id != '".$get_cf['id']."' AND branch_id = '".$_SESSION['login_branchid']."'");
	$sum1 = mysql_fetch_assoc($sum1q);
	$sum2q = mysql_query("SELECT SUM(outamt) as sumOut FROM cashbook_skimkutu WHERE date < '".$year1."-' AND branch_id = '".$_SESSION['login_branchid']."'");
