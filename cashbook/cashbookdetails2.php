...
$cbcf_q = mysql_query("SELECT * FROM cashbook_cf 
						WHERE branch_id = '".$_SESSION['login_branchid']."' 
...
$loan_q = mysql_query("SELECT * FROM cashbook 
						WHERE branch_id = '".$_SESSION['login_branchid']."' 
						AND package_id = '".$package_id."' 
						AND date LIKE '%".$month."%' 
						ORDER BY date ASC, id ASC");

$prevbal_q = mysql_query("SELECT SUM(amount) AS amtOut 
							FROM cashbook 
...
$prevbal2_q = mysql_query("SELECT SUM(amount) AS amtIn 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND transaction = 'REC' 
...
$prevbal3_q = mysql_query("SELECT SUM(amount) AS amtEx 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND type = 'EXPENSES' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
...
$prevbal4_q = mysql_query("SELECT SUM(amount) AS amtKom 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND transaction = 'KOMISYEN' 
							AND date < '".$month."'");
$get_pb4 = mysql_fetch_assoc($prevbal4_q);

$prevbal5_q = mysql_query("SELECT SUM(amount) AS amtOth 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND type = 'RECEIVED2' 
...
$prevbal6_q = mysql_query("SELECT SUM(amount) AS amtKom2 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND transaction = 'KOMISYEN2' 
							AND date < '".$month."'");
$get_pb6 = mysql_fetch_assoc($prevbal6_q);

$prevbal7_q = mysql_query("SELECT SUM(amount) AS amtCCM 
								FROM cashbook 
								WHERE package_id = '".$package_id."' 
								AND branch_id = '".$_SESSION['login_branchid']."' 
								AND transaction = 'CCM' 
...
$prevbal8_q = mysql_query("SELECT SUM(amount) AS amtTrans 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND type = 'TRANSFER1' 
...
$prevbal9_q = mysql_query("SELECT SUM(amount) AS amtTrans2 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND type = 'TRANSFER2' 
...
$prevbal10_q = mysql_query("SELECT SUM(amount) AS amtExt 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND transaction = 'EXT' 
...
$prevbal11_q = mysql_query("SELECT SUM(amount) AS amtKInt 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND transaction = 'INT' 
...
$prevbal12_q = mysql_query("SELECT SUM(amount) AS amtKInt2 
							FROM cashbook 
							WHERE package_id = '".$package_id."' 
							AND branch_id = '".$_SESSION['login_branchid']."' 
							AND transaction = 'INT' 
