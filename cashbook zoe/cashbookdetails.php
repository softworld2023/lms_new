...
$loan_q = mysql_query("SELECT * FROM cashbook WHERE package_id = '".$package_id."' AND date LIKE '%".$month."%' ORDER BY date ASC, id ASC");
...
$prevbal11_q = mysql_query("SELECT SUM(amount) AS amtKInt FROM cashbook WHERE package_id = '".$package_id."' AND transaction = 'INT' AND type = 'COMMISSION' AND date < '".$month."'");
