...
if($get_p['type'] == 'Flexi Loan' && $get_p['receipt_type'] == '2') {
	$loan_q = mysql_query("SELECT * FROM bal2_cf WHERE package_id = '".$package_id."' ORDER BY month DESC");
}else
{
...
<table width="1280" id="list_table">
    ...
    <tr>
		...
		<?php if($get_p['type'] == 'Flexi Loan' && $get_p['receipt_type'] == '2') { ?>
		<td><?php if($cf2) { echo "RM ".$cf2; } else { echo "RM 0.00"; } ?></td>
		<td>
            ...
            <table>
            	<tr>
                    ...
                    <td style="padding:0px">
                   	  <input type="text" name="amount_<?php echo $ctr; ?>" id="amount_<?php echo $ctr; ?>" value="<?php echo $cf2; ?>" class="currency">                    
					</td>
                    <td>Edit Date</td>
                    <td style="padding:0px">
                   	  <input type="text" name="opening_<?php echo $ctr; ?>" id="opening_<?php echo $ctr; ?>" value="<?php echo $get_l['date']; ?>">                    
					</td>
                    <td>
