...
$prevbal5_q = mysql_query("SELECT SUM(amount) AS amtOth FROM cashbook WHERE package_id = '".$package_id."' AND type = 'COMMISSION' AND date < '".$month."'");
$get_pb5 = mysql_fetch_assoc($prevbal5_q);

$prevbal6_q = mysql_query("SELECT SUM(amount) AS amtKom2 FROM cashbook WHERE package_id = '".$package_id."' AND type = 'PAY' AND date < '".$month."'");
$get_pb6 = mysql_fetch_assoc($prevbal6_q);

$prevbal7_q = mysql_query("SELECT SUM(amount) AS amtCCM FROM cashbook WHERE package_id = '".$package_id."' AND type = 'RECEIVED' AND date < '".$month."'");
...
$cf = $cf - $get_pb3['amtEx'] + $get_pb5['amtOth'] - $get_pb6['amtKom2'] + $get_pb7['amtCCM'] + $get_pb8['amtTrans'] + $get_pb9['amtTrans2'];
