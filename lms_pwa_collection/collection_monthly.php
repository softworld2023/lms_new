...
<html lang="en">
    ...
    <body>
        ...
        <div id="collection" style="display: none;">
            <div class="app-bar p-3 pl-3" style="background-color: darkgreen; height: fit-content;">
                <div class="d-flex flex-column flex-sm-row gap-2">
                    ...
                    <div>
                        ...
                        <!-- <a href="collection_monthly.php" style="margin-left: 10px; text-decoration: none;" >
                            <img src="../img/pay_monthly.png" title="Monthly Collection" style="width: 24px;">
                        </a> -->
            ...
            <div id="content">
                ...
                <form id="form-collection">
                    ...
                    <input type="hidden" id="instalment_type" name="instalment_type" value="Monthly">
                    <div>
                        <div class="label">
                            <span class="btn btn-secondary btn-salary-type">Gaji</span>&nbsp;/&nbsp;
                    ...
                    <div>
                        <div class="label label-instalment" style="display: flex; align-items: center;">
                            <div class="instalment-type-container">
                                <span class="btn btn-secondary btn-instalment-type">Monthly</span>
                            </div>
        ...
        <script>
            ...
            $('#salary, #instalment, #tepi2, #tepi2_bunga').on('input', function() {
                let balanceReceived = $('#salary').val() - $('#instalment').val() - $('#tepi2_bunga').val()
                ;
                console.log('bbb'+ balanceReceived);
            ...
            function goToCollection() {
                ...
                $('#collection').show(0, function() {
                    ...
                    $.ajax({
                        url: 'get_monthly_customer_list_ajax.php',
                        type: 'POST',
                        data: {
                            branch: branch
                        },
...
//     $('#instalment_month').val(formatted);
// });
// $('#instalment_month').click( 
//     function(e) {
//         $(this).off('click').AnyTime_picker({ format: "%d-%m-%Y", labelTitle: "Select Date"}).focus(); 
//     } 
// ).keydown(
// 	function(e){
