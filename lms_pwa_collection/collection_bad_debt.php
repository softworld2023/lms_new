...
<html lang="en">
    ...
    <body>
        ...
        <div id="collection" style="display: none;">
            <div class="app-bar p-3 pl-3" style="background-color: #bf2c2c; height: fit-content;">
            ...
            <div id="content">
                ...
                <form id="form-collection">
                    ...
                    <input type="hidden" id="instalment_type" name="instalment_type" value="Bad Debt">
                    <!-- <div>
                        <div class="label">
                    ...
                    <div>
                        <div class="label label-instalment" style="display: flex; align-items: center;">
                            <div class="instalment-type-container">
                                <span class="btn btn-secondary btn-instalment-type">Bad Debt</span>
                            </div>
