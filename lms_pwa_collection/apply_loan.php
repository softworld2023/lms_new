        	  ...
        	  <table width="85%" id="table_form2">
                ...
                <tr>
                  ...
                  <td><table id="radio_table3">
                      <tr>
                        <td width="79"><input readonly type="text" name="customercode2" id="customercode2" style="width:60px" onblur="checkcode(this.value)" value="<?php if($get_q['customercode2'] != '') { echo $get_q['customercode2']; } ?>" /></td>
